...
> 2026-09-20 更新：四个 PR 的组合模型流水已结束，98 项中 90 项精度通过；官网 9.18 成功的 61 个对应项全部精度通过。各 PR 专项测试按最终验证版本汇总为 35/35 通过，其中 addcdiv 包含新发现的 BF16 系数舍入修复。性能复核、修复后的完整模型复跑及产品 PR 推送尚未完成。
