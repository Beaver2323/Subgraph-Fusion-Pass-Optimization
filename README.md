...
> 2026-09-20 更新：四个 PR 的组合模型流水已结束，98 项中 90 项精度通过；官网 9.18 成功的 61 个对应项全部精度通过。各 PR 专项测试按最终验证版本汇总为 35/35 通过，其中 addcdiv 包含新发现的 BF16 系数舍入修复。四个产品 PR 已更新推送，CLA 均通过，远端流水已触发；性能复核和修复后的完整模型复跑尚未完成。
