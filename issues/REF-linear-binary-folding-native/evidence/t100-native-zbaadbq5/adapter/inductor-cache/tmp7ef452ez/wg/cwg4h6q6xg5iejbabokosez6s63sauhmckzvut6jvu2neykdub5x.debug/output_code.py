...
_frozen_param4 = None  # device(type='npu', index=0) torch.float32 (3, 32) (32, 1) fffc64800aa0
_frozen_param5 = None  # device(type='npu', index=0) torch.float32 (32,) (1,) fffc64801130
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            extern_kernels.addmm(_frozen_param5, arg3_1, _frozen_param4, alpha=1, beta=1, out=buf0)
            del arg3_1
        return (buf0, )
