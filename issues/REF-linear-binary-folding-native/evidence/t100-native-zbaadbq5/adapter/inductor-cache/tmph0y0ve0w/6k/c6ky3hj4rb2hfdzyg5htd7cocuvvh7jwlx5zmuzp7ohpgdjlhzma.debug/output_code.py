...
_frozen_param1 = None  # device(type='npu', index=0) torch.float32 (4, 1) (1, 1) fffc4d694960
_frozen_param2 = None  # device(type='npu', index=0) torch.float32 (3, 32) (1, 3) fffc4d795040


# kernel path: /home/z50063656/tmp/t100-native-zbaadbq5/adapter/inductor-cache/tmph0y0ve0w/qb/cqblau2qrutkkud6afnwcr564ych73to4lmti6sarcvaeiqh6x2j.py
...
#   %add : Tensor "f32[4, 32][32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm, %arg1_1), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_add_0.run(buf1, _frozen_param1, 128, stream=raw_stream0)
        return (buf1, )
