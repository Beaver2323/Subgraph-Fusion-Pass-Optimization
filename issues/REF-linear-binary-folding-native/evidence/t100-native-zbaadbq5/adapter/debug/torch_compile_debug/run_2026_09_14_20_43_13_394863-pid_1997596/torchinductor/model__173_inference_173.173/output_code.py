...
_frozen_param1 = None  # device(type='npu', index=0) torch.float32 (4, 1) (1, 1) fffc64420140
_frozen_param2 = None  # device(type='npu', index=0) torch.float32 (3, 32) (1, 3) fffc643b6260


# kernel path: /home/z50063656/tmp/t100-native-zbaadbq5/adapter/inductor-cache/tmpu__mko2y/sw/cswdjsvxc4iyi5dthu3cmipmzu3yp4sni4e5n5xvrwopobptofxa.py
...
#   %mul : Tensor "f32[4, 32][32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mm, %arg1_1), kwargs = {})
#   return %mul
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_mul_0.run(buf1, _frozen_param1, 128, stream=raw_stream0)
        return (buf1, )
