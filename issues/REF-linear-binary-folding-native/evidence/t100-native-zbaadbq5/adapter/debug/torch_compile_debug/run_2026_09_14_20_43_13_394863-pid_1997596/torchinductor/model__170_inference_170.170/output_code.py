...
_frozen_param1 = None  # device(type='npu', index=0) torch.float32 (4, 32) (32, 1) fffc4d4040f0
_frozen_param2 = None  # device(type='npu', index=0) torch.float32 (3, 32) (1, 3) fffc4d6bac60


# kernel path: /home/z50063656/tmp/t100-native-zbaadbq5/adapter/inductor-cache/tmp3su1q6m3/st/cstr7jgqzzymh76kylwdr7yekaxj2ozxv63pw3pdv4fhm2ktawyl.py
# Topologically Sorted Source Nodes: [sub], Original ATen: [aten.sub]
# Source node to ATen node mapping:
#   sub => sub
# Graph fragment:
#   %mm : Tensor "f32[4, 32][32, 1]npu:0" = PlaceHolder[target=mm]
#   %_frozen_param1 : Tensor "f32[4, 32][32, 1]npu:0" = PlaceHolder[target=_frozen_param1]
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 128}, 
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [128, {'divisors': [1]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 128, 'divisor': 1, 'seed': 1}]},
...
def get_args():
    ...
    _frozen_param1 = rand_strided((4, 32), (32, 1), device='npu:0', dtype=torch.float32)
