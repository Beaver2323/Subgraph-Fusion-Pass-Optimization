...
_frozen_param3 = None  # device(type='npu', index=0) torch.float32 (3, 32) (1, 3) fffc64891b30
_frozen_param4 = None  # device(type='npu', index=0) torch.float32 (32,) (1,) fffc6470b890
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            extern_kernels.addmm(_frozen_param4, reinterpret_tensor(arg3_1, (8, 3), (3, 1), 0), _frozen_param3, alpha=1, beta=1, out=buf0)
            del arg3_1
