...
_frozen_param1 = None  # device(type='npu', index=0) torch.float32 (4, 1) (1, 1) fffc4d3eb570
_frozen_param2 = None  # device(type='npu', index=0) torch.float32 (3, 32) (1, 3) fffc646c05f0


# kernel path: /home/z50063656/tmp/t100-native-zbaadbq5/adapter/inductor-cache/tmpbkci8vyo/5g/c5guypylbmgdecppaomdp5ez5bhgibytvgsg3gayc3k2cfrjkvb6.py
...
#   %div : Tensor "f32[4, 32][32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mm, %arg1_1), kwargs = {})
#   return %div
triton_unk_fused_div_0 = async_compile.triton('triton_unk_fused_div_0', '''
import triton
import triton.language as tl
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_div_0.run(buf1, _frozen_param1, 128, stream=raw_stream0)
        return (buf1, )
