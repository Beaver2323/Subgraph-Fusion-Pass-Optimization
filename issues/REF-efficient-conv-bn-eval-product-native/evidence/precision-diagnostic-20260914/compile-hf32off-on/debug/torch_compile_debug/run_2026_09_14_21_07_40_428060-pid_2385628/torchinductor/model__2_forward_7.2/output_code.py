...
# kernel path: /home/z50063656/tmp/t098-precision-diagnostic-20260914/compile-hf32off-on/inductor-cache/tmplnym_f46/r6/cr6zjji5v3ekplgzas4whtgfn33txa46muon2icon2neto72tvo7.py
...
# kernel path: /home/z50063656/tmp/t098-precision-diagnostic-20260914/compile-hf32off-on/inductor-cache/tmplnym_f46/l2/cl24nw77vjtesqinpskazmbqcfzs6xyz7ifpicymrnjttmst234x.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, mul_1, rsqrt, view, view_1
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t098-precision-diagnostic-20260914/compile-hf32off-on/inductor-cache/tmplnym_f46/6b/c6b6pub3f3afchlateq6wvkruhe6aljh644l2boice2janly2jgw.py
...
# kernel path: /home/z50063656/tmp/t098-precision-diagnostic-20260914/compile-hf32off-on/inductor-cache/tmplnym_f46/v2/cv2f6jv67ov22jpdjwu2okt2wrtblv4ewwq5etzhsotl3p53quq3.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, add_1, convolution, mul, mul_2, rsqrt, sub, view, view_1, view_2
# Graph fragment:
