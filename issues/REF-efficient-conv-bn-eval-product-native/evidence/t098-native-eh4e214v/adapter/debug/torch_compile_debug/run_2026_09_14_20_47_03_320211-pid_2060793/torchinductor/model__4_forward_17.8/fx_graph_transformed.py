class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[32]", primals_2: "f32[32]", primals_3: "f32[32]", primals_4: "f32[32]", primals_5: "f32[32]", primals_6: "f32[32, 3, 3]", primals_7: "f32[4, 3, 96]"):
        ...
        mul_1: "f32[32, 3, 3]" = torch.ops.aten.mul.Tensor(primals_6, mul)
        ...
        convolution: "f32[4, 32, 47]" = torch.ops.aten.convolution.default(primals_7, mul_1, add_1, [2], [0], [1], False, [0], 1);  add_1 = None
