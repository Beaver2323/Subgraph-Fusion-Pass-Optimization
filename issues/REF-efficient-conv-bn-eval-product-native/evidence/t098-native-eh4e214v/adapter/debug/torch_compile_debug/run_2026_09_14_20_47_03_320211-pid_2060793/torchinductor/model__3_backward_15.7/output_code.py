...
# kernel path: /home/z50063656/tmp/t098-native-eh4e214v/adapter/inductor-cache/tmp497zfynf/2v/c2vzstsqqwbkukzb62kqjwwwod4t2dhowlnrvt76g3tzhnqgqwc4.py
...
# kernel path: /home/z50063656/tmp/t098-native-eh4e214v/adapter/inductor-cache/tmp497zfynf/zo/czokmfwmkm3v3kbswhgawvqzloxe3pqk7nzp5axm7askljic5sbt.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval, mul_6], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, rsqrt, view, view_1
#   mul_6 => mul_6
...
# kernel path: /home/z50063656/tmp/t098-native-eh4e214v/adapter/inductor-cache/tmp497zfynf/6r/c6raquvwrqx5mffrmhrotuljiafdcjoneeab5zy3jt35735iryqt.py
...
#   %mul_5 : Tensor "f32[32, 3][3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mm, %primals_4), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, tangents_1 = args
        args.clear()
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_add_mul_rsqrt_view_0.run(primals_6, primals_3, buf3, 96, stream=raw_stream0)
            ...
            # Topologically Sorted Source Nodes: [sum_1, view_3, efficient_conv_bn_eval, mul_3, mul_4, view_4, mul_5, sum_2, add_2, mul_7], Original ATen: [aten.sum, aten.view, aten.add, aten.rsqrt, aten.mul, aten.sub]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_sub_sum_view_2.run(buf6, tangents_1, primals_6, primals_3, primals_5, primals_2, buf0, primals_4, buf1, buf2, 32, stream=raw_stream0)
            del buf0
            del primals_2
            del primals_3
            del primals_4
            ...
            del primals_6
            del tangents_1
        return (None, None, None, buf4, buf2, reinterpret_tensor(buf6, (32, ), (1, ), 0), reinterpret_tensor(buf1, (32, ), (1, ), 0), )
...
def get_args():
    ...
    return [primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, tangents_1]
