...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpg_aj3o28/bs/cbsgyg6bupme5ze4uldszptbw2iaehcjpjiioqteu6fuew4gu2w4.py
...
#   %view_1 : Tensor "f32[32, 1][1, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%primals_6, [32, 1]), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpg_aj3o28/if/cif46rhgrb66ev2uceygexjsisztfofrvrlyrfxjy7pd5vzmvapo.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, mul_1, rsqrt, view, view_1
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpg_aj3o28/gt/cgtpds7uetctfqiy576evb7s36lqcr3g72ppn5hheifrja6g66im.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_add_mul_rsqrt_view_0.run(primals_6, primals_3, buf0, 96, stream=raw_stream0)
            ...
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_sub_view_2.run(primals_7, primals_6, primals_3, primals_5, primals_2, buf2, 32, stream=raw_stream0)
            del primals_7
            ...
            del buf1
            del buf2
        return (buf3, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, )
