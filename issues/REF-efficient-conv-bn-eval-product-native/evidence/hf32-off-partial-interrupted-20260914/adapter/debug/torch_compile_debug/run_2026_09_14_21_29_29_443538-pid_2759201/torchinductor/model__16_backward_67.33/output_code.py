...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpt7pb__vd/5t/c5tmxwzen3b2nr3bompy7linmnpvq5rn2wjjcdl2xmbyjgvzqwjx.py
...
#   %view_1 : Tensor "f32[1, 32, 1][32, 1, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%primals_4, [1, 32, 1]), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpt7pb__vd/cy/ccy3ivlg7cyan7k7ydxlxjnivgejubf33aafrdwzosqr5eagk2kg.py
...
#   %primals_6 : Tensor "f32[3, 32, 3][96, 3, 1]npu:0" = PlaceHolder[target=primals_6]
...
#   %mul_5 : Tensor "f32[3, 32, 3][96, 3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_1, %primals_6), kwargs = {})
#   %mul_6 : Tensor "f32[3, 32, 3][96, 3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_1, %mul), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = torch.ops.aten.convolution_backward.default(tangents_1, primals_7, mul_1, [32], (2,), (0,), (1,), True, (0,), 1, [False, True, True])
            del mul_1
            del primals_7
            del tangents_1
            buf1 = buf0[1]
            ...
            triton_unk_fused_add_mul_rsqrt_view_0.run(primals_4, primals_2, buf4, 288, stream=raw_stream0)
            ...
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval, mul_3, mul_4, view_3, mul_5, mul_6, sum_1, add_2, mul_7], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.sum]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_sub_sum_view_1.run(buf7, buf5, buf1, primals_6, buf2, primals_4, primals_2, primals_5, primals_1, buf3, 32, 9, stream=raw_stream0)
            del buf1
            del primals_1
            del primals_2
            del primals_4
...
def get_args():
    ...
    primals_6 = rand_strided((3, 32, 3), (96, 3, 1), device='npu:0', dtype=torch.float32)
    primals_7 = rand_strided((4, 3, 4), (12, 4, 1), device='npu:0', dtype=torch.float32)
