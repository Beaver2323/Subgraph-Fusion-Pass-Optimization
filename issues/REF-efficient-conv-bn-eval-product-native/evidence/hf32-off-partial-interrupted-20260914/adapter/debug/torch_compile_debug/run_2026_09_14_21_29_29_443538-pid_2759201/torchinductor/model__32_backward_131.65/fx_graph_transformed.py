class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[32]", primals_2: "f32[32]", primals_4: "f32[32]", primals_5: "f32[32, 3, 3]", primals_6: "f32[4, 3, 96]", mul_1: "f32[32, 3, 3]", tangents_1: "f32[4, 32, 47]"):
        # No stacktrace found for following nodes
        convolution_backward = torch.ops.aten.convolution_backward.default(tangents_1, primals_6, mul_1, [32], [2], [0], [1], False, [0], 1, [False, True, True]);  tangents_1 = primals_6 = mul_1 = None
        ...
        view_3: "f32[32, 1, 1]" = torch.ops.aten.reshape.default(mul_3, [32, 1, 1]);  mul_3 = None
        mul_4: "f32[32, 3, 3]" = torch.ops.aten.mul.Tensor(getitem_1, primals_5);  primals_5 = None
        ...
        view_4: "f32[32]" = torch.ops.aten.reshape.default(mul_6, [32]);  mul_6 = None
        return (None, None, getitem_2, view_4, mul_5, None)
