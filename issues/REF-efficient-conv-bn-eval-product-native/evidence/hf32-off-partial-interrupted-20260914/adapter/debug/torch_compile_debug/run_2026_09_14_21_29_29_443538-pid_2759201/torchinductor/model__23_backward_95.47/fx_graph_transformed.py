class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 3, 4, 4]", primals_2: "f32[32]", primals_3: "f32[32]", primals_4: "f32[3, 32, 3, 3]", primals_5: "f32[32]", primals_6: "f32[32]", mul_1: "f32[3, 32, 3, 3]", tangents_1: "f32[4, 32, 9, 9]"):
        # No stacktrace found for following nodes
        convolution_backward = torch.ops.aten.convolution_backward.default(tangents_1, primals_1, mul_1, [32], [2, 2], [0, 0], [1, 1], True, [0, 0], 1, [False, True, True]);  tangents_1 = primals_1 = mul_1 = None
        ...
        view_1: "f32[1, 32, 1, 1]" = torch.ops.aten.reshape.default(primals_6, [1, 32, 1, 1]);  primals_6 = None
        ...
        view_3: "f32[1, 32, 1, 1]" = torch.ops.aten.reshape.default(mul_4, [1, 32, 1, 1]);  mul_4 = None
        mul_5: "f32[3, 32, 3, 3]" = torch.ops.aten.mul.Tensor(getitem_1, primals_4);  primals_4 = None
