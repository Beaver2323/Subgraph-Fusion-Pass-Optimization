...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmprgldfl2s/r6/cr6zjji5v3ekplgzas4whtgfn33txa46muon2icon2neto72tvo7.py
...
#   %mul_1 : Tensor "f32[32, 3, 3][9, 3, 1]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%primals_4, %mul), kwargs = {})
#   return %buf0
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmprgldfl2s/l2/cl24nw77vjtesqinpskazmbqcfzs6xyz7ifpicymrnjttmst234x.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, mul_1, rsqrt, view, view_1
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmprgldfl2s/qe/cqeyo3wkdryjnzkopgk2pk254a5gkumlhlw4shoz4kss7zqntrsz.py
...
#   %convolution : Tensor "f32[4, 32, 47][1504, 47, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%primals_1, %mul_1, %add_1, [2], [0], [1], False, [0], 1), kwargs = {})
#   return %buf2
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmprgldfl2s/4m/c4mg2nn5x26vj7ynlotw2uxrv2ktogq6ftwhfngevkibfgrpbjwe.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.zeros_like, aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, add_1, convolution, full_default, mul, mul_2, rsqrt, sub, view, view_1, view_2
# Graph fragment:
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_add_mul_rsqrt_view_0.run(primals_5, primals_3, buf0, 288, stream=raw_stream0)
            buf1 = buf0; del buf0  # reuse
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_view_1.run(buf1, primals_4, 288, stream=raw_stream0)
            buf2 = empty_strided_npu((32, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.zeros_like, aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_convolution_mul_rsqrt_sub_view_zeros_like_2.run(primals_6, primals_5, primals_3, primals_2, buf2, 32, stream=raw_stream0)
            del primals_6
            primals_1 = copy_if_misaligned(primals_1)
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.zeros_like, aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
            # [Provenance debug handles] extern_kernels.convolution:1
            buf3 = extern_kernels.convolution(primals_1, buf1, stride=(2,), padding=(0,), dilation=(1,), transposed=False, output_padding=(0,), groups=1, bias=None)
            buf4 = buf3; del buf3  # reuse
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.zeros_like, aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_convolution_mul_rsqrt_sub_view_zeros_like_3.run(buf4, buf2, 6016, stream=raw_stream0)
            del buf2
        return (buf4, primals_1, primals_2, primals_3, primals_4, primals_5, buf1, )
