class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[32]", primals_2: "f32[32]", primals_3: "f32[32]", primals_4: "f32[32]", primals_5: "f32[32, 3]", primals_6: "f32[4, 3]"):
        ...
        view_1: "f32[32, 1]" = torch.ops.aten.reshape.default(primals_4, [32, 1])
        mul: "f32[32, 1]" = torch.ops.aten.mul.Tensor(view_1, view);  view_1 = view = None
        mul_1: "f32[32, 3]" = torch.ops.aten.mul.Tensor(primals_5, mul)
        ...
        addmm: "f32[4, 32]" = torch.ops.aten.addmm.default(add_1, primals_6, permute);  add_1 = permute = None
        return (addmm, primals_1, primals_2, primals_4, primals_5, primals_6)
