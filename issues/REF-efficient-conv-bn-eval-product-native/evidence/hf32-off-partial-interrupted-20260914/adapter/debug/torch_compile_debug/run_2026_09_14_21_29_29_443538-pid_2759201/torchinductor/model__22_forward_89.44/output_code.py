...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpip3_6has/gp/cgpwsk3q3fdrwsj2g5jntzsdblnx523povqezhqthx4peb2m3hmv.py
...
#   %mul_1 : Tensor "f32[3, 32, 3, 3][288, 9, 3, 1]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%primals_6, %mul), kwargs = {})
#   return %buf0
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpip3_6has/qg/cqgffquqhbyun2jhqogdzxxgo6lcxnkhpd732ju7lfvyychguw6v.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, mul_1, rsqrt, view, view_1
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpip3_6has/6b/c6b6pub3f3afchlateq6wvkruhe6aljh644l2boice2janly2jgw.py
...
#   %convolution : Tensor "f32[4, 32, 9, 9][2592, 81, 9, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%primals_7, %mul_1, %add_1, [2, 2], [0, 0], [1, 1], True, [0, 0], 1), kwargs = {})
#   return %buf2
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpip3_6has/v7/cv76xgthjjf7gvtes2l7vzbbfqkmtjmrpqh5myzxhgf4sx6duwql.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, add_1, convolution, mul, mul_2, rsqrt, sub, view, view_1, view_2
# Graph fragment:
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf3 = extern_kernels.convolution(primals_7, buf1, stride=(2, 2), padding=(0, 0), dilation=(1, 1), transposed=True, output_padding=(0, 0), groups=1, bias=None)
