class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 3]", primals_2: "f32[32]", primals_3: "f32[32]", primals_4: "f32[32, 3]", primals_5: "f32[32]", primals_6: "f32[32]", primals_7: "f32[32]"):
        ...
        view_1: "f32[32, 1]" = torch.ops.aten.reshape.default(primals_6, [32, 1])
        ...
        return (addmm, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6)
