...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmp1ne9fb_a/r6/cr6zjji5v3ekplgzas4whtgfn33txa46muon2icon2neto72tvo7.py
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmp1ne9fb_a/l2/cl24nw77vjtesqinpskazmbqcfzs6xyz7ifpicymrnjttmst234x.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, mul_1, rsqrt, view, view_1
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmp1ne9fb_a/6b/c6b6pub3f3afchlateq6wvkruhe6aljh644l2boice2janly2jgw.py
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmp1ne9fb_a/v2/cv2f6jv67ov22jpdjwu2okt2wrtblv4ewwq5etzhsotl3p53quq3.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.convolution]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, add_1, convolution, mul, mul_2, rsqrt, sub, view, view_1, view_2
# Graph fragment:
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_add_mul_rsqrt_view_0.run(primals_6, primals_3, buf0, 288, stream=raw_stream0)
