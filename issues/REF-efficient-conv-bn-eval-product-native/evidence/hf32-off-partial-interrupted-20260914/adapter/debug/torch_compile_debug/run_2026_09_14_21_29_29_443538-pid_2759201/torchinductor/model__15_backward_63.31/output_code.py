...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpyl7y4h5h/75/c75vg7bewo7rbxmpcqvdakmcfmqumvmhjpibhvbhkoiizr7l624r.py
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpyl7y4h5h/k6/ck6p5z4mhoq5kmftjnhsyp76n62uh2uzpnrtwymdz3foeha22ghr.py
...
#   %mul_5 : Tensor "f32[32, 3, 3, 3, 3][81, 27, 9, 3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_1, %primals_4), kwargs = {})
#   %mul_6 : Tensor "f32[32, 3, 3, 3, 3][81, 27, 9, 3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_1, %mul), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = torch.ops.aten.convolution_backward.default(tangents_1, primals_1, mul_1, [32], (2, 2, 2), (0, 0, 0), (1, 1, 1), False, (0, 0, 0), 1, [False, True, True])
            del mul_1
            del primals_1
            del tangents_1
            buf1 = buf0[1]
            ...
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval, mul_3, mul_4, view_3, mul_5, mul_6, sum_1, add_2, mul_7], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.sum]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_sub_sum_view_1.run(buf5, buf7, buf1, primals_4, buf2, primals_6, primals_3, primals_5, primals_2, buf3, 32, 81, stream=raw_stream0)
            del buf1
            del primals_2
            del primals_3
            del primals_4
