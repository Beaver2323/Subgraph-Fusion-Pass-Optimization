...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmple6th1ex/hk/chkvwwfr3376uxkmmrvyaapqpri4k3tnmhticoy2hyo7nwebz2k6.py
...
#   %mul_4 : Tensor "f32[32, 3][3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mm, %primals_5), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmple6th1ex/id/cidax6xznyq23ididi3623dsesyysfsigfumotzemkvreq4nbggl.py
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmple6th1ex/v4/cv4p2267wc27ymwahgyxqbntuqvtxanxwqazjrvxy4lhigkljh45.py
# Topologically Sorted Source Nodes: [efficient_conv_bn_eval, mul_5], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
# Source node to ATen node mapping:
#   efficient_conv_bn_eval => add, mul, rsqrt, view, view_1
#   mul_5 => mul_5
...
class Runner:
    ...
    def call(self, args):
        primals_1, primals_2, primals_4, primals_5, primals_6, tangents_1 = args
        args.clear()
        with torch.npu.utils.device(0):
            ...
            extern_kernels.mm(reinterpret_tensor(tangents_1, (32, 4), (1, 32), 0), primals_6, out=buf0)
            del primals_6
            buf1 = empty_strided_npu((1, 32), (32, 1), torch.float32)
            buf4 = empty_strided_npu((32, 1), (1, 1), torch.float32)
            # Topologically Sorted Source Nodes: [sum_1, view_3, efficient_conv_bn_eval, mul_3, view_4, mul_4, sum_2, add_2, mul_6], Original ATen: [aten.sum, aten.view, aten.zeros_like, aten.sub, aten.mul, aten.add, aten.rsqrt]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_sub_sum_view_zeros_like_0.run(tangents_1, primals_1, buf0, primals_5, primals_2, buf1, buf4, 32, stream=raw_stream0)
            del primals_1
            del primals_5
            del tangents_1
            ...
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval, mul_5], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_view_1.run(primals_4, primals_2, buf2, 96, stream=raw_stream0)
            del primals_2
            del primals_4
            ...
            del buf2
        return (None, None, reinterpret_tensor(buf1, (32, ), (1, ), 0), reinterpret_tensor(buf4, (32, ), (1, ), 0), buf3, None, )
...
def get_args():
    ...
    return [primals_1, primals_2, primals_4, primals_5, primals_6, tangents_1]
