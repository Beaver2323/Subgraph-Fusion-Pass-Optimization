class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[32]", primals_2: "f32[32]", primals_4: "f32[32]", primals_5: "f32[32]", primals_6: "f32[32, 3]", primals_7: "f32[4, 3]", tangents_1: "f32[4, 32]"):
        # No stacktrace found for following nodes
        permute_1: "f32[32, 4]" = torch.ops.aten.permute.default(tangents_1, [1, 0])
        mm: "f32[32, 3]" = torch.ops.aten.mm.default(permute_1, primals_7);  permute_1 = primals_7 = None
        ...
        view_4: "f32[32, 1]" = torch.ops.aten.reshape.default(mul_4, [32, 1]);  mul_4 = None
        mul_5: "f32[32, 3]" = torch.ops.aten.mul.Tensor(mm, primals_6);  primals_6 = None
        ...
        view_5: "f32[32]" = torch.ops.aten.reshape.default(mul_7, [32]);  mul_7 = None
        return (None, None, view_3, view_5, mul_3, mul_6, None)
