...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpt8btxnyw/ba/cbalnzmb5gp2rf3pdjawkquds3w5a4en26l3tw7jut25is67arep.py
...
#   %view_1 : Tensor "f32[32, 1, 1, 1][1, 1, 1, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%primals_6, [32, 1, 1, 1]), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t098-native-doq0hsal/adapter/inductor-cache/tmpt8btxnyw/c3/cc3p2b5kawzqdtdwe5pxgi2bhuvvs3mepup5nfa5mhgevxdb6b4z.py
...
#   %primals_4 : Tensor "f32[32, 3, 3, 3][27, 9, 3, 1]npu:0" = PlaceHolder[target=primals_4]
...
#   %mul_5 : Tensor "f32[32, 3, 3, 3][27, 9, 3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_1, %primals_4), kwargs = {})
#   %mul_6 : Tensor "f32[32, 3, 3, 3][27, 9, 3, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem_1, %mul), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = torch.ops.aten.convolution_backward.default(tangents_1, primals_1, mul_1, [32], (2, 2), (0, 0), (1, 1), False, (0, 0), 1, [False, True, True])
            del mul_1
            del primals_1
            del tangents_1
            buf1 = buf0[1]
            ...
            triton_unk_fused_add_mul_rsqrt_view_0.run(primals_6, primals_3, buf4, 864, stream=raw_stream0)
            ...
            # Topologically Sorted Source Nodes: [efficient_conv_bn_eval, mul_3, mul_4, view_3, mul_5, mul_6, sum_1, add_2, mul_7], Original ATen: [aten.add, aten.rsqrt, aten.view, aten.mul, aten.sub, aten.sum]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_mul_rsqrt_sub_sum_view_1.run(buf5, buf7, buf1, primals_4, buf2, primals_6, primals_3, primals_5, primals_2, buf3, 32, 27, stream=raw_stream0)
            del buf1
            del primals_2
            del primals_3
            del primals_4
...
def get_args():
    ...
    primals_1 = rand_strided((4, 3, 96, 96), (27648, 9216, 96, 1), device='npu:0', dtype=torch.float32)
    primals_2 = rand_strided((32, ), (1, ), device='npu:0', dtype=torch.float32)
    primals_3 = rand_strided((32, ), (1, ), device='npu:0', dtype=torch.float32)
    primals_4 = rand_strided((32, 3, 3, 3), (27, 9, 3, 1), device='npu:0', dtype=torch.float32)
