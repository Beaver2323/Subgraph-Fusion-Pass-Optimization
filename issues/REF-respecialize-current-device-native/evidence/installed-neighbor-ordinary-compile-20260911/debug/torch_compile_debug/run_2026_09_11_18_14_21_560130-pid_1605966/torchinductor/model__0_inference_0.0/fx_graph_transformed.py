class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2, 8]"):
        ...
        full_default: "f32[4, 8]" = torch.ops.aten.full.default([4, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
        ...
        add: "f32[4, 8]" = torch.ops.aten.add.Tensor(full_default, sum_1);  full_default = sum_1 = None
        return (add,)
