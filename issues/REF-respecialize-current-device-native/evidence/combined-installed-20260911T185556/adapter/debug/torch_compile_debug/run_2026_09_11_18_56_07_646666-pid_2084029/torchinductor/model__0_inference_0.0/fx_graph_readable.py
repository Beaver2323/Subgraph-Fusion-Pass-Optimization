class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2, 8]"):
        ...
        current_device_default = torch.ops.coor.current_device.default()
        full: "f32[4, 8]" = torch.ops.aten.full.default([4, 8], 0, dtype = torch.float32, layout = torch.strided, device = current_device_default, pin_memory = False);  current_device_default = None
