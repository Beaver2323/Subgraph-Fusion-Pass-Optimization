...
def forward(self, arg0_1, arg1_1, arg2_1, arg3_1):
    ...
    expand = torch.ops.aten.expand.default(permute_1, [1, 16, 2, 32]);  permute_1 = None
    view = torch.ops.aten.view.default(expand, [16, 2, 32]);  expand = None
    expand_1 = torch.ops.aten.expand.default(permute_3, [1, 16, 32, 2]);  permute_3 = None
    ...
    full_default = torch.ops.aten.full.default([], 5.656854249492381, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
    ...
    expand_2 = torch.ops.aten.expand.default(div_1, [1, 16, 2, 2]);  div_1 = None
    view_3 = torch.ops.aten.view.default(expand_2, [16, 2, 2]);  expand_2 = None
    expand_3 = torch.ops.aten.expand.default(permute_2, [1, 16, 2, 32]);  permute_2 = None
