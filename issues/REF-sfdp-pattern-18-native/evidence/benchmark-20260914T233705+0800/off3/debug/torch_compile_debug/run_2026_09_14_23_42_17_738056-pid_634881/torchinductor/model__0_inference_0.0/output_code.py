...
# kernel path: /home/z50063656/tmp/attention-performance-20260914/benchmark-20260914T233705+0800/pattern-18/off3/inductor-cache/tmp50gpy2yn/k6/ck674jpirmxolj5h635ld7mjvb67g23yjc4qxg5huoxntqwugl3f.py
...
# kernel path: /home/z50063656/tmp/attention-performance-20260914/benchmark-20260914T233705+0800/pattern-18/off3/inductor-cache/tmp50gpy2yn/ji/cji2sv4xvaftgl3viy6aydlrlgchnbkkgq35gd3hlbbrkknt6lwp.py
...
# kernel path: /home/z50063656/tmp/attention-performance-20260914/benchmark-20260914T233705+0800/pattern-18/off3/inductor-cache/tmp50gpy2yn/ey/ceyrrn43zdqcvkcsbhvddghv55d5velc7b67zge6zwwuh47j4vls.py
...
# kernel path: /home/z50063656/tmp/attention-performance-20260914/benchmark-20260914T233705+0800/pattern-18/off3/inductor-cache/tmp50gpy2yn/x6/cx6uyoi5xqgnn3w7aq3ycziz2ihnb53bb6dxcn3g3upvcg34kkvj.py
# Topologically Sorted Source Nodes: [attn_weights, inv_scale, attn_weights_1, causal_mask_value, attn_weights_2, softmax], Original ATen: [aten.matmul, aten.full, aten.div, aten.where, aten._softmax]
# Source node to ATen node mapping:
#   attn_weights => view_2
#   attn_weights_1 => div
...
# kernel path: /home/z50063656/tmp/attention-performance-20260914/benchmark-20260914T233705+0800/pattern-18/off3/inductor-cache/tmp50gpy2yn/ki/cki2hkkud53svr2ojmgrkkqxpyqfweawahuoebhlmlhy64cwaqn6.py
# Topologically Sorted Source Nodes: [attn_weights, inv_scale, attn_weights_1, causal_mask_value, attn_weights_2, softmax], Original ATen: [aten.matmul, aten.full, aten.div, aten.where, aten._softmax]
# Source node to ATen node mapping:
#   attn_weights => view_2
#   attn_weights_1 => div
...
# kernel path: /home/z50063656/tmp/attention-performance-20260914/benchmark-20260914T233705+0800/pattern-18/off3/inductor-cache/tmp50gpy2yn/ei/ceii64k6swhfgjuqpv3lc3sobgvniixvtqegvomp6momowsch3tk.py
# Topologically Sorted Source Nodes: [attn_weights, inv_scale, attn_weights_1, causal_mask_value, attn_weights_2, softmax], Original ATen: [aten.matmul, aten.full, aten.div, aten.where, aten._softmax]
# Source node to ATen node mapping:
#   attn_weights => view_2
#   attn_weights_1 => div
