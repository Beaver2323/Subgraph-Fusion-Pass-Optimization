class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[1024, 6, 128]", arg1_1: "f32[1024, 6, 128]"):
        ...
        view_default: "f32[1024, 768]" = torch.ops.aten.view.default(arg0_1, (1024, 768))
        ...
        select_4: "f32[1024, 128]" = torch.ops.aten.select.int(arg0_1, 1, 4);  arg0_1 = None
        ...
        return (view_default, cat_default_2, cat_default_1, cat_default)
