...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # Topologically Sorted Source Nodes: [cat_default_2], Original ATen: [aten.cat]
            ...
            # Topologically Sorted Source Nodes: [select_int, select_int_1, select_int_2, select_int_3, select_int_4, cat_default], Original ATen: [aten.select, aten.cat]
            ...
            # Topologically Sorted Source Nodes: [select_int, select_int_2, select_int_4, cat_default_1], Original ATen: [aten.select, aten.cat]
