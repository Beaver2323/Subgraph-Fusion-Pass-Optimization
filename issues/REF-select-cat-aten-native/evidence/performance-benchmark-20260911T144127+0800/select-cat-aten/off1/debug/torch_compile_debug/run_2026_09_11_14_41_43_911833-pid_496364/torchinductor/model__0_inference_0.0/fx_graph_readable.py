class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[1024, 6, 128]", arg1_1: "f32[1024, 6, 128]"):
        ...
        cat: "f32[1024, 768]" = torch.ops.aten.cat.default([select, select_1, select_2, select_3, select_4, select_5], 1);  select_5 = None
        ...
        cat_1: "f32[1024, 640]" = torch.ops.aten.cat.default([select, select_1, select_2, select_3, select_4], 1);  select_1 = select_3 = None
        ...
        cat_2: "f32[1024, 384]" = torch.ops.aten.cat.default([select, select_2, select_4], 1);  select = select_2 = select_4 = None
