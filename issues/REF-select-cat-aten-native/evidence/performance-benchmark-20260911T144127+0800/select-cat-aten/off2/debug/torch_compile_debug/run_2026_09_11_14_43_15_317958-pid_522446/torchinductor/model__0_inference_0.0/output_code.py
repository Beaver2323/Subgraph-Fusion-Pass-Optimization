...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # Topologically Sorted Source Nodes: [select_int, select_int_1, select_int_2, select_int_3, select_int_4, select_int_5, cat_default], Original ATen: [aten.select, aten.cat]
            # [Provenance debug handles] torch.ops.aten.cat.default:1
            buf0 = torch.ops.aten.cat.default([reinterpret_tensor(arg0_1, (1024, 128), (768, 1), 0), reinterpret_tensor(arg0_1, (1024, 128), (768, 1), 128), reinterpret_tensor(arg0_1, (1024, 128), (768, 1), 256), reinterpret_tensor(arg0_1, (1024, 128), (768, 1), 384), reinterpret_tensor(arg0_1, (1024, 128), (768, 1), 512), reinterpret_tensor(arg0_1, (1024, 128), (768, 1), 640)], 1)
