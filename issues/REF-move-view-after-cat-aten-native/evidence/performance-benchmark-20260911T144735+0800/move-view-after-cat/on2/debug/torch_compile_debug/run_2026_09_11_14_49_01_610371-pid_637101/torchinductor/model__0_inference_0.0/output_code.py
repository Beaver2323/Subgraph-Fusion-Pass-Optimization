...
# kernel path: /home/z50063656/tmp/t089-npu-results/benchmark-20260911T144735+0800/move-view-after-cat/on2/inductor-cache/tmp14dsutzb/eh/cehmkkab2rg44gp4d4ofcqeijrsliqqau4e2xg5llfvzltgwgzxk.py
# Topologically Sorted Source Nodes: [split_with_sizes_default, view_default, , merged, cat_default_1], Original ATen: [aten.split_with_sizes, aten.view, aten.cat]
# Source node to ATen node mapping:
#    => permute_default
#   cat_default_1 => cat_default_1
#   merged => reshape_default
