class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[4, 2, 16, 32]", arg1_1: "f32[4, 2, 16, 32]", arg2_1: "f32[4, 2, 16, 32]"):
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:977 in dot_prod_attention, code: attn_mask = torch.ones(
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:979 in dot_prod_attention, code: ).tril(diagonal=0)
        ...
        view_default: "b8[4, 1, 1, 2]" = torch.ops.aten.view.default(eq_scalar, [4, 1, 1, 2]);  eq_scalar = None
        ...
        npu_fusion_attention_v3_default = torch.ops.npu.npu_fusion_attention_v3.default(permute_default, permute_default_1, permute_default_2, 16, 'BNSD', None, None, logical_not_default, 0.3333333333333333, 1.0, 2147483647, 2147483647, 2);  permute_default = permute_default_1 = permute_default_2 = logical_not_default = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:984 in dot_prod_attention, code: return torch.matmul(weights, v)
