...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-revised-domains/functional-20260915T000318+0800/pattern-15/off/inductor-cache/tmpvdh74gc5/k6/ck674jpirmxolj5h635ld7mjvb67g23yjc4qxg5huoxntqwugl3f.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-revised-domains/functional-20260915T000318+0800/pattern-15/off/inductor-cache/tmpvdh74gc5/vy/cvy7lkqhjtituenoxv2hel4ww4vu7wkfg5pj2uinra6f4no2udgo.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-revised-domains/functional-20260915T000318+0800/pattern-15/off/inductor-cache/tmpvdh74gc5/ak/cakcgbfyspnvtz7niaqj3vquxefros4lwjg6xwlpvtzc4o2u46oy.py
...
#   %div : Tensor "f16[2, 8, 4, 4][128, 16, 4, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%view_2, 2.0), kwargs = {})
...
@triton.jit
def triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_2(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 256
    x_g_tile0 : tl.constexpr = (4) if (4) < (XBLOCK) else (XBLOCK)
    ...
    for i in range(group_size):
        ...
        tmp9 = extract_slice(_es_full2, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        ...
        tmp11 = extract_slice(_es_full3, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        ...
        tmp16 = extract_slice(_es_full4, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        ...
        tmp18 = extract_slice(_es_full5, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        ...
        tmp23 = extract_slice(_es_full6, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        ...
        tmp25 = extract_slice(_es_full7, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        ...
        tmp10 = tmp9 == tmp1
        tmp12 = tmp11 * tmp4
        tmp13 = tl.where(tmp10, tmp6, tmp12)
        tmp14 = tmp13.to(tl.float32)
        tmp15 = tl.maximum(tmp8, tmp14)
        tmp17 = tmp16 == tmp1
        tmp19 = tmp18 * tmp4
        tmp20 = tl.where(tmp17, tmp6, tmp19)
        tmp21 = tmp20.to(tl.float32)
        tmp22 = tl.maximum(tmp15, tmp21)
        tmp24 = tmp23 == tmp1
        tmp26 = tmp25 * tmp4
        tmp27 = tl.where(tmp24, tmp6, tmp26)
        tmp28 = tmp27.to(tl.float32)
        tmp29 = tl.maximum(tmp22, tmp28)
        tl.store(out_ptr0 + (x0 + 4*x1 + 128*x2), tmp29, x0mask & x1mask & x2mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/attention-functional-20260914-revised-domains/functional-20260915T000318+0800/pattern-15/off/inductor-cache/tmpvdh74gc5/s2/cs2w7ldulca7gcdvjv4t7pnbblf7ou5d4hv6c5njheku6c2q7nqk.py
# Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
# Source node to ATen node mapping:
#   attn_mask => expand_2
#   eq => eq
...
@triton.jit
def triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_3(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 64
    ...
    for i in range(group_size):
        ...
        tmp9 = extract_slice(_es_sfull2, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        _es_lane3 = tl.arange(0, 4)[None, :]
        _es_full3 = tl.load(in_ptr0 + (1 + 4 * x1) + _es_lane3, x1mask, eviction_policy='evict_last').to(tl.float32)
        tmp12 = extract_slice(_es_full3, [0, 0], [real_block_x1, 1], [1, 1])
        ...
        tmp14 = extract_slice(_es_sfull4, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        ...
        tmp18 = extract_slice(_es_sfull5, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        _es_lane6 = tl.arange(0, 4)[None, :]
        _es_full6 = tl.load(in_ptr0 + (2 + 4 * x1) + _es_lane6, x1mask, eviction_policy='evict_last').to(tl.float32)
        tmp22 = extract_slice(_es_full6, [0, 0], [real_block_x1, 1], [1, 1])
        ...
        tmp24 = extract_slice(_es_sfull7, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        ...
        tmp28 = extract_slice(_es_sfull8, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        _es_lane9 = tl.arange(0, 4)[None, :]
        _es_full9 = tl.load(in_ptr0 + (3 + 4 * x1) + _es_lane9, x1mask, eviction_policy='evict_last').to(tl.float32)
        tmp32 = extract_slice(_es_full9, [0, 0], [real_block_x1, 1], [1, 1])
        ...
        tmp34 = extract_slice(_es_sfull10, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        ...
        tmp38 = extract_slice(_es_sfull11, [0, 0], [real_block_x1, real_block_x0], [1, 4])
        tmp1 = tl.full([1], 0.0, tl.float32)
        tmp2 = tmp0 == tmp1
        tmp4 = tl.full([1], 0.5, tl.float32)
        tmp5 = tmp3 * tmp4
        ...
        tmp13 = tmp12 == tmp1
        tmp15 = tmp14 * tmp4
        tmp16 = tl.where(tmp13, tmp6, tmp15)
        ...
        tmp23 = tmp22 == tmp1
        tmp25 = tmp24 * tmp4
        tmp26 = tl.where(tmp23, tmp6, tmp25)
        ...
        tmp39 = tmp37 - tmp38
        tmp40 = libdevice.exp(tmp39)
        tmp41 = tmp31 + tmp40
        tl.store(out_ptr0 + (x0 + 32*x1), tmp41, x0mask & x1mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/attention-functional-20260914-revised-domains/functional-20260915T000318+0800/pattern-15/off/inductor-cache/tmpvdh74gc5/tm/ctmpm4etx3egmc6ff6tpd4pyuetnsn3kvtv2l63k7jp4polj7k3a.py
# Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
# Source node to ATen node mapping:
#   attn_mask => expand_2
#   eq => eq
...
@triton.jit
def triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_4(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 256
    x_g_tile0 : tl.constexpr = (4) if (4) < (XBLOCK) else (XBLOCK)
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-revised-domains/functional-20260915T000318+0800/pattern-15/off/inductor-cache/tmpvdh74gc5/pr/cprg7hbm2oukkxase73xbkv3pefq5uso5it52grnqmfps5dmrnxv.py
# Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
# Source node to ATen node mapping:
#   attn_mask => expand_2
#   eq => eq
...
@triton.jit
def triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_5(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 256
    x_g_tile0 : tl.constexpr = (4) if (4) < (XBLOCK) else (XBLOCK)
    ...
    for i in range(group_size):
        ...
        tmp9 = tl.load(in_ptr1 + (x0 + 4*x1 + 128*x2), x0mask & x1mask & x2mask)
        tmp12 = tl.load(in_ptr2 + (x0 + 4*x1 + 128*x2), x0mask & x1mask & x2mask)
        tmp1 = tl.full([1], 0.0, tl.float32)
        tmp2 = tmp0 == tmp1
        tmp4 = tl.full([1], 0.5, tl.float32)
        tmp5 = tmp3 * tmp4
        ...
        tmp13 = (tmp11 / tmp12)
        tmp14 = tmp13.to(tl.float32)
        tl.store(in_out_ptr0 + (x0 + 4*x1 + 128*x2), tmp14, x0mask & x1mask & x2mask)
''', device_str='npu')
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_2.run(arg3_1, buf2, buf3, 256, stream=raw_stream0)
            buf4 = empty_strided_npu((2, 8, 4, 1), (32, 4, 1, 64), torch.float32)
            # Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_3.run(arg3_1, buf2, buf3, buf4, 64, stream=raw_stream0)
            buf5 = empty_strided_npu((2, 8, 4, 4), (128, 16, 4, 1), torch.float32)
            # Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_4.run(buf4, buf5, 256, stream=raw_stream0)
            del buf4
            buf6 = reinterpret_tensor(buf2, (2, 8, 4, 4), (128, 16, 4, 1), 0); del buf2  # reuse
            # Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_div_eq_expand_full_masked_fill_matmul_view_5.run(buf6, arg3_1, buf3, buf5, 256, stream=raw_stream0)
            del arg3_1
            del buf3
            del buf5
