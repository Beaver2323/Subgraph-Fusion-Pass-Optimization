...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T231936+0800/pattern-15/on/inductor-cache/tmpzsnhou7r/k6/ck674jpirmxolj5h635ld7mjvb67g23yjc4qxg5huoxntqwugl3f.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T231936+0800/pattern-15/on/inductor-cache/tmpzsnhou7r/vy/cvy7lkqhjtituenoxv2hel4ww4vu7wkfg5pj2uinra6f4no2udgo.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T231936+0800/pattern-15/on/inductor-cache/tmpzsnhou7r/6k/c6kwztmx6jn7z5qmbzmklxzr2rztcutrmzc3pis6iofomxddd2sp.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T231936+0800/pattern-15/on/inductor-cache/tmpzsnhou7r/t5/ct5urmfcjinr5arsvyvdtbqo2xlk7zezkiyfhpil6g6fndx42vuw.py
# Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
# Source node to ATen node mapping:
#   attn_mask => expand_2
#   eq => eq
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T231936+0800/pattern-15/on/inductor-cache/tmpzsnhou7r/jb/cjbiyafcv74xd6iqa3j4ndhbeg3alq24dgxxahbwo7lf7zzxt3ej.py
# Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
# Source node to ATen node mapping:
#   attn_mask => expand_2
#   eq => eq
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T231936+0800/pattern-15/on/inductor-cache/tmpzsnhou7r/nx/cnxifor6c4fpk2bcodylxbabihov2je6untuvd2egtsxclmlkr4z.py
# Topologically Sorted Source Nodes: [eq, view, attn_mask, fill_value, scores, scores_1, masked_fill, softmax], Original ATen: [aten.eq, aten.view, aten.expand, aten.full, aten.matmul, aten.div, aten.masked_fill, aten._softmax]
# Source node to ATen node mapping:
#   attn_mask => expand_2
#   eq => eq
