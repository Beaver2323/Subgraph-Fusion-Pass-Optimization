...
# kernel path: /home/z50063656/tmp/t078-npu-results/REF-addcdiv-fma-codegen-native/lowp-three-arm-20260908T072913+0800/float16/re-fused/inductor-cache/tmpf0170vl4/s2/cs2aoowvrhvs5rzk3diqqv7iz7vf3m6ysbdp7zab33ix4kpxzoru.py
...
#   %addcdiv_default : Tensor "f16[64, 64][64, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.addcdiv.default](args = (%arg0_1, %arg1_1, %arg2_1), kwargs = {value: 2.0})
