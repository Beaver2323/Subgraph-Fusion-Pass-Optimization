...
> 归档时间：2026-09-08T02:04:47.642229+08:00

## 对照定义

- 修复前：源码修复前：最小NPU入口适配可编译，但未形成目标FMA语义
- 修复后：源码修复后：NPU条件分支使用受支持FMA表达并通过正负例
- 证据含义：对照FX、pointwise IR和生成的Triton kernel，确认修复前普通除乘加与修复后目标表达的差异。
