...
# kernel path: /home/z50063656/tmp/t078-npu-results/REF-addcdiv-fma-codegen-native/fp16-source-fix-20260909T174900+0800/value-1p0/inductor-cache/tmprxidclqk/ri/cril66bolsmc5qtjrpdhwoo2ii3lhm6te23gavqz6jbmrmmhcxra.py
...
#   %add : Tensor "f16[64, 64][64, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg0_1, %div), kwargs = {})
#   return %add
triton_unk_fused_add_mul_0 = async_compile.triton('triton_unk_fused_add_mul_0', '''
import triton
import triton.language as tl
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_add_mul_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused_add_mul_0(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_add_mul_0.run(arg0_1, arg1_1, arg2_1, buf0, 4096, stream=raw_stream0)
            del arg0_1
            del arg1_1
            del arg2_1
        return (buf0, )
