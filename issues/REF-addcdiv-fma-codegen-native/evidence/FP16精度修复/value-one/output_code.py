...
# kernel path: /home/z50063656/tmp/t078-npu-results/REF-addcdiv-fma-codegen-native/fp16-source-fix-20260908T085145+0800/value-1p0/inductor-cache/tmpmxw2bm07/sb/csbma26cme4s77rgidq5t4cyqsi2wglzfbgrrcvdyp2g35dg6bu7.py
...
#   %addcdiv_default : Tensor "f16[64, 64][64, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.addcdiv.default](args = (%arg0_1, %arg1_1, %arg2_1), kwargs = {})
