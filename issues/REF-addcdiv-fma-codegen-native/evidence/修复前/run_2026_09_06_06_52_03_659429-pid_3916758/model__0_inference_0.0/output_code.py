...
# kernel path: /home/z50063656/tmp/t078-npu-results/REF-addcdiv-fma-codegen-native/adapter-i6uo737w/inductor-cache/tmp6h7xowqa/qq/cqqk3lykrh4xuio4thp6xdkdot4uds35oszkyupgkuxibpdp5gqg.py
...
#   %arg2_1 : Tensor "f32[64, 64][64, 1]npu:0" = PlaceHolder[target=arg2_1]
#   %div : Tensor "f32[64, 64][64, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%arg1_1, %arg2_1), kwargs = {})
#   %mul : Tensor "f32[64, 64][64, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, 2.0), kwargs = {})
#   %add : Tensor "f32[64, 64][64, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg0_1, %mul), kwargs = {})
#   return %add
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_add_div_mul_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': False, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = empty_strided_npu((64, 64), (64, 1), torch.float32)
            # Topologically Sorted Source Nodes: [div, mul, add], Original ATen: [aten.div, aten.mul, aten.add]
...
def get_args():
    ...
    arg0_1 = rand_strided((64, 64), (64, 1), device='npu:0', dtype=torch.float32)
    arg1_1 = rand_strided((64, 64), (64, 1), device='npu:0', dtype=torch.float32)
    arg2_1 = rand_strided((64, 64), (64, 1), device='npu:0', dtype=torch.float32)
