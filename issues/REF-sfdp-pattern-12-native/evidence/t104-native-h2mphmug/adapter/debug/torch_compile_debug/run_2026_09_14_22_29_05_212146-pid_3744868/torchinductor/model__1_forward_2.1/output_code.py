...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/ge/cgeliu2diup6pi5vfditw3jtdjerlpzopjwuzem4nmthqaipmupy.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/uc/cucrdchtuujauozjr34vtgsr3xwjjwi4itllbiccui74zgskmd65.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/hj/chjgsi527fcmyqnopzzs46uy5fqmu44nh37loozeax72ncwmqzao.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/pe/cpesnlc4dvm6faq7o2yvhdbz4n7tvqmeybhcgsxpalp3q6g5gkm3.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/o4/co4nxzo4tpsuiu3u6x4jgf3okoglljcwxw6uhk2a3zu3tcinh3f6.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/lw/clw5stj3tdlzihtt6633n5yd5jdnoydqyhwy5oybtgnuh3ewfltn.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/7t/c7tb2vncverstr5mzujiysyi7yxwdgkghefdrja2wqkx4igfwd2w.py
...
# kernel path: /home/z50063656/tmp/t104-native-h2mphmug/adapter/inductor-cache/tmpvzdxo52h/ih/cih7mc75w3ia4qn2wh67a46xxxtzz6jccerxan4jidfzk24utaxw.py
# Topologically Sorted Source Nodes: [matmul, , softmax], Original ATen: [aten.matmul, aten.div, aten.mul, aten.amax, aten.sub, aten.all, aten._softmax]
# Source node to ATen node mapping:
#    => amax_default, amax_default_1, div_tensor, div_tensor_1, logical_not_default_1, mul_tensor, sub_tensor, sub_tensor_1, where_self
#   matmul => view_2
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf10 = torch.ops.npu._npu_dropout.default(buf9, 0.4)
            buf11 = buf10[0]
            assert_alignment(buf11, 16, 'torch.ops.npu._npu_dropout.default')
            buf12 = buf10[1]
            assert_alignment(buf12, 16, 'torch.ops.npu._npu_dropout.default')
            del buf10
            ...
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_matmul_transpose_0.run(primals_3, buf13, 4096, stream=raw_stream0)
            buf14 = empty_strided_npu((64, 2, 32), (64, 32, 1), torch.float32)
            # Topologically Sorted Source Nodes: [transpose_2, matmul_1], Original ATen: [aten.transpose, aten.matmul]
            # [Provenance debug handles] extern_kernels.bmm:4
            extern_kernels.bmm(reinterpret_tensor(buf11, (64, 2, 2), (4, 2, 1), 0), reinterpret_tensor(buf13, (64, 2, 32), (64, 32, 1), 0), out=buf14)
            del buf13
        return (reinterpret_tensor(buf14, (4, 16, 2, 32), (1024, 64, 32, 1), 0), reinterpret_tensor(primals_2, (4, 16, 2, 32), (1024, 32, 512, 1), 0), reinterpret_tensor(primals_3, (4, 16, 2, 32), (1024, 32, 512, 1), 0), reinterpret_tensor(primals_1, (4, 16, 32, 2), (1024, 32, 1, 512), 0), buf9, buf11, buf12, )
