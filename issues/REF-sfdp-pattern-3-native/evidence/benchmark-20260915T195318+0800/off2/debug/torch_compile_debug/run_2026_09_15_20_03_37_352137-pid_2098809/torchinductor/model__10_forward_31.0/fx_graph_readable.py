class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[2, 4, 8, 16]", primals_2: "f16[2, 4, 8, 16]", primals_3: "f16[2, 4, 8, 16]"):
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:89 in _sfdp_pattern_3, code: torch.matmul(query, key.transpose(-2, -1))
        ...
        div_tensor: "f16[2, 4, 8, 8]" = torch.ops.aten.div.Tensor(view_2, 2.0)
        ...
        div_tensor_1: "f32[2, 4, 8, 8]" = torch.ops.aten.div.Tensor(sub_tensor, 2.0);  sub_tensor = None
        ...
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:91 in _sfdp_pattern_3, code: .softmax(dim=-1),
        ...
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:88 in _sfdp_pattern_3, code: return torch.nn.functional.dropout(
        ...
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:93 in _sfdp_pattern_3, code: ).matmul(value)
