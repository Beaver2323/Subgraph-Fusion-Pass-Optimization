...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = torch.ops.npu.npu_fusion_attention_v3.default(arg1_1, arg0_1, arg2_1, 2, 'BNSD', None, None, None, 0.3333333333333333, keep_prob=1.0, pre_tockens=2147483647, next_tockens=2147483647, inner_precise=0, prefix=None, actual_seq_qlen=None, actual_seq_kvlen=None, sparse_mode=0, gen_mask_parallel=True, sync=False, softmax_layout='', sink=None)
            del arg0_1
            del arg1_1
            del arg2_1
            buf1 = buf0[0]
