class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 2, 16, 32]", primals_2: "f32[4, 2, 16, 32]", primals_3: "f32[4, 2, 16, 32]", getitem_9: "f32[0]", tangents_1: "f32[4, 2, 16, 32]"):
        ...
        npu_fusion_attention_v3_default = torch.ops.npu.npu_fusion_attention_v3.default(primals_1, primals_2, primals_3, 2, 'BNSD', None, None, None, 0.3333333333333333, 0.6)

        # ac_graph_id: 4 - PREFER_RECOMPUTE Backward of forward node: File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:334 in dot_prod_attention, code: ).matmul(value)
