class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 2, 16, 32]", primals_2: "f32[4, 2, 16, 32]", primals_3: "f32[4, 2, 16, 32]"):
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:330 in dot_prod_attention, code: torch.matmul(query, key.transpose(-2, -1)).div(3.0).softmax(dim=-1),
        ...
        div_tensor: "f32[4, 2, 16, 16]" = torch.ops.aten.div.Tensor(view_2, 3.0)
        ...
        div_tensor_1: "f32[4, 2, 16, 16]" = torch.ops.aten.div.Tensor(sub_tensor, 3.0);  sub_tensor = None
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:329 in dot_prod_attention, code: return torch.nn.functional.dropout(
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:334 in dot_prod_attention, code: ).matmul(value)
