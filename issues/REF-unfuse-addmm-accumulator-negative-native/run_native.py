#!/usr/bin/env python3
"""T-078 computed-accumulator addmm 负例的原生入口预检与适配调度。"""
...
METHOD = "TestPatternMatcher.test_preserve_accumulator_addmm_with_pointwise"
...
root = WORK / "t078-npu-results" / "REF-unfuse-addmm-accumulator-negative-native"
