#!/usr/bin/env python3
"""复用上游 addmm bias unfuse 核心方法；只适配设备与测试入口。"""
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location(
        "t078_unfuse_addmm_core_upstream", SOURCE
    )
    ...
    summary = {
        ...
        "adapter_deviation": [
            "GPU_TYPE=npu",
            "显式构造原 TestPatternMatcher 方法，绕过 HAS_GPU 启动门",
            "不改变三个子场景、shape、torch.compile 或 FileCheck 判据",
        ],
