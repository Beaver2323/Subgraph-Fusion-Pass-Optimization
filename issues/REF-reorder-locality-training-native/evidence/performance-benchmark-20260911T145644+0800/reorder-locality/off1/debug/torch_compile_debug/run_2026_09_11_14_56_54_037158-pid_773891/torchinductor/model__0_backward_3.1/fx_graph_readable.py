class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[16, 16]", primals_2: "f32[8, 16]", primals_3: "f32[16, 16]", mm: "f32[8, 16]", mm_1: "f32[8, 16]", tangents_1: "f32[8]"):
        # Backward of forward node: File: /home/z50063656/Pass/Subgraph-Fusion-Pass-Optimization/runners/t087_t090_performance_worker.py:267 in forward, code: return (a * b + torch.sin(a) * torch.cos(b)).sum(dim=1)
        ...
        # Backward of forward node: File: /home/z50063656/Pass/Subgraph-Fusion-Pass-Optimization/runners/t087_t090_performance_worker.py:265 in forward, code: a = torch.tanh(x @ self.w1)
        ...
        # Backward of forward node: File: /home/z50063656/Pass/Subgraph-Fusion-Pass-Optimization/runners/t087_t090_performance_worker.py:266 in forward, code: b = torch.sigmoid(x @ self.w2)
        ...
        mul_7: "f32[8, 16]" = torch.ops.aten.mul.Tensor(expand, sigmoid);  expand = None
        ...
        mul_8: "f32[8, 16]" = torch.ops.aten.mul.Tensor(sigmoid, sub);  sigmoid = sub = None
