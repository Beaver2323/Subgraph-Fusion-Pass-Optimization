...
# kernel path: /home/z50063656/tmp/t087-npu-results/benchmark-20260911T145644+0800/reorder-locality/on3/inductor-cache/tmparzw6pm1/oh/cohjayhbiv5pivvhjwbokdgo6xc2mdskd6ylfau3v7m5siuf2ic2.py
# Topologically Sorted Source Nodes: [unsqueeze, expand, a, sin, mul_2, b, sin_1, neg, mul_4, mul_6, add_2, sub, mul_8, mul_9, matmul_backward, cos, mul_3, cos_1, mul_5, mul_7, add_1, mul_10, sub_1, mul_11, matmul_backward_1], Original ATen: [aten.unsqueeze, aten.expand, aten.tanh, aten.sin, aten.mul, aten.sigmoid, aten.neg, aten.add, aten.sigmoid_backward, aten.matmul_backward, aten.cos, aten.tanh_backward]
