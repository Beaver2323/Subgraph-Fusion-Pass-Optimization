#!/usr/bin/env python3
"""复用上游 same-shape leaf-bias addmm 正例；只适配设备与入口。"""
...
METHOD = "test_unfuse_same_shape_leaf_bias_addmm"
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location("t078_unfuse_addmm_leaf_upstream", SOURCE)
    ...
    summary = {
        ...
        "adapter_deviation": [
            ...
            "不改变 Parameter leaf、shape、数值断言或 addmm FileCheck",
        ],
