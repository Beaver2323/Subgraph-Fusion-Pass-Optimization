#!/usr/bin/env python3
"""T-078 same-shape leaf-bias addmm 正例的原生入口预检与适配调度。"""
...
METHOD = "TestPatternMatcher.test_unfuse_same_shape_leaf_bias_addmm"
...
root = WORK / "t078-npu-results" / "REF-unfuse-addmm-leaf-native"
