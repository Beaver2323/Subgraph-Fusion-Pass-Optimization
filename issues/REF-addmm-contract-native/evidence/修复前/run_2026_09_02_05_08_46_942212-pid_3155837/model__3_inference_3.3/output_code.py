...
#   add_1 => add_1
# Graph fragment:
#   %arg2_1 : Tensor "f32[1, 16, 16][256, 16, 1]npu:0" = PlaceHolder[target=arg2_1]
#   %mm : Tensor "f32[16, 16][16, 1]npu:0" = PlaceHolder[target=mm]
#   %mm_1 : Tensor "f32[16, 16][16, 1]npu:0" = PlaceHolder[target=mm_1]
#   %add : Tensor "f32[1, 16, 16][256, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg2_1, %mm), kwargs = {})
#   %add_1 : Tensor "f32[1, 16, 16][256, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_1, %arg2_1), kwargs = {})
#   return %add,%add_1
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf1 = reinterpret_tensor(buf0, (1, 16, 16), (256, 16, 1), 0); del buf0  # reuse
            buf3 = reinterpret_tensor(buf2, (1, 16, 16), (256, 16, 1), 0); del buf2  # reuse
            # Topologically Sorted Source Nodes: [add, add_1], Original ATen: [aten.add]
...
def get_args():
    ...
    arg2_1 = rand_strided((1, 16, 16), (256, 16, 1), device='npu:0', dtype=torch.float32)
