class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[16, 16]", arg1_1: "f32[16, 16]"):
        ...
        add: "f32[16, 16]" = torch.ops.aten.add.Tensor(4, mm);  mm = None
        mm_1: "f32[16, 16]" = torch.ops.aten.mm.default(arg0_1, arg1_1);  arg0_1 = arg1_1 = None
        add_1: "f32[16, 16]" = torch.ops.aten.add.Tensor(mm_1, 4);  mm_1 = None
        return (add, add_1)
