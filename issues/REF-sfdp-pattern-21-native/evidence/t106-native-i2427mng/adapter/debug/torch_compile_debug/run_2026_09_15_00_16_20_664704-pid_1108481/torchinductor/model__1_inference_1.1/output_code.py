...
# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/qc/cqcesuwhlktntyty4rhr6263lvyqoaivbggehiewmbmtty5p3jp2.py
...
# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/yy/cyykchrp3ahibilargerd5fwf34zqateyek4a6mvb675arsykgj3.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.permute, aten.transpose, aten.mul]
# Source node to ATen node mapping:
...
#   %permute_default_1 : Tensor "f32[1, 16, 2, 32][1024, 32, 512, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%arg1_1, [0, 2, 1, 3]), kwargs = {})
...
triton_unk_fused_mul_permute_transpose_1 = async_compile.triton('triton_unk_fused_mul_permute_transpose_1', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/u4/cu4a733cmcm2ytd32xf4ztqjnj3dvihsb3hndpjwqm54u4eeltgp.py
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 64}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'out_ptr0': '*i1', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [2, 32, {'divisors': [1, 2]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 2, 'divisor': 1, 'seed': 1}, {'name': 'x1', 'length': 32, 'divisor': 2, 'seed': 2}]},
...
# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/6p/c6p7ezoczhsdq4qmcinmbtvfglkkac2g4xxqzz2liml7rlt75zma.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 64}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [2, 16, 2, {'divisors': [1, 2, 32]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 2, 'divisor': 1, 'seed': 1}, {'name': 'x2', 'length': 16, 'divisor': 2, 'seed': 2}, {'name': 'x3', 'length': 2, 'divisor': 32, 'seed': 2}]},
...
def triton_unk_fused__safe_softmax_add_matmul_3(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + (2 * x2 + 32 * x3) + _es_lane0, x2mask & x3mask & ((2 * x2 + 32 * x3 + _es_lane0 >= 0) & (2 * x2 + 32 * x3 + _es_lane0 < 64)), eviction_policy='evict_last')
        tmp0 = extract_slice(_es_full0, [0, 0, 0], [_es_full0.shape[0], _es_full0.shape[1], 1], [1, 1, 1])
        tmp1 = tl.load(in_ptr1 + (0))
        tmp2 = tmp1
        _es_lane1 = tl.arange(0, 2)[None, None, :]
        _es_full1 = tl.load(in_ptr0 + (1 + 2 * x2 + 32 * x3) + _es_lane1, x2mask & x3mask & ((1 + 2 * x2 + 32 * x3 + _es_lane1 >= 0) & (1 + 2 * x2 + 32 * x3 + _es_lane1 < 64)), eviction_policy='evict_last')
        ...
        tl.store(out_ptr0 + (x0 + 2*x2 + 32*x3), tmp8, x0mask & x2mask & x3mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/lc/clct2d3boongipa2ihz7qjgvr3dw63kytfrs6gqk2bmrbbcau7eg.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 64}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3, 4), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [2, 16, 2, {'divisors': [1, 2, 32]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 2, 'divisor': 1, 'seed': 1}, {'name': 'x2', 'length': 16, 'divisor': 2, 'seed': 2}, {'name': 'x3', 'length': 2, 'divisor': 32, 'seed': 2}]},
...
def triton_unk_fused__safe_softmax_add_matmul_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        tmp2 = tmp1
        _es_lane1 = tl.arange(0, 2)[None, None, :]
        _es_full1 = tl.load(in_ptr2 + (2 * x2 + 32 * x3) + _es_lane1, x2mask & x3mask & ((2 * x2 + 32 * x3 + _es_lane1 >= 0) & (2 * x2 + 32 * x3 + _es_lane1 < 64)), eviction_policy='evict_last')
        tmp4 = extract_slice(_es_full1, [0, 0, 0], [_es_full1.shape[0], _es_full1.shape[1], 1], [1, 1, 1])
        _es_lane2 = tl.arange(0, 2)[None, None, :]
        _es_full2 = tl.load(in_ptr0 + (1 + 2 * x2 + 32 * x3) + _es_lane2, x2mask & x3mask & ((1 + 2 * x2 + 32 * x3 + _es_lane2 >= 0) & (1 + 2 * x2 + 32 * x3 + _es_lane2 < 64)), eviction_policy='evict_last')
        ...
        _es_full3 = tl.load(in_ptr2 + (1 + 2 * x2 + 32 * x3) + _es_lane3, x2mask & x3mask & ((1 + 2 * x2 + 32 * x3 + _es_lane3 >= 0) & (1 + 2 * x2 + 32 * x3 + _es_lane3 < 64)), eviction_policy='evict_last')
        ...
        tmp14 = tmp6 + tmp13
        tl.store(out_ptr0 + (x0 + 2*x2 + 32*x3), tmp14, x0mask & x2mask & x3mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/6n/c6nl4irjx42cds42oxcyr35jvbgsjbropy6y3ynqh2y2rz7rdkgv.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-i2427mng/adapter/inductor-cache/tmpglas2bm_/wr/cwrwoxhjadromruwa5o3naxwlx526qkmdxlskwj7r6j4xvfc4gdu.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
# Graph fragment:
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 64}, 
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*i1', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3, 4, 5), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [2, 32, {'divisors': [1, 2]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 2, 'divisor': 1, 'seed': 1}, {'name': 'x1', 'length': 32, 'divisor': 2, 'seed': 2}]},
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.permute, aten.transpose, aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_mul_permute_transpose_1.run(arg1_1, buf1, 512, 2, stream=raw_stream0)
            del arg1_1
            ...
            del arg3_1
            del buf8
        return (reinterpret_tensor(buf9, (1, 16, 2, 32), (1024, 64, 32, 1), 0), )
