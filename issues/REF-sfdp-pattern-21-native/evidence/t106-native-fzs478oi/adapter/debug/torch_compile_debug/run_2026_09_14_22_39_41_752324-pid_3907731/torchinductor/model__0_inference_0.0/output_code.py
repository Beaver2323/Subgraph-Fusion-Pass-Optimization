...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/zi/cziymxfd7mjgxqx7bzblzcwzay5w734x54jqr54ezjd5szgmtiw3.py
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/2f/c2fzyqjal4tidfupi52q5suwdqts6rqyn2rgaorj3dz6bm4wrnlv.py
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/2f/c2fspjnql5qc5cuclrkkoexdnqmj5sburucsalez2irs2pumthvy.py
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/yp/cypadxrtuluhp5rrhlgjltru3tlfsofexrppcos4msklz4k6vqt2.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/d3/cd3t4arakow5lolzo52q3czqpr5v5sppeikrj3updjd2gtyilpyo.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax_add_matmul_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full2 = tl.load(in_ptr0 + (1 + 2 * x2 + 128 * x3) + _es_lane2, x2mask & x3mask, eviction_policy='evict_last')
        tmp7 = extract_slice(_es_full2, [0, 0, 0], [real_block_x3, real_block_x2, 1], [1, 1, 1])
        tmp8 = tl.load(in_ptr1 + (1))
        tmp9 = tmp8
        _es_lane3 = tl.arange(0, 2)[None, None, :]
        _es_full3 = tl.load(in_ptr2 + (1 + 2 * x2 + 128 * x3) + _es_lane3, x2mask & x3mask, eviction_policy='evict_last')
        tmp11 = extract_slice(_es_full3, [0, 0, 0], [real_block_x3, real_block_x2, 1], [1, 1, 1])
        tmp3 = tmp0 + tmp2
        tmp5 = tmp3 - tmp4
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/6f/c6fixvxvqkhex5n6yukkh2mjked4tzytrqfdeerivaupncfrwyiz.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/jd/cjd4gquv3luhv573duse2zvunqm2qycjcfada33fwqkq3g7pbhvy.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t106-native-fzs478oi/adapter/inductor-cache/tmpf5c7j6zw/vr/cvrufcuwz23u6ianr3febkkgoxt6ghvpyyb2gy3wu65zznqg7myr.py
