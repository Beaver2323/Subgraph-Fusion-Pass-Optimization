...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/qc/cqcesuwhlktntyty4rhr6263lvyqoaivbggehiewmbmtty5p3jp2.py
...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/yy/cyykchrp3ahibilargerd5fwf34zqateyek4a6mvb675arsykgj3.py
...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/u4/cu4a733cmcm2ytd32xf4ztqjnj3dvihsb3hndpjwqm54u4eeltgp.py
...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/wm/cwmwkfaanm7s7i3ubcpieqbiweajqw5pcljl4tnihnpsnkmn4nwu.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax_add_matmul_3(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + (2 * x2 + 32 * x3) + _es_lane0, x2mask & x3mask, eviction_policy='evict_last')
        tmp0 = extract_slice(_es_full0, [0, 0, 0], [real_block_x3, real_block_x2, 1], [1, 1, 1])
        tmp1 = tl.load(in_ptr1 + (0))
        tmp2 = tmp1
        _es_lane1 = tl.arange(0, 2)[None, None, :]
        _es_full1 = tl.load(in_ptr0 + (1 + 2 * x2 + 32 * x3) + _es_lane1, x2mask & x3mask, eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/vn/cvny6tbjsff6xkzmvimm6gg4bjmf6s5wrbx5joizxcql6v2ztghn.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax_add_matmul_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        tmp2 = tmp1
        _es_lane1 = tl.arange(0, 2)[None, None, :]
        _es_full1 = tl.load(in_ptr2 + (2 * x2 + 32 * x3) + _es_lane1, x2mask & x3mask, eviction_policy='evict_last')
        tmp4 = extract_slice(_es_full1, [0, 0, 0], [real_block_x3, real_block_x2, 1], [1, 1, 1])
        _es_lane2 = tl.arange(0, 2)[None, None, :]
        _es_full2 = tl.load(in_ptr0 + (1 + 2 * x2 + 32 * x3) + _es_lane2, x2mask & x3mask, eviction_policy='evict_last')
        ...
        _es_full3 = tl.load(in_ptr2 + (1 + 2 * x2 + 32 * x3) + _es_lane3, x2mask & x3mask, eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/6n/c6nl4irjx42cds42oxcyr35jvbgsjbropy6y3ynqh2y2rz7rdkgv.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-etfwqegi/adapter/inductor-cache/tmpt48wost6/wr/cwrwoxhjadromruwa5o3naxwlx526qkmdxlskwj7r6j4xvfc4gdu.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
# Graph fragment:
