...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/kk/ckkamhw5kdix7dvbiqqn3ci52p77zrsvbmmrscy6g4bajefdwnnh.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/hq/chqqohgrigaws3zogcw2zolisf5ygycxyzb4vyjicegaglxsks75.py
...
#   %permute_default_1 : Tensor "f16[2, 8, 4, 16][512, 16, 128, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%arg1_1, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/fa/cfasa73nfzzzv7ryxnjy67zojq5scnl45j7jg3lrbqslhze6edyk.py
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/ty/ctyyiwtiovna3xpeycttoxbz2njk7i7fwsfz3hnxhum6qypnq2na.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax__to_copy_add_matmul_3(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + (4 * x1 + 128 * x2) + _es_lane0, x1mask & x2mask, eviction_policy='evict_last')
        tmp0 = extract_slice(_es_full0, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane1 = tl.arange(0, 4)[None, None, :]
        _es_full1 = tl.load(in_ptr1 + 4 * x2 + _es_lane1, x2mask, eviction_policy='evict_last')
        tmp1 = extract_slice(_es_full1, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane2 = tl.arange(0, 4)[None, None, :]
        _es_full2 = tl.load(in_ptr0 + (1 + 4 * x1 + 128 * x2) + _es_lane2, x1mask & x2mask, eviction_policy='evict_last')
        tmp5 = extract_slice(_es_full2, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane3 = tl.arange(0, 4)[None, None, :]
        _es_full3 = tl.load(in_ptr1 + (1 + 4 * x2) + _es_lane3, x2mask, eviction_policy='evict_last')
        tmp6 = extract_slice(_es_full3, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane4 = tl.arange(0, 4)[None, None, :]
        _es_full4 = tl.load(in_ptr0 + (2 + 4 * x1 + 128 * x2) + _es_lane4, x1mask & x2mask, eviction_policy='evict_last')
        tmp11 = extract_slice(_es_full4, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane5 = tl.arange(0, 4)[None, None, :]
        _es_full5 = tl.load(in_ptr1 + (2 + 4 * x2) + _es_lane5, x2mask, eviction_policy='evict_last')
        tmp12 = extract_slice(_es_full5, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane6 = tl.arange(0, 4)[None, None, :]
        _es_full6 = tl.load(in_ptr0 + (3 + 4 * x1 + 128 * x2) + _es_lane6, x1mask & x2mask, eviction_policy='evict_last')
        tmp17 = extract_slice(_es_full6, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        _es_lane7 = tl.arange(0, 4)[None, None, :]
        _es_full7 = tl.load(in_ptr1 + (3 + 4 * x2) + _es_lane7, x2mask, eviction_policy='evict_last')
        tmp18 = extract_slice(_es_full7, [0, 0, 0], [real_block_x2, real_block_x1, 1], [1, 1, 1])
        tmp2 = tmp1.to(tl.float32)
        tmp3 = tmp2.to(tl.float32)
        tmp4 = tmp0 + tmp3
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/rr/crrbmmthrpqlks6ghim553eg4flk2bfgrquhutri2w76yfmn652a.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax__to_copy_add_matmul_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full1 = tl.load(in_ptr1 + 4 * x1 + _es_lane1, x1mask, eviction_policy='evict_last')
        tmp1 = extract_slice(_es_full1, [0, 0], [real_block_x1, 1], [1, 1])
        ...
        _es_full4 = tl.load(in_ptr1 + (1 + 4 * x1) + _es_lane4, x1mask, eviction_policy='evict_last')
        tmp9 = extract_slice(_es_full4, [0, 0], [real_block_x1, 1], [1, 1])
        ...
        _es_full7 = tl.load(in_ptr1 + (2 + 4 * x1) + _es_lane7, x1mask, eviction_policy='evict_last')
        tmp18 = extract_slice(_es_full7, [0, 0], [real_block_x1, 1], [1, 1])
        ...
        _es_full10 = tl.load(in_ptr1 + (3 + 4 * x1) + _es_lane10, x1mask, eviction_policy='evict_last')
        tmp27 = extract_slice(_es_full10, [0, 0], [real_block_x1, 1], [1, 1])
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/th/cthhhsf2xu75mkk5diqewg6f3gm3og7iqz3xpsi5dikfumepiiyz.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/5i/c5ibgktsksgksrg3egbilllc6qvmrmgom4nxl5efaqcpzfgphzle.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/ua/cua5e6wrjtqsvznwyi7v43yftebetkyawgbylpf76aqj2bog5jhu.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, convert_element_type_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, view_default_2, where_self
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/eq/ceqppph7dlrdb343nyd64yo2opblkp3j2vll6v6www3y4qqujlom.py
...
#   %permute_default_2 : Tensor "f16[2, 8, 4, 16][512, 16, 128, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%arg2_1, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T232759+0800/pattern-21/off/inductor-cache/tmpnqocupkx/ra/crasb3ccsyoeryap2fdlo737bxukx7wtzj4kfpvkq4oxsi7u66u4.py
