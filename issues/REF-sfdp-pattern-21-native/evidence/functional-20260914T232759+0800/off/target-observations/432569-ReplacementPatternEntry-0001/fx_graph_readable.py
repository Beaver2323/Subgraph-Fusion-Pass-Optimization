...
def forward(self, arg0_1, arg1_1, arg2_1, arg3_1):
    ...
    add = torch.ops.aten.add.Tensor(view_2, arg3_1);  view_2 = arg3_1 = None
    convert_element_type_2 = torch.ops.prims.convert_element_type.default(add, torch.float16);  add = None
    ...
    amax = torch.ops.aten.amax.default(convert_element_type_3, [-1], True)
    sub = torch.ops.aten.sub.Tensor(convert_element_type_3, amax);  convert_element_type_3 = amax = None
    exp = torch.ops.aten.exp.default(sub);  sub = None
    sum_1 = torch.ops.aten.sum.dim_IntList(exp, [-1], True)
    div = torch.ops.aten.div.Tensor(exp, sum_1);  exp = sum_1 = None
    convert_element_type_4 = torch.ops.prims.convert_element_type.default(div, torch.float16);  div = None
    expand_2 = torch.ops.aten.expand.default(convert_element_type_4, [2, 8, 4, 4]);  convert_element_type_4 = None
    view_3 = torch.ops.aten.view.default(expand_2, [16, 4, 4]);  expand_2 = None
    expand_3 = torch.ops.aten.expand.default(permute_2, [2, 8, 4, 16]);  permute_2 = None
