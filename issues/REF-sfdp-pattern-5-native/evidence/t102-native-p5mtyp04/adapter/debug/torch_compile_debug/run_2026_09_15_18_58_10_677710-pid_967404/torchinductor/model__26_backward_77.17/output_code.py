...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/lp/clps2vzkfs2rbggwey2i2bt62rn65yireirmwgpremydbsy45f7w.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/pn/cpnpz4loddkvuoej5efprzxcybfi2mp33je5qvkhuujk46w4cpzb.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/ra/cragwt5whudtdvj5mxhzmhtxqy7r6cr5mi5hzl6fnhu3snfhescb.py
...
#   %mul_scalar : Tensor "f32[4, 2, 16, 32][1024, 512, 32, 1]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Scalar](args = (%primals_1, 0.4167804918837871), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/4w/c4w2blxn3w7jangixpqeseji5bm3dujfkxlbzlbr7mmabnvlac4s.py
...
#   %mul_scalar_1 : Tensor "f32[4, 2, 32, 16][1024, 512, 1, 32]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Scalar](args = (%permute_default, 0.4167804918837871), kwargs = {})
...
def triton_unk_fused_mul_transpose_3(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        tmp1 = tl.full([1, 1], 0.4167804918837871, tl.float32)
        tmp2 = tmp0 * tmp1
        tl.store(out_ptr0 + (x2 + 16*y0 + 512*y1), tmp2, x2mask & y0mask & y1mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/pl/cplubiut47ks5xwqqfg3totqq66pt6kls4zpub6drpwoaxj74lxp.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/f2/cf2esr22dzzsf6qec5s6ccf3hgacyhs3vnd45z2dphifdq6lke45.py
# Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/33/c33jlojvxm7yyxwfmhzkzxq24itacum46nniwnvbfoeoiamejx7f.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpyot5m79g/ep/cep2itbngq2mvzodysipfla5v2ot3k7pm762kes3vf3mwqhu2inr.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#    => mul_scalar_2
# Graph fragment:
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # [Provenance debug handles] torch.ops.aten.logical_and.default:13
            ...
            # Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
            # [Provenance debug handles] torch.ops.aten.any.dim:15
            ...
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:16
            ...
            del buf10
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._softmax_backward_data, aten.matmul_backward]
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:17
