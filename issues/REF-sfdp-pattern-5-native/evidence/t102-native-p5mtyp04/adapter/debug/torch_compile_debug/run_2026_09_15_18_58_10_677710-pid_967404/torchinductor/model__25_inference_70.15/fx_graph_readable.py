class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[4, 2, 16, 32]", arg1_1: "f32[4, 2, 16, 32]", arg2_1: "f32[4, 2, 16, 32]"):
        # ac_graph_id: 10 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:387 in sfdp_pattern_5_v3, code: attn_mask = torch.ones(
        ...
        # ac_graph_id: 10 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:389 in sfdp_pattern_5_v3, code: ).tril(diagonal=0)
        ...
        # ac_graph_id: 10 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:391 in sfdp_pattern_5_v3, code: torch.logical_not(attn_mask), -float("inf")
        logical_not: "b8[16, 16]" = torch.ops.aten.logical_not.default(logical_and)

        # ac_graph_id: 10 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:390 in sfdp_pattern_5_v3, code: attn_mask = attn_mask.masked_fill(
        ...
        # ac_graph_id: 10 - PREFER_RECOMPUTE No stacktrace found for following nodes
        convert_element_type_default: "f32[16, 16]" = torch.ops.prims.convert_element_type.default(where, torch.float32);  where = None
        mul_scalar: "f32[4, 2, 16, 32]" = torch.ops.aten.mul.Scalar(arg0_1, 0.4167804918837871);  arg0_1 = None
        ...
        # ac_graph_id: 10 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:398 in sfdp_pattern_5_v3, code: return attn_weight @ value
