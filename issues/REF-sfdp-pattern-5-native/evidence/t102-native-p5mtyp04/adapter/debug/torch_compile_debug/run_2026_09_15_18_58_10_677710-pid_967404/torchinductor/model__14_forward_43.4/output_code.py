...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpkg9g5llo/hu/chul34wo73dosgps7a7lruccvpm4wkwam3tm6citkatbjnfze32e.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpkg9g5llo/vl/cvlf3izkjjpfy6vc7lrz4jzxcdypieyik3r2tklpqaizmdh46uzr.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpkg9g5llo/5j/c5jftdq6opf24s3bmy57lq6tlwpxjgt5kudgvmdcm62csvafptth.py
...
#   %mul_scalar : Tensor "f32[4, 2, 16, 32][1024, 512, 32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%primals_1, 0.42044820762685725), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpkg9g5llo/b5/cb5mm55nbfhg7z5w7sl4ksjokfhw43expkm5wtd3bau5slnizgsr.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpkg9g5llo/cf/ccfshom5mujxezw5wkwvf4wm2o2dn6ualglxwipadwh5v3lijw7p.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpkg9g5llo/ll/cll6cod3ays7pkqw7w3rlrny6lvamycq6o5qv66svjcncrzynkdi.py
# Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            del buf10
        return (reinterpret_tensor(buf11, (4, 2, 16, 32), (1024, 512, 32, 1), 0), primals_1, primals_2, primals_3, )
