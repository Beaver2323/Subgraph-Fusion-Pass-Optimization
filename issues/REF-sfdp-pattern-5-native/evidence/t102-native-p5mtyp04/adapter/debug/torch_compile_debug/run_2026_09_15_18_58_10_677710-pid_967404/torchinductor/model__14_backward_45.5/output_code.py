...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/lp/clps2vzkfs2rbggwey2i2bt62rn65yireirmwgpremydbsy45f7w.py
# Topologically Sorted Source Nodes: [attn_mask], Original ATen: [aten.tril]
# Source node to ATen node mapping:
#   attn_mask => iota, le, sub, unsqueeze, unsqueeze_1
# Graph fragment:
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_tril_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 0, 'num_reduction': 0, 'npu_num_x_nodes': 2, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/pn/cpnpz4loddkvuoej5efprzxcybfi2mp33je5qvkhuujk46w4cpzb.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/nb/cnbhttidhhstzcfyl72vtdr3xfm56dry3m6sbhjietw2vkqxhexz.py
...
#   %mul_scalar : Tensor "f32[4, 2, 16, 32][1024, 512, 32, 1]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Scalar](args = (%primals_1, 0.42044820762685725), kwargs = {})
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_mul_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/ye/cyew5ib72ovu3gpzly4pq6mtis5ee4zhl54pbmfld3cgveqehodd.py
...
#   %permute_default : Tensor "f32[4, 2, 32, 16][1024, 512, 1, 32]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%primals_2, [0, 1, 3, 2]), kwargs = {})
#   %mul_scalar_1 : Tensor "f32[4, 2, 32, 16][1024, 512, 1, 32]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Scalar](args = (%permute_default, 0.42044820762685725), kwargs = {})
#   return %expand_default_1
triton_unk_fused_mul_transpose_3 = async_compile.triton('triton_unk_fused_mul_transpose_3', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
def triton_unk_fused_mul_transpose_3(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        tmp1 = tl.full([1, 1], 0.42044820762685725, tl.float32)
        tmp2 = tmp0 * tmp1
        tl.store(out_ptr0 + (x2 + 16*y0 + 512*y1), tmp2, x2mask & y0mask & y1mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/pl/cplubiut47ks5xwqqfg3totqq66pt6kls4zpub6drpwoaxj74lxp.py
# Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, convert_element_type_default, eq_scalar, logical_not_default, view_default_2
#   attn_mask_1 => full_default_1, where
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/f2/cf2esr22dzzsf6qec5s6ccf3hgacyhs3vnd45z2dphifdq6lke45.py
# Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
#   %where_self : Tensor "f32[4, 2, 16, 16][512, 256, 16, 1]npu:0"[num_users=3] = call_function[target=torch.ops.aten.where.self](args = (%logical_not_default_1, %full_default_2, %div_tensor), kwargs = {})
#   return %amax_default,%sum_dim_int_list,%where_self
...
@triton.jit
def triton_unk_fused__safe_softmax__to_copy_add_logical_not_masked_fill_matmul_5(in_out_ptr0, in_ptr0, in_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 128
    r0_numel = 16
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/33/c33jlojvxm7yyxwfmhzkzxq24itacum46nniwnvbfoeoiamejx7f.py
...
#   return %sum_dim_int_list_1,%buf15
triton_unk_fused__softmax_backward_data_matmul_backward_6 = async_compile.triton('triton_unk_fused__softmax_backward_data_matmul_backward_6', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@npu_triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__softmax_backward_data_matmul_backward_6', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 1, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
def triton_unk_fused__softmax_backward_data_matmul_backward_6(in_out_ptr0, in_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 128
    r0_numel = 16
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmppy9a25ct/r4/cr4nyyc24uetnkc4g55yeqqzo55zehbnua7564fvgpvrdvt6koyo.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#    => mul_scalar_2
# Graph fragment:
#   %getitem_7 : Tensor "f32[4, 2, 32, 16][1024, 512, 16, 1]npu:0" = PlaceHolder[target=getitem_7]
#   %mul_scalar_2 : Tensor "f32[4, 2, 32, 16][1024, 512, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%getitem_7, 0.42044820762685725), kwargs = {})
#   return %mul_scalar_2
triton_unk_fused_mul_7 = async_compile.triton('triton_unk_fused_mul_7', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_mul_7', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused_mul_7(in_out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 4096
    x_g_tile0 : tl.constexpr = (4096) if (4096) < (XBLOCK) else (XBLOCK)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # Topologically Sorted Source Nodes: [ones, attn_mask], Original ATen: [aten.ones, aten.tril]
            # [Provenance debug handles] torch.ops.aten.logical_and.default:3
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_mul_2.run(primals_1, buf3, 4096, stream=raw_stream0)
            del primals_1
            buf4 = empty_strided_npu((4, 2, 32, 16), (1024, 512, 16, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.transpose, aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_mul_transpose_3.run(primals_2, buf4, 256, 16, stream=raw_stream0)
            del primals_2
            buf5 = empty_strided_npu((8, 16, 16), (256, 16, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.mul, aten.transpose, aten.matmul]
            # [Provenance debug handles] extern_kernels.bmm:4
            extern_kernels.bmm(reinterpret_tensor(buf3, (8, 16, 32), (512, 32, 1), 0), reinterpret_tensor(buf4, (8, 32, 16), (512, 16, 1), 0), out=buf5)
            buf8 = empty_strided_npu((4, 2, 16, 16), (512, 256, 16, 1), torch.bool)
            # Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__safe_softmax__to_copy_add_logical_not_masked_fill_matmul_4.run(buf5, buf2, buf8, 2048, stream=raw_stream0)
            # Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
            # [Provenance debug handles] torch.ops.aten.any.dim:5
            ...
            # Topologically Sorted Source Nodes: [logical_not, attn_mask_1, ], Original ATen: [aten.logical_not, aten.masked_fill, aten._to_copy, aten.matmul, aten.add, aten._safe_softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__safe_softmax__to_copy_add_logical_not_masked_fill_matmul_5.run(buf10, buf2, buf9, 128, 16, stream=raw_stream0)
            del buf2
            del buf9
            tangents_1 = copy_if_misaligned(tangents_1)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul_backward]
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:6
            buf11 = torch.ops.aten.matmul_backward.default(tangents_1, buf10, primals_3, [True, True])
            del primals_3
            del tangents_1
            buf12 = buf11[0]
            assert_alignment(buf12, 16, 'torch.ops.aten.matmul_backward.default')
            buf13 = buf11[1]
            assert_alignment(buf13, 16, 'torch.ops.aten.matmul_backward.default')
            del buf11
            buf15 = buf12; del buf12  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._softmax_backward_data, aten.matmul_backward]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_backward_data_matmul_backward_6.run(buf15, buf10, 128, 16, stream=raw_stream0)
            del buf10
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._softmax_backward_data, aten.matmul_backward]
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:7
            buf16 = torch.ops.aten.matmul_backward.default(buf15, buf3, buf4, [True, True])
            del buf15
            del buf3
            del buf4
            buf17 = buf16[0]
            assert_alignment(buf17, 16, 'torch.ops.aten.matmul_backward.default')
            buf18 = buf16[1]
            assert_alignment(buf18, 16, 'torch.ops.aten.matmul_backward.default')
            del buf16
            buf19 = buf18; del buf18  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_mul_7.run(buf19, 4096, stream=raw_stream0)
            buf20 = buf17; del buf17  # reuse
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul_backward]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_mul_7.run(buf20, 4096, stream=raw_stream0)
        return (buf20, reinterpret_tensor(buf19, (4, 2, 16, 32), (1024, 512, 1, 16), 0), buf13, )
...
def get_args():
    ...
    return [primals_1, primals_2, primals_3, tangents_1]
