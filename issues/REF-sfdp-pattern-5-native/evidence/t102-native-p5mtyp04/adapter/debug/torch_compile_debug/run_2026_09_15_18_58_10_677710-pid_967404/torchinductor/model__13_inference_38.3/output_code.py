...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpvfcn9tcn/pl/cpl2uyu3futnfioiuu6csryhff3kwdkq6sjmlhpzxr3pjf4nqhdt.py
...
#   %mul_scalar : Tensor "f32[4, 2, 16, 32][1024, 512, 32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%arg0_1, 0.42044820762685725), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpvfcn9tcn/a4/ca4iqk4i44czmmam2alwfiv7ivb6kfykz24mvb7t63ty2m7q3s5m.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpvfcn9tcn/hl/chll4mwcovcfhj7gowfeksx7qubz2qf6j3zpjwuu4k32smnwfxwp.py
# Topologically Sorted Source Nodes: [attn_mask], Original ATen: [aten.tril]
# Source node to ATen node mapping:
#   attn_mask => iota, iota_1, le, sub, unsqueeze, unsqueeze_1
# Graph fragment:
#   %iota : Tensor "i64[16][1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.iota.default](args = (16,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: npu:0, requires_grad: False})
...
#   %iota_1 : Tensor "i64[16][1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.iota.default](args = (16,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: npu:0, requires_grad: False})
#   %unsqueeze_1 : Tensor "i64[16, 1][1, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%iota_1, -1), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpvfcn9tcn/34/c344vne37sftxuyp4kmj5j5m3boov33bgdtgdfwi552qeynpxodq.py
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpvfcn9tcn/pl/cplubiut47ks5xwqqfg3totqq66pt6kls4zpub6drpwoaxj74lxp.py
# Topologically Sorted Source Nodes: [, logical_not, attn_mask_1], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t102-native-p5mtyp04/adapter/inductor-cache/tmpvfcn9tcn/f2/cf2esr22dzzsf6qec5s6ccf3hgacyhs3vnd45z2dphifdq6lke45.py
# Topologically Sorted Source Nodes: [, logical_not, attn_mask_1], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
#   %where_self : Tensor "f32[4, 2, 16, 16][512, 256, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%logical_not_default_1, %full_default_2, %div_tensor), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_mul_0.run(arg0_1, buf0, 4096, stream=raw_stream0)
            del arg0_1
            ...
            del buf0
            del buf1
            buf3 = empty_strided_npu((16, 16), (16, 1), torch.bool)
            # Topologically Sorted Source Nodes: [attn_mask], Original ATen: [aten.tril]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_tril_2.run(buf3, 256, stream=raw_stream0)
            buf4 = empty_strided_npu((16, 16), (16, 1), torch.bool)
            # Topologically Sorted Source Nodes: [ones], Original ATen: [aten.ones]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_ones_3.run(buf4, 256, stream=raw_stream0)
            # Topologically Sorted Source Nodes: [attn_mask, ones], Original ATen: [aten.tril, aten.ones]
            # [Provenance debug handles] torch.ops.aten.logical_and.default:2
            buf5 = torch.ops.aten.logical_and.default(buf3, buf4)
            assert_alignment(buf5, 16, 'torch.ops.aten.logical_and.default')
            del buf3
            del buf4
            buf6 = empty_strided_npu((4, 2, 16, 16), (512, 256, 16, 1), torch.bool)
            # Topologically Sorted Source Nodes: [, logical_not, attn_mask_1], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__safe_softmax__to_copy_add_logical_not_masked_fill_matmul_4.run(buf2, buf5, buf6, 2048, stream=raw_stream0)
            # Topologically Sorted Source Nodes: [, logical_not, attn_mask_1], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
            ...
            del buf6
            buf10 = reinterpret_tensor(buf2, (4, 2, 16, 16), (512, 256, 16, 1), 0); del buf2  # reuse
            # Topologically Sorted Source Nodes: [, logical_not, attn_mask_1], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__safe_softmax__to_copy_add_logical_not_masked_fill_matmul_5.run(buf10, buf5, buf7, 128, 16, stream=raw_stream0)
            del buf5
            del buf7
            ...
            extern_kernels.bmm(reinterpret_tensor(buf10, (8, 16, 16), (256, 16, 1), 0), reinterpret_tensor(arg2_1, (8, 16, 32), (512, 32, 1), 0), out=buf11)
            del arg2_1
            del buf10
        return (reinterpret_tensor(buf11, (4, 2, 16, 32), (1024, 512, 32, 1), 0), )
