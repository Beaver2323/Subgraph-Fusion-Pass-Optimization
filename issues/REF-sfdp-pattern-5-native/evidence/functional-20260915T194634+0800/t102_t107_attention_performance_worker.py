...
def normalize_scale_argument(name, value):
    # c()只用于追踪占位；1～4各自参数名不同，extra_check均要求Python float/int。
...
def main() -> None:
    ...
    record = {
        ...
        "input_initialization": "fixed-seed-normal-std0.25; preserve-shape-stride-dtype; named-scale-trace-placeholder-to-python-scalar",
        "argument_initialization": [('named-scale-to-python-scalar-outside-compile; preserve-value' if type(x) in (float,int)
