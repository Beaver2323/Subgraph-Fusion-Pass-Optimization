...
def forward(self, primals, tangents):
    ...
    div = torch.ops.aten.div.Tensor(view_2, 0.66666);  view_2 = None
    add = torch.ops.aten.add.Tensor(div, primals_3);  div = primals_3 = None
    ...
    expand_3 = torch.ops.aten.expand.default(primals_4, [2, 4, 8, 16])
    ...
    matmul_backward = torch.ops.aten.matmul_backward.default(tangents_1, convert_element_type_3, primals_4, [True, True]);  tangents_1 = primals_4 = None
    ...
    div_2 = torch.ops.aten.div.Tensor(convert_element_type_8, 0.66666);  convert_element_type_8 = None
    ...
    return pytree.tree_unflatten([view_5, permute_1, getitem_2, None, getitem_1], self._out_spec)
