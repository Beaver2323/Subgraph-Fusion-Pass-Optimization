...
def forward(self, primals, tangents):
    ...
    mul_scalar = torch.ops.aten.mul.Scalar(primals_2, 0.4167804918837871);  primals_2 = None
    ...
    mul_scalar_2 = torch.ops.aten.mul.Scalar(getitem_7, 0.4167804918837871);  getitem_7 = None
    permute_default_1 = torch.ops.aten.permute.default(mul_scalar_2, [0, 1, 3, 2]);  mul_scalar_2 = None
    mul_scalar_3 = torch.ops.aten.mul.Scalar(getitem_6, 0.4167804918837871);  getitem_6 = None
    return pytree.tree_unflatten([view_default_5, permute_default_1, mul_scalar_3, getitem_5], self._out_spec)
