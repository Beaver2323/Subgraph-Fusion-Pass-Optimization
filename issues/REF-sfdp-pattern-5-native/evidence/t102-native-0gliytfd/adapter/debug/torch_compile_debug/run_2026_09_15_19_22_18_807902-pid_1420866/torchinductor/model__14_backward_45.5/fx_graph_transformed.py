class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 2, 16, 32]", primals_2: "f32[4, 2, 16, 32]", primals_3: "f32[4, 2, 16, 32]", tangents_1: "f32[4, 2, 16, 32]"):
        # ac_graph_id: 4 - PREFER_RECOMPUTE Backward of forward node: File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:362 in sfdp_pattern_5_v1, code: attn_mask = torch.ones(
        ...
        # ac_graph_id: 4 - PREFER_RECOMPUTE Backward of forward node: File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:364 in sfdp_pattern_5_v1, code: ).tril(diagonal=0)
        ...
        # ac_graph_id: 4 - PREFER_RECOMPUTE Backward of forward node: File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:366 in sfdp_pattern_5_v1, code: torch.logical_not(attn_mask), -float("inf")
        logical_not: "b8[16, 16]" = torch.ops.aten.logical_not.default(logical_and)

        # ac_graph_id: 4 - PREFER_RECOMPUTE Backward of forward node: File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:365 in sfdp_pattern_5_v1, code: attn_mask = attn_mask.masked_fill(
        ...
        mul_scalar: "f32[4, 2, 16, 32]" = torch.ops.aten.mul.Scalar(primals_1, 0.42044820762685725);  primals_1 = None
