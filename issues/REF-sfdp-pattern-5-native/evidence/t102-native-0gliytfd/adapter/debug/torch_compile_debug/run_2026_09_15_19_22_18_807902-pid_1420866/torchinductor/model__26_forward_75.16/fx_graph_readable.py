class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 2, 16, 32]", primals_2: "f32[4, 2, 16, 32]", primals_3: "f32[4, 2, 16, 32]"):
        # ac_graph_id: 12 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:387 in sfdp_pattern_5_v3, code: attn_mask = torch.ones(
        ...
        # ac_graph_id: 12 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:389 in sfdp_pattern_5_v3, code: ).tril(diagonal=0)
        ...
        # ac_graph_id: 12 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:391 in sfdp_pattern_5_v3, code: torch.logical_not(attn_mask), -float("inf")
        logical_not: "b8[16, 16]" = torch.ops.aten.logical_not.default(logical_and)

        # ac_graph_id: 12 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:390 in sfdp_pattern_5_v3, code: attn_mask = attn_mask.masked_fill(
        ...
        mul_scalar: "f32[4, 2, 16, 32]" = torch.ops.aten.mul.Scalar(primals_1, 0.4167804918837871)
        permute_default: "f32[4, 2, 32, 16]" = torch.ops.aten.permute.default(primals_2, [0, 1, 3, 2])
        ...
        expand_default_3: "f32[4, 2, 16, 32]" = torch.ops.aten.expand.default(primals_3, [4, 2, 16, 32])
        ...
        # ac_graph_id: 12 - PREFER_RECOMPUTE File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:398 in sfdp_pattern_5_v3, code: return attn_weight @ value
        view_default_5: "f32[4, 2, 16, 32]" = torch.ops.aten.view.default(bmm_default_1, [4, 2, 16, 32]);  bmm_default_1 = None
        return (view_default_5, primals_1, primals_2, primals_3)
