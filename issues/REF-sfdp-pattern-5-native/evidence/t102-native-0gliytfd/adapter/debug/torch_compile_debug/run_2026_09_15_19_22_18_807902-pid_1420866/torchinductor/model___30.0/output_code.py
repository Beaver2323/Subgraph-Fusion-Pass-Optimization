...
# kernel path: /home/z50063656/tmp/t102-native-0gliytfd/adapter/inductor-cache/tmp0lyh1zsy/pl/cpl2uyu3futnfioiuu6csryhff3kwdkq6sjmlhpzxr3pjf4nqhdt.py
...
#   %mul_scalar : Tensor "f32[4, 2, 16, 32][1024, 512, 32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%arg1_1, 0.42044820762685725), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-0gliytfd/adapter/inductor-cache/tmp0lyh1zsy/a4/ca4iqk4i44czmmam2alwfiv7ivb6kfykz24mvb7t63ty2m7q3s5m.py
...
#   %permute_default : Tensor "f32[4, 2, 32, 16][1024, 512, 1, 32]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%arg0_1, [0, 1, 3, 2]), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-0gliytfd/adapter/inductor-cache/tmp0lyh1zsy/hl/chll4mwcovcfhj7gowfeksx7qubz2qf6j3zpjwuu4k32smnwfxwp.py
...
# kernel path: /home/z50063656/tmp/t102-native-0gliytfd/adapter/inductor-cache/tmp0lyh1zsy/34/c344vne37sftxuyp4kmj5j5m3boov33bgdtgdfwi552qeynpxodq.py
...
# kernel path: /home/z50063656/tmp/t102-native-0gliytfd/adapter/inductor-cache/tmp0lyh1zsy/pl/cplubiut47ks5xwqqfg3totqq66pt6kls4zpub6drpwoaxj74lxp.py
...
# kernel path: /home/z50063656/tmp/t102-native-0gliytfd/adapter/inductor-cache/tmp0lyh1zsy/f2/cf2esr22dzzsf6qec5s6ccf3hgacyhs3vnd45z2dphifdq6lke45.py
# Topologically Sorted Source Nodes: [, logical_not, masked_fill], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused_mul_0.run(arg1_1, buf0, 4096, stream=raw_stream0)
            del arg1_1
            arg0_1 = copy_if_misaligned(arg0_1)
            buf1 = empty_strided_npu((4, 2, 32, 16), (1024, 512, 16, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.transpose, aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_mul_transpose_1.run(arg0_1, buf1, 256, 16, stream=raw_stream0)
            del arg0_1
