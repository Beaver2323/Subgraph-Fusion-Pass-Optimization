class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 2, 16, 32]", primals_2: "f32[4, 2, 16, 32]", primals_3: "f32[4, 2, 16, 32]"):
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:412 in sfdp_pattern_6, code: attn_mask = torch.ones(
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:419 in sfdp_pattern_6, code: (query @ key.transpose(-2, -1) / math.sqrt(query.size(-1))) + attn_mask,
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:414 in sfdp_pattern_6, code: ).tril(diagonal=0)
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:416 in sfdp_pattern_6, code: torch.logical_not(attn_mask), -float("inf")
        logical_not: "b8[16, 16]" = torch.ops.aten.logical_not.default(logical_and)

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:415 in sfdp_pattern_6, code: attn_mask = attn_mask.masked_fill(
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:418 in sfdp_pattern_6, code: attn_weight = torch.softmax(
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:422 in sfdp_pattern_6, code: attn_weight = torch.nn.functional.dropout(attn_weight, 0.5, training)
        _npu_dropout = torch.ops.npu._npu_dropout.default(div_1, 0.5)
        getitem: "f32[4, 2, 16, 16]" = _npu_dropout[0]
        getitem_1: "u8[256]" = _npu_dropout[1];  _npu_dropout = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:423 in sfdp_pattern_6, code: return attn_weight @ value
        ...
        return (view_5, primals_2, primals_3, permute, div_1, getitem, getitem_1)
