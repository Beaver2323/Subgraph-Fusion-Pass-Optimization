...
def forward(self, arg0_1, arg1_1, arg2_1):
    ...
    mul_scalar = torch.ops.aten.mul.Scalar(permute_default, 0.5773502691896257);  permute_default = None
    permute_default_3 = torch.ops.aten.permute.default(permute_default_1, [0, 1, 3, 2]);  permute_default_1 = None
    mul_scalar_1 = torch.ops.aten.mul.Scalar(permute_default_3, 0.5773502691896257);  permute_default_3 = None
    ...
    full_default_2 = torch.ops.aten.full.default([4, 16, 2, 2], 0, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
