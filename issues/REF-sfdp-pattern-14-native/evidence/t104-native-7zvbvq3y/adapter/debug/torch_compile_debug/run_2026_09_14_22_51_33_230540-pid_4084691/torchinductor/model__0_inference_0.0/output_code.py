...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/nz/cnzwd36l5utzj2exewkxweto5ugilozt5pogkehagwfhby7se4o6.py
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/op/cop7khezqxrvw5b6grhcjdvgnnvnctxysebip2ybzhmd6n7lefi6.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.transpose, aten.mul, aten.matmul]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/m5/cm53jw6q5vdh5lddg3by7ykb66gnmv7c3it3cyqvt55t3bacyzsc.py
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/xz/cxz6tsciwejo5tv6vcnjbtpgxcqpxom32dhfjbl6u32dp7ok4p2u.py
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/54/c54cxvvhmnv3mkzegsz56zv22onn3rxlziwhtywwkrnfbkalol4m.py
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/pf/cpfwqppzjnpqg5i4snpb4fnqrzoksqgagszqk2qy5w427rgc4mxk.py
# Topologically Sorted Source Nodes: [, logical_not, masked_fill], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/2o/c2od7nungi7pwmt2spb7gvjw6pa3ycoq3agfenym66qi2fdzewyq.py
# Topologically Sorted Source Nodes: [, logical_not, masked_fill], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/xc/cxcdlcza3ivulcu4bonnbbzf3xnbbma4op7lu2g3wpoipppsno7i.py
# Topologically Sorted Source Nodes: [, logical_not, masked_fill], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/66/c665vkgm7w2amaldqwfnyf2mojl3c56ucrkyoghvf6xuwcerzzwp.py
# Topologically Sorted Source Nodes: [, logical_not, masked_fill], Original ATen: [aten.matmul, aten.logical_not, aten.masked_fill, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, convert_element_type_default, div_tensor, exp_default, full_default_2, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
#   logical_not => logical_not
...
# kernel path: /home/z50063656/tmp/t104-native-7zvbvq3y/adapter/inductor-cache/tmpgllcfeec/qs/cqszgbsuv7lsdj4wru6wpr4n6ca5oj5kwu5hawxlj5tgofoaqc2s.py
