class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[2, 2, 8, 16]", primals_2: "f32[2, 2, 8, 16]", primals_3: "f32[8, 8]", primals_4: "f32[2, 2, 8, 16]"):
        ...
        view_default: "f32[4, 8, 16]" = torch.ops.aten.reshape.default(expand_default, [4, 8, 16]);  expand_default = None
        expand_default_1: "f32[2, 2, 16, 8]" = torch.ops.aten.expand.default(mul_scalar_1, [2, 2, 16, 8])
        view_default_1: "f32[4, 16, 8]" = torch.ops.aten.reshape.default(expand_default_1, [4, 16, 8]);  expand_default_1 = None
        bmm_default: "f32[4, 8, 8]" = torch.ops.aten.bmm.default(view_default, view_default_1);  view_default = view_default_1 = None
        view_default_2: "f32[2, 2, 8, 8]" = torch.ops.aten.reshape.default(bmm_default, [2, 2, 8, 8]);  bmm_default = None
        ...
        view_default_3: "f32[4, 8, 8]" = torch.ops.aten.reshape.default(expand_default_2, [4, 8, 8]);  expand_default_2 = None
        expand_default_3: "f32[2, 2, 8, 16]" = torch.ops.aten.expand.default(primals_4, [2, 2, 8, 16])
        view_default_4: "f32[4, 8, 16]" = torch.ops.aten.reshape.default(expand_default_3, [4, 8, 16]);  expand_default_3 = None
        ...
        view_default_5: "f32[2, 2, 8, 16]" = torch.ops.aten.reshape.default(bmm_default_1, [2, 2, 8, 16]);  bmm_default_1 = None
