...
# kernel path: /home/z50063656/tmp/t102-training-boundary-installed-20260915/inductor-cache/tmpotx__90g/4q/c4qztwnawqdggz7w53astet7rg6hu3hzialzxkiab3mjnggimnyf.py
# Topologically Sorted Source Nodes: [mul_1, sum_2, mul_2, sub_1, mul_3, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.mul, aten.matmul_backward]
...
#   %div : Tensor "f32[2, 2, 8, 8][128, 64, 8, 1]npu:0" = PlaceHolder[target=div]
#   %sum_2 : Tensor "f32[2, 2, 8, 1][16, 8, 1, 32]npu:0" = PlaceHolder[target=sum_2]
#   %primals_3 : Tensor "f32[][]npu:0" = PlaceHolder[target=primals_3]
#   %mul_1 : Tensor "f32[2, 2, 8, 8][128, 64, 8, 1]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem, %div), kwargs = {})
#   %sum_2 : Tensor "f32[2, 2, 8, 1][16, 8, 1, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_1, [-1], True), kwargs = {})
#   %mul_2 : Tensor "f32[2, 2, 8, 8][128, 64, 8, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_2), kwargs = {})
#   %sub_1 : Tensor "f32[2, 2, 8, 8][128, 64, 8, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_1, %mul_2), kwargs = {})
#   %mul_3 : Tensor "f32[2, 2, 8, 8][128, 64, 8, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_1, %primals_3), kwargs = {})
#   %matmul_backward_1 : [num_users=2] = call_function[target=torch.ops.aten.matmul_backward.default](args = (%mul_3, %primals_2, %permute, [True, True]), kwargs = {})
#   return %sum_2,%buf4
triton_unk_fused__softmax_backward_data_matmul_backward_mul_0 = async_compile.triton('triton_unk_fused__softmax_backward_data_matmul_backward_mul_0', '''
import triton
import triton.language as tl
...
@npu_triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__softmax_backward_data_matmul_backward_mul_0', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 5, 'num_reduction': 1, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
def triton_unk_fused__softmax_backward_data_matmul_backward_mul_0(in_out_ptr0, in_ptr0, in_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    total_thread = 48
    ...
    for i in range(group_size):
        ...
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            tmp1 = tl.load(in_ptr0 + (r0_1 + 8*x0), r0_mask & x0mask, eviction_policy='evict_last', other=0.0)
            tmp2 = tmp0 * tmp1
        ...
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            rindex = r0_index
            r0_1 = r0_index
            tmp6 = tl.load(in_out_ptr0 + (r0_1 + 8*x0), r0_mask & x0mask, eviction_policy='evict_first', other=0.0)
            tmp7 = tl.load(in_ptr0 + (r0_1 + 8*x0), r0_mask & x0mask, eviction_policy='evict_first', other=0.0)
            tmp8 = tmp6 * tmp7
            tmp9 = tmp7 * tmp4
            tmp10 = tmp8 - tmp9
            tmp13 = tmp10 * tmp12
            tl.store(in_out_ptr0 + (r0_1 + 8*x0), tmp13, r0_mask & x0mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/t102-training-boundary-installed-20260915/inductor-cache/tmpotx__90g/mf/cmfoydofdwyopfhbgoyco6so3r2632o3ktmoj7g2lgkrfov4ojjq.py
# Topologically Sorted Source Nodes: [mul_1, mul_2, sub_1, mul_3, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.mul, aten.matmul_backward]
# Source node to ATen node mapping:
#   matmul_backward_1 => matmul_backward_1
#   mul_1 => mul_1
#   mul_2 => mul_2
...
#   %matmul_backward_1 : [num_users=2] = call_function[target=torch.ops.aten.matmul_backward.default](args = (%mul_3, %primals_2, %permute, [True, True]), kwargs = {})
#   return %buf5
triton_unk_fused__softmax_backward_data_matmul_backward_mul_1 = async_compile.triton('triton_unk_fused__softmax_backward_data_matmul_backward_mul_1', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__softmax_backward_data_matmul_backward_mul_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 3, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused__softmax_backward_data_matmul_backward_mul_1(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    ynumel = 64
    xnumel = 8
...
# kernel path: /home/z50063656/tmp/t102-training-boundary-installed-20260915/inductor-cache/tmpotx__90g/mb/cmbht3dfqxqe6a3x6hdxpadljzpjxsq7mcvb2hor2l7xwlcgcmpy.py
...
class Runner:
    ...
    def call(self, args):
        primals_2, primals_3, primals_4, permute, div, tangents_1 = args
        args.clear()
        with torch.npu.utils.device(0):
            ...
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:5
            buf0 = torch.ops.aten.matmul_backward.default(tangents_1, div, primals_4, [True, True])
            del primals_4
            del tangents_1
            buf1 = buf0[0]
            ...
            triton_unk_fused__softmax_backward_data_matmul_backward_mul_0.run(buf4, div, primals_3, 32, 8, stream=raw_stream0)
            del div
            del primals_3
            buf5 = empty_strided_npu((2, 2, 16, 8), (256, 128, 8, 1), torch.float32)
            # Topologically Sorted Source Nodes: [mul_1, mul_2, sub_1, mul_3, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.mul, aten.matmul_backward]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_backward_data_matmul_backward_mul_1.run(permute, buf5, 64, 8, stream=raw_stream0)
            del permute
            # Topologically Sorted Source Nodes: [mul_1, mul_2, sub_1, mul_3, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.mul, aten.matmul_backward]
...
def get_args():
    ...
    div = rand_strided((2, 2, 8, 8), (128, 64, 8, 1), device='npu:0', dtype=torch.float32)
    tangents_1 = rand_strided((2, 2, 8, 16), (256, 128, 16, 1), device='npu:0', dtype=torch.float32)
    return [primals_2, primals_3, primals_4, permute, div, tangents_1]
