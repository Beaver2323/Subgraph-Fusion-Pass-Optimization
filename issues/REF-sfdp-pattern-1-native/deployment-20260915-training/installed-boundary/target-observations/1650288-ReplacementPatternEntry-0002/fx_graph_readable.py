...
def forward(self, primals, tangents):
    ...
    mul = torch.ops.aten.mul.Tensor(view_2, 0.25);  view_2 = None
    ...
    expand_2 = torch.ops.aten.expand.default(convert_element_type_3, [2, 2, 8, 8])
    ...
    mul_3 = torch.ops.aten.mul.Tensor(convert_element_type_8, 0.25);  convert_element_type_8 = None
