class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[2, 2, 8, 16]", primals_2: "f32[2, 2, 8, 16]", primals_3: "f32[2, 2, 8, 16]"):
        ...
        # File: /home/z50063656/Pass/Subgraph-Fusion-Pass-Optimization/runners/attention_training_boundary.py:44 in div, code: return (q @ k.transpose(-2,-1)).div(4.0).softmax(-1) @ v
        getitem_4: "f32[2, 2, 8, 16]" = npu_fusion_attention_v3_default[0]
