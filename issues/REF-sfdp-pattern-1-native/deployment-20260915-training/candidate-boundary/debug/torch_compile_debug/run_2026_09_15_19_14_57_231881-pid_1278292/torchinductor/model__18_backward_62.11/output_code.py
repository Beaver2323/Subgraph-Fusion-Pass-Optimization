...
# kernel path: /home/z50063656/tmp/t102-training-boundary-candidate-20260915/inductor-cache/tmphp3y4jgs/wj/cwjmh5p3i7nbtq2aeqxkq3p4oohqfp24om74igkb4p7bzmj4447e.py
# Topologically Sorted Source Nodes: [mul, sum_2, mul_1, sub_1, div_2, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.div, aten.matmul_backward]
...
#   %mul : Tensor "f32[2, 2, 8, 8][128, 64, 8, 1]npu:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%getitem, %div_1), kwargs = {})
...
#   return %sum_2,%buf4
triton_unk_fused__softmax_backward_data_div_matmul_backward_0 = async_compile.triton('triton_unk_fused__softmax_backward_data_div_matmul_backward_0', '''
import triton
import triton.language as tl
...
def triton_unk_fused__softmax_backward_data_div_matmul_backward_0(in_out_ptr0, in_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            tmp9 = tmp7 * tmp4
            tmp10 = tmp8 - tmp9
            tmp11 = tl.full([1, 1], 0.25, tl.float32)
            tmp12 = tmp10 * tmp11
            tl.store(in_out_ptr0 + (r0_1 + 8*x0), tmp12, r0_mask & x0mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/t102-training-boundary-candidate-20260915/inductor-cache/tmphp3y4jgs/wp/cwp22qb6ry6eh25muqkss4zihq53eylbjgyx2rjouk5vt475shy7.py
# Topologically Sorted Source Nodes: [mul, mul_1, sub_1, div_2, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.div, aten.matmul_backward]
# Source node to ATen node mapping:
#   div_2 => div_2
#   matmul_backward_1 => matmul_backward_1
#   mul => mul
...
#   %matmul_backward_1 : [num_users=2] = call_function[target=torch.ops.aten.matmul_backward.default](args = (%div_2, %primals_2, %permute, [True, True]), kwargs = {})
#   return %buf5
triton_unk_fused__softmax_backward_data_div_matmul_backward_1 = async_compile.triton('triton_unk_fused__softmax_backward_data_div_matmul_backward_1', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__softmax_backward_data_div_matmul_backward_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 3, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused__softmax_backward_data_div_matmul_backward_1(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    ynumel = 64
    xnumel = 8
...
# kernel path: /home/z50063656/tmp/t102-training-boundary-candidate-20260915/inductor-cache/tmphp3y4jgs/mb/cmbht3dfqxqe6a3x6hdxpadljzpjxsq7mcvb2hor2l7xwlcgcmpy.py
...
class Runner:
    ...
    def call(self, args):
        primals_2, primals_4, permute, div_1, tangents_1 = args
        args.clear()
        with torch.npu.utils.device(0):
            ...
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:9
            buf0 = torch.ops.aten.matmul_backward.default(tangents_1, div_1, primals_4, [True, True])
            del primals_4
            del tangents_1
            buf1 = buf0[0]
            ...
            triton_unk_fused__softmax_backward_data_div_matmul_backward_0.run(buf4, div_1, 32, 8, stream=raw_stream0)
            del div_1
            buf5 = empty_strided_npu((2, 2, 16, 8), (256, 128, 8, 1), torch.float32)
            # Topologically Sorted Source Nodes: [mul, mul_1, sub_1, div_2, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.div, aten.matmul_backward]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__softmax_backward_data_div_matmul_backward_1.run(permute, buf5, 64, 8, stream=raw_stream0)
            del permute
            # Topologically Sorted Source Nodes: [mul, mul_1, sub_1, div_2, matmul_backward_1], Original ATen: [aten._softmax_backward_data, aten.div, aten.matmul_backward]
            # [Provenance debug handles] torch.ops.aten.matmul_backward.default:10
...
def get_args():
    ...
    return [primals_2, primals_4, permute, div_1, tangents_1]
