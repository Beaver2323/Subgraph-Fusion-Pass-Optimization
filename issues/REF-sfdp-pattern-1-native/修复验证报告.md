...
> 2026-09-21：PR 46464 已更新推送，CLA 通过，正式流水已启动。见[提交与流水状态](../../report/四个PR推送与流水状态_20260921.md)。

> 2026-09-20 更新：46464 的新增专项测试 10/10 通过，无跳过，覆盖 1～5 号 attention 的 FP16/FP32 训练。1/2/5 比较前向及梯度；3/4 含随机 dropout，仅验证匹配、前反向执行和有限值。
