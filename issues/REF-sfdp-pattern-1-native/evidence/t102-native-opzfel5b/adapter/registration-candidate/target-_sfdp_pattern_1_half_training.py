...
def forward(self, primals_1, primals_2, primals_3, primals_4, tangents_1):
    ...
    div = torch.ops.aten.div.Tensor(view_2, primals_8);  view_2 = None
    ...
    div_2 = torch.ops.aten.div.Tensor(convert_element_type_8, primals_8);  convert_element_type_8 = primals_8 = None
