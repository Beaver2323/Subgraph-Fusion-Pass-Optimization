class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[2, 4, 8, 16]", primals_2: "f16[2, 4, 8, 16]", primals_3: "f16[2, 4, 8, 16]"):
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:45 in _sfdp_pattern_1, code: torch.matmul(query, key.transpose(-2, -1))
        ...
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:47 in _sfdp_pattern_1, code: .softmax(dim=-1)
        ...
        return (view_5, primals_2, primals_3, permute, convert_element_type_3)
