...
def forward(self, primals, tangents):
    ...
    npu_fusion_attention_v3_default = torch.ops.npu.npu_fusion_attention_v3.default(primals_2, primals_1, primals_3, 4, 'BNSD', None, None, None, 0.5)
    ...
    npu_fusion_attention_grad_v3_default = torch.ops.npu.npu_fusion_attention_grad_v3.default(primals_2, primals_1, primals_3, tangents_1, 4, 'BNSD', softmax_max = getitem_5, softmax_sum = getitem_6, softmax_in = getitem_7, attention_in = getitem_4, scale_value = 0.5, seed = getitem_8, offset = getitem_9);  primals_2 = primals_1 = primals_3 = tangents_1 = getitem_5 = getitem_6 = getitem_7 = getitem_8 = getitem_9 = None
    ...
    return pytree.tree_unflatten([getitem_4, getitem_11, getitem_10, getitem_12], self._out_spec)
