class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[4, 2, 16, 32]", primals_2: "f16[4, 2, 16, 32]", primals_3: "f16[4, 2, 16, 32]", getitem_7: "f16[0]", tangents_1: "f16[4, 2, 16, 32]"):
        ...
        # ac_graph_id: 8 - PREFER_RECOMPUTE Backward of forward node: File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:160 in dot_prod_attention, code: .matmul(value)
        getitem_4: "f16[4, 2, 16, 32]" = npu_fusion_attention_v3_default[0]
        ...
        getitem_10: "f16[4, 2, 16, 32]" = npu_fusion_attention_grad_v3_default[0]
        getitem_11: "f16[4, 2, 16, 32]" = npu_fusion_attention_grad_v3_default[1]
        ...
        getitem_12: "f16[4, 2, 16, 32]" = npu_fusion_attention_grad_v3_default[2];  npu_fusion_attention_grad_v3_default = None
