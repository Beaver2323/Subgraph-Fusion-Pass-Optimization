class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[4, 2, 16, 32]", primals_2: "f16[4, 2, 16, 32]", primals_3: "f16[4, 2, 16, 32]", getitem_4: "f16[4, 2, 16, 32]", getitem_5: "f32[4, 2, 16, 8]", getitem_6: "f32[4, 2, 16, 8]", getitem_7: "f16[0]", getitem_8: "i64[1]", getitem_9: "i64[1]", tangents_1: "f16[4, 2, 16, 32]"):
