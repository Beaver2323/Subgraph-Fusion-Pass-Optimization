...
def forward(self, primals, tangents):
    ...
    expand_2 = torch.ops.aten.expand.default(convert_element_type_3, [4, 2, 16, 16])
    ...
    div_2 = torch.ops.aten.div.Tensor(convert_element_type_8, 5.656854249492381);  convert_element_type_8 = None
