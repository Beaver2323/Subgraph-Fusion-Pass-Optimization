...
# kernel path: /home/z50063656/tmp/t102-native-oen9jamj/adapter/inductor-cache/tmpz7rdocz6/an/candsshkypvfrnsggwy35sius34riv5kigzkpjpjfuterl4jkvbx.py
...
#   %div_tensor : Tensor "f32[4, 2, 16, 16][512, 256, 16, 1]npu:0"[num_users=4] = call_function[target=torch.ops.aten.div.Tensor](args = (%view_2, 5.656854249492381), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-oen9jamj/adapter/inductor-cache/tmpz7rdocz6/64/c64b4bqzxn7jmzivxm7fvene4ni3pvhbf2yrffzqtxscrunyd5bb.py
...
#   %div_tensor_1 : Tensor "f32[4, 2, 16, 16][512, 256, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%sub_tensor, 5.656854249492381), kwargs = {})
