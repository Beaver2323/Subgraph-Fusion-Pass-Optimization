...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            del arg0_1
            del arg1_1
            # Topologically Sorted Source Nodes: [split_tensor, merged], Original ATen: [aten.split, aten.cat]
            # [Provenance debug handles] torch.ops.aten.cat.default:2
            buf1 = torch.ops.aten.cat.default([reinterpret_tensor(buf0, (1024, 32), (256, 1), 0), reinterpret_tensor(buf0, (1024, 32), (256, 1), 32), reinterpret_tensor(buf0, (1024, 32), (256, 1), 64), reinterpret_tensor(buf0, (1024, 32), (256, 1), 96), reinterpret_tensor(buf0, (1024, 32), (256, 1), 128), reinterpret_tensor(buf0, (1024, 32), (256, 1), 160), reinterpret_tensor(buf0, (1024, 32), (256, 1), 192), reinterpret_tensor(buf0, (1024, 32), (256, 1), 224)], 1)
            assert_alignment(buf1, 16, 'torch.ops.aten.cat.default')
            arg2_1 = copy_if_misaligned(arg2_1)
            # Topologically Sorted Source Nodes: [split_tensor, side], Original ATen: [aten.split, aten.cat]
            # [Provenance debug handles] torch.ops.aten.cat.default:3
            buf2 = torch.ops.aten.cat.default([reinterpret_tensor(buf0, (1024, 32), (256, 1), 0), arg2_1], 1)
            assert_alignment(buf2, 16, 'torch.ops.aten.cat.default')
            del arg2_1
            del buf0
            # Topologically Sorted Source Nodes: [cat_default_3], Original ATen: [aten.cat]
            # [Provenance debug handles] torch.ops.aten.cat.default:4
            buf3 = torch.ops.aten.cat.default([buf1, buf2], 1)
