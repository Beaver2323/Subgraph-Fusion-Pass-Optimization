class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[2, 4, 8, 16]", arg1_1: "f16[2, 4, 8, 16]", arg2_1: "f16[2, 4, 8, 16]", arg3_1: "f32[1, 1, 8, 8]"):
        ...
        view: "f16[8, 8, 16]" = torch.ops.aten.view.default(arg0_1, [8, -1, 16]);  arg0_1 = None
        ...
        view_1: "f16[8, 8, 16]" = torch.ops.aten.view.default(arg1_1, [8, -1, 16]);  arg1_1 = None
        ...
        view_2: "f16[8, 8, 16]" = torch.ops.aten.view.default(arg2_1, [8, -1, 16]);  arg2_1 = None
        ...
        view_3: "f16[2, 4, 8, 8]" = torch.ops.aten.view.default(bmm, [2, 4, 8, -1]);  bmm = None
        ...
        view_4: "f32[8, 8, 8]" = torch.ops.aten.view.default(add, [8, 8, -1]);  add = None
