...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T233202+0800/pattern-24/on/inductor-cache/tmpozcyfnio/pf/cpfqz6aaghouspc2ftppuykvalyevxvltttse576ozmi4is7zlbp.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul]
# Source node to ATen node mapping:
#    => convert_element_type_default_1, mul_scalar
# Graph fragment:
#   %arg0_1 : Tensor "f16[2, 4, 8, 16][512, 128, 16, 1]npu:0" = PlaceHolder[target=arg0_1]
#   %convert_element_type_default_1 : Tensor "f32[2, 4, 8, 16][512, 128, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
#   %mul_scalar : Tensor "f32[2, 4, 8, 16][512, 128, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%convert_element_type_default_1, 1.0), kwargs = {})
#   return %expand_default
triton_unk_fused__to_copy_mul_0 = async_compile.triton('triton_unk_fused__to_copy_mul_0', '''
import triton
import triton.language as tl
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__to_copy_mul_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused__to_copy_mul_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T233202+0800/pattern-24/on/inductor-cache/tmpozcyfnio/5w/c5wch3gwdcwnjhgu7seryvlzhaz4eg7ng2f6suuc4cwtfxnbimtb.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.mul]
# Source node to ATen node mapping:
#    => convert_element_type_default_2, mul_scalar_1, permute_default
# Graph fragment:
#   %arg1_1 : Tensor "f16[2, 4, 8, 16][512, 128, 16, 1]npu:0" = PlaceHolder[target=arg1_1]
#   %convert_element_type_default_2 : Tensor "f32[2, 4, 8, 16][512, 128, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg1_1, torch.float32), kwargs = {})
#   %permute_default : Tensor "f32[2, 4, 16, 8][512, 128, 1, 16]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_2, [0, 1, 3, 2]), kwargs = {})
#   %mul_scalar_1 : Tensor "f32[2, 4, 16, 8][512, 128, 1, 16]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%permute_default, 1.0), kwargs = {})
#   return %expand_default_1
triton_unk_fused__to_copy_mul_transpose_1 = async_compile.triton('triton_unk_fused__to_copy_mul_transpose_1', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid2D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__to_copy_mul_transpose_1', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 3, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused__to_copy_mul_transpose_1(in_ptr0, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    ynumel = 128
    xnumel = 8
    ...
    for i in range(group_size):
        ...
        ymask = y0mask & y1mask
        tmp0 = tl.load(in_ptr0 + (y0 + 16*x2 + 128*y1), x2mask & y0mask & y1mask).to(tl.float32)
        tmp1 = tmp0.to(tl.float32)
        tmp2 = tl.full([1, 1], 1.0, tl.float32)
        tmp3 = tmp1 * tmp2
        tl.store(out_ptr0 + (x2 + 8*y0 + 128*y1), tmp3, x2mask & y0mask & y1mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T233202+0800/pattern-24/on/inductor-cache/tmpozcyfnio/mh/cmhhq4feiywbg4l6ji4ol5epq2xukyx7242bim2kbj7c4e3cib22.py
...
#   %convert_element_type_default : Tensor "f16[1, 1, 8, 8][64, 64, 8, 1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg3_1, torch.float16), kwargs = {})
#   %add_tensor : Tensor "f32[2, 4, 8, 8][256, 64, 8, 1]npu:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_default_2, %convert_element_type_default), kwargs = {})
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__safe_softmax__to_copy_add_matmul_2', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'npu_num_x_nodes': 2, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T233202+0800/pattern-24/on/inductor-cache/tmpozcyfnio/fu/cfujdxldw3wexlbb3cls2khkyfgw2ruboa44ujtteupxqisq6miq.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, convert_element_type_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
# Graph fragment:
#   %bmm_default : Tensor "f32[8, 8, 8][64, 8, 1]npu:0" = PlaceHolder[target=bmm_default]
#   %arg3_1 : Tensor "f32[1, 1, 8, 8][64, 64, 8, 1]npu:0" = PlaceHolder[target=arg3_1]
...
#   %where_self : Tensor "f32[2, 4, 8, 8][256, 64, 8, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%logical_not_default_1, %full_default, %div_tensor), kwargs = {})
...
@npu_triton_heuristics.reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__safe_softmax__to_copy_add_matmul_3', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 7, 'num_reduction': 2, 'npu_num_x_nodes': 2, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False}
)
@triton.jit
def triton_unk_fused__safe_softmax__to_copy_add_matmul_3(in_out_ptr0, in_ptr0, in_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 64
    r0_numel = 8
    ...
    for i in range(group_size):
        ...
        _tmp6 = tl.full([real_block_x1, real_block_x0, R0_BLOCK], float("-inf"), tl.float32)
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            tmp3 = tmp2.to(tl.float32)
            tmp4 = tmp0 + tmp3
            tmp5 = tl.broadcast_to(tmp4, [real_block_x1, real_block_x0, R0_BLOCK])
            tmp7 = tl.maximum(_tmp6, tmp5)
            _tmp6 = tmp7
        tmp6 = triton_helpers.max2(_tmp6, 2)[:, :, None]
        _tmp16 = tl.full([real_block_x1, real_block_x0, R0_BLOCK], 0, tl.float32)
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            r0_index = r0_offset + r0_base
            r0_mask = r0_index < r0_numel
            roffset = r0_offset
            rindex = r0_index
            r0_2 = r0_index
            tmp8 = tl.load(in_out_ptr0 + (r0_2 + 8*x0 + 64*x1), r0_mask & x0mask & x1mask, eviction_policy='evict_last', other=float("-inf"))
            ...
            tmp15 = tl.broadcast_to(tmp14, [real_block_x1, real_block_x0, R0_BLOCK])
            tmp17 = _tmp16 + tmp15
            _tmp16 = tmp17
        tmp16 = tl.sum(_tmp16, 2)[:, :, None]
        tmp18 = tl.load(in_ptr1 + (x0 + 8 * x1), x0mask & x1mask, eviction_policy='evict_last') != 0
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            r0_index = r0_offset + r0_base
            r0_mask = r0_index < r0_numel
            roffset = r0_offset
            rindex = r0_index
            r0_2 = r0_index
            tmp20 = tl.load(in_out_ptr0 + (r0_2 + 8*x0 + 64*x1), r0_mask & x0mask & x1mask, eviction_policy='evict_first', other=0.0)
            tmp21 = tl.load(in_ptr0 + (r0_2 + 8*x0), r0_mask & x0mask, eviction_policy='evict_last', other=0.0)
            tmp19 = tmp18 == 0
            ...
            tmp29 = tl.where(tmp19, tmp28, tmp27)
            tl.store(in_out_ptr0 + (r0_2 + 8*x0 + 64*x1), tmp29, r0_mask & x0mask & x1mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T233202+0800/pattern-24/on/inductor-cache/tmpozcyfnio/wt/cwt2icfslhfypzr4wqn25fkxqvz6v3h6cs7rrkfhjjzp4ymi4nvi.py
...
#   %convert_element_type_default_3 : Tensor "f32[2, 4, 8, 16][512, 128, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg2_1, torch.float32), kwargs = {})
...
@npu_triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp16', 'out_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [1024, {'divisors': [1]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 1024, 'divisor': 1, 'seed': 1}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__to_copy_4', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /home/z50063656/tmp/attention-functional-20260914-unskip/functional-20260914T233202+0800/pattern-24/on/inductor-cache/tmpozcyfnio/ns/cnssktt7v3rcnzndjygak5rfcdaxgwm4nqpqbc5xo36ngfph2gxh.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.view]
# Source node to ATen node mapping:
...
#   %convert_element_type_default_4 : Tensor "f16[2, 4, 8, 16][512, 128, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_default_5, torch.float16), kwargs = {})
#   return %convert_element_type_default_4
triton_unk_fused_matmul_view_5 = async_compile.triton('triton_unk_fused_matmul_view_5', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_matmul_view_5', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused_matmul_view_5(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
    group_id = tl.program_id(0)
    xnumel = 1024
    x_g_tile0 : tl.constexpr = (1024) if (1024) < (XBLOCK) else (XBLOCK)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            triton_unk_fused__to_copy_mul_0.run(arg0_1, buf0, 1024, stream=raw_stream0)
            del arg0_1
            arg1_1 = copy_if_misaligned(arg1_1)
            buf1 = empty_strided_npu((2, 4, 16, 8), (512, 128, 8, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.transpose, aten.mul]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__to_copy_mul_transpose_1.run(arg1_1, buf1, 128, 8, stream=raw_stream0)
            del arg1_1
            buf2 = empty_strided_npu((8, 8, 8), (64, 8, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy, aten.mul, aten.matmul, aten.transpose]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__safe_softmax__to_copy_add_matmul_2.run(buf2, arg3_1, buf3, 512, stream=raw_stream0)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__safe_softmax__to_copy_add_matmul_3.run(buf7, arg3_1, buf4, 64, 8, stream=raw_stream0)
            del arg3_1
            del buf4
            arg2_1 = copy_if_misaligned(arg2_1)
            buf8 = empty_strided_npu((2, 4, 8, 16), (512, 128, 16, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten._to_copy]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__to_copy_4.run(arg2_1, buf8, 1024, stream=raw_stream0)
            del arg2_1
            buf9 = empty_strided_npu((8, 8, 16), (128, 16, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten._to_copy, aten.add, aten._safe_softmax]
            # [Provenance debug handles] extern_kernels.bmm:3
            extern_kernels.bmm(reinterpret_tensor(buf7, (8, 8, 8), (64, 8, 1), 0), reinterpret_tensor(buf8, (8, 8, 16), (128, 16, 1), 0), out=buf9)
            del buf7
            del buf8
            buf10 = empty_strided_npu((2, 4, 8, 16), (512, 128, 16, 1), torch.float16)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.view]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_matmul_view_5.run(buf9, buf10, 1024, stream=raw_stream0)
            del buf9
        return (buf10, )
