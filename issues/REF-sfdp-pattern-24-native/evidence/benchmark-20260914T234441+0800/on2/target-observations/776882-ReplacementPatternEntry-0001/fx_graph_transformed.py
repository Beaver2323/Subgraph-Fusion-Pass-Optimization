...
def forward(self, arg0_1, arg1_1, arg2_1, arg3_1):
    ...
    convert_element_type_default_1 = torch.ops.prims.convert_element_type.default(arg0_1, torch.float32);  arg0_1 = None
    convert_element_type_default_2 = torch.ops.prims.convert_element_type.default(arg1_1, torch.float32);  arg1_1 = None
    convert_element_type_default_3 = torch.ops.prims.convert_element_type.default(arg2_1, torch.float32);  arg2_1 = None
    mul_scalar = torch.ops.aten.mul.Scalar(convert_element_type_default_1, 1.0);  convert_element_type_default_1 = None
    permute_default = torch.ops.aten.permute.default(convert_element_type_default_2, [0, 1, 3, 2]);  convert_element_type_default_2 = None
    ...
    expand_default_2 = torch.ops.aten.expand.default(where_self, [2, 4, 8, 8]);  where_self = None
    view_default_3 = torch.ops.aten.view.default(expand_default_2, [8, 8, 8]);  expand_default_2 = None
    expand_default_3 = torch.ops.aten.expand.default(convert_element_type_default_3, [2, 4, 8, 16]);  convert_element_type_default_3 = None
