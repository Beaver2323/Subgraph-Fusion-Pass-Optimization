...
def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1):
    ...
    where_self = torch.ops.aten.where.self(arg1_1, arg0_1, full_default_2);  arg1_1 = arg0_1 = full_default_2 = None
    mul_scalar = torch.ops.aten.mul.Scalar(arg3_1, 0.42044820762685725);  arg3_1 = None
    permute_default = torch.ops.aten.permute.default(arg2_1, [0, 1, 3, 2]);  arg2_1 = None
    ...
    full_default_3 = torch.ops.aten.full.default([4, 2, 16, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
    ...
    expand_default_2 = torch.ops.aten.expand.default(where_self_1, [4, 2, 16, 16]);  where_self_1 = None
    view_default_3 = torch.ops.aten.view.default(expand_default_2, [8, 16, 16]);  expand_default_2 = None
    expand_default_3 = torch.ops.aten.expand.default(arg4_1, [4, 2, 16, 32]);  arg4_1 = None
