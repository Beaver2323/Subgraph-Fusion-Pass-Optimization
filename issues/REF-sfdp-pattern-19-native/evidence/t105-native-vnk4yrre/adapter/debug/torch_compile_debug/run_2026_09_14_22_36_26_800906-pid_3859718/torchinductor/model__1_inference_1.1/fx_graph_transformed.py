class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[16, 16]", arg1_1: "b8[16, 16]", arg2_1: "f32[4, 2, 16, 32]", arg3_1: "f32[4, 2, 16, 32]", arg4_1: "f32[4, 2, 16, 32]"):
        ...
        mul_scalar: "f32[4, 2, 16, 32]" = torch.ops.aten.mul.Scalar(arg3_1, 0.4167804918837871);  arg3_1 = None
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:1291 in dot_prod_attention_v2, code: ).matmul(value)
