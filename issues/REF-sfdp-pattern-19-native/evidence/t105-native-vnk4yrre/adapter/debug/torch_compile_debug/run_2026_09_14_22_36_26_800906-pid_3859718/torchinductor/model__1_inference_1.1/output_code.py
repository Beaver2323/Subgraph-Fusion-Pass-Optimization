...
# kernel path: /home/z50063656/tmp/t105-native-vnk4yrre/adapter/inductor-cache/tmp3tesriop/in/cinca6ycbsmnq3anq5cfc6nakzrxgycpqk3gqas6sfi52mdh5we5.py
...
#   %mul_scalar : Tensor "f32[4, 2, 16, 32][1024, 512, 32, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%arg3_1, 0.4167804918837871), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t105-native-vnk4yrre/adapter/inductor-cache/tmp3tesriop/n7/cn7bjan43an6e7ughhyfcnkyu72rhm4vqdboexi75skm7hckk3g4.py
...
#   %mul_scalar_1 : Tensor "f32[4, 2, 32, 16][1024, 512, 1, 32]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%permute_default, 0.4167804918837871), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t105-native-vnk4yrre/adapter/inductor-cache/tmp3tesriop/y3/cy3tr7pb3xu4cwr52bxhlqh2gsffcxqxl6mgoo5xdfpoj576oh4e.py
...
# kernel path: /home/z50063656/tmp/t105-native-vnk4yrre/adapter/inductor-cache/tmp3tesriop/uj/cujtcpi2gjw7p5qvrm765b5bxklrfulkmynui3urvp7hzb46cqfz.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.full, aten.where, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
