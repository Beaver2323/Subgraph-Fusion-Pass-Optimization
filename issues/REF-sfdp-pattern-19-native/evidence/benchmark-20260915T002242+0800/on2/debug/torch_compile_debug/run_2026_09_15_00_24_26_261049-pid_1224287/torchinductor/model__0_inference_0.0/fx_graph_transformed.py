class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2, 4, 8, 16]", arg1_1: "f32[2, 4, 8, 16]", arg2_1: "b8[1, 1, 8, 8]", arg3_1: "f32[1, 1, 8, 8]", arg4_1: "f32[2, 4, 8, 16]"):
        ...
        eq_scalar: "b8[2, 4, 8, 8]" = torch.ops.aten.eq.Scalar(add_tensor, -inf)
        ...
        sub_tensor: "f32[2, 4, 8, 8]" = torch.ops.aten.sub.Tensor(add_tensor, amax_default);  add_tensor = amax_default = None
