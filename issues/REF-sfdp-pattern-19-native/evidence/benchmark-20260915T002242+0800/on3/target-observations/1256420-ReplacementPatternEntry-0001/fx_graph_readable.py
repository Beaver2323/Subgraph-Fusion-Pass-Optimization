...
def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1):
    ...
    expand = torch.ops.aten.expand.default(arg1_1, [2, 4, 8, 16]);  arg1_1 = None
    view = torch.ops.aten.view.default(expand, [8, 8, 16]);  expand = None
    expand_1 = torch.ops.aten.expand.default(permute, [2, 4, 16, 8]);  permute = None
    ...
    full_default = torch.ops.aten.full.default([], 0.66666, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
    ...
    where = torch.ops.aten.where.self(arg2_1, div, full_default_1);  arg2_1 = div = full_default_1 = None
    add = torch.ops.aten.add.Tensor(where, arg3_1);  where = arg3_1 = None
    ...
    expand_2 = torch.ops.aten.expand.default(div_1, [2, 4, 8, 8]);  div_1 = None
    view_3 = torch.ops.aten.view.default(expand_2, [8, 8, 8]);  expand_2 = None
    expand_3 = torch.ops.aten.expand.default(arg4_1, [2, 4, 8, 16]);  arg4_1 = None
