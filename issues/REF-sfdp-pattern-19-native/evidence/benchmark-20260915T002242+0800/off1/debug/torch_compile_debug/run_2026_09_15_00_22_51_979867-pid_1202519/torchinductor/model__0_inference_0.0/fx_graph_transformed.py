class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[2, 4, 8, 16]", arg1_1: "f32[2, 4, 8, 16]", arg2_1: "b8[1, 1, 8, 8]", arg3_1: "f32[1, 1, 8, 8]", arg4_1: "f32[2, 4, 8, 16]"):
        ...
        expand: "f32[2, 4, 8, 16]" = torch.ops.aten.expand.default(arg1_1, [2, 4, 8, 16]);  arg1_1 = None
        view: "f32[8, 8, 16]" = torch.ops.aten.reshape.default(expand, [8, 8, 16]);  expand = None
        permute: "f32[2, 4, 16, 8]" = torch.ops.aten.permute.default(arg0_1, [0, 1, 3, 2]);  arg0_1 = None
        expand_1: "f32[2, 4, 16, 8]" = torch.ops.aten.expand.default(permute, [2, 4, 16, 8]);  permute = None
        view_1: "f32[8, 16, 8]" = torch.ops.aten.reshape.default(expand_1, [8, 16, 8]);  expand_1 = None
        bmm: "f32[8, 8, 8]" = torch.ops.aten.bmm.default(view, view_1);  view = view_1 = None
        view_2: "f32[2, 4, 8, 8]" = torch.ops.aten.reshape.default(bmm, [2, 4, 8, 8]);  bmm = None
        ...
        full_default: "f32[]" = torch.ops.aten.full.default([], 0.66666, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
        ...
        div: "f32[2, 4, 8, 8]" = torch.ops.aten.div.Tensor(view_2, full_default);  view_2 = full_default = None
        ...
        full_default_1: "f32[]" = torch.ops.aten.full.default([], -3.4028234663852886e+38, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
        ...
        where: "f32[2, 4, 8, 8]" = torch.ops.aten.where.self(arg2_1, div, full_default_1);  arg2_1 = div = full_default_1 = None
        ...
        expand_2: "f32[2, 4, 8, 8]" = torch.ops.aten.expand.default(div_1, [2, 4, 8, 8]);  div_1 = None
        view_3: "f32[8, 8, 8]" = torch.ops.aten.reshape.default(expand_2, [8, 8, 8]);  expand_2 = None
        expand_3: "f32[2, 4, 8, 16]" = torch.ops.aten.expand.default(arg4_1, [2, 4, 8, 16]);  arg4_1 = None
        view_4: "f32[8, 8, 16]" = torch.ops.aten.reshape.default(expand_3, [8, 8, 16]);  expand_3 = None
        bmm_1: "f32[8, 8, 16]" = torch.ops.aten.bmm.default(view_3, view_4);  view_3 = view_4 = None
        view_5: "f32[2, 4, 8, 16]" = torch.ops.aten.reshape.default(bmm_1, [2, 4, 8, 16]);  bmm_1 = None
        return (view_5,)
