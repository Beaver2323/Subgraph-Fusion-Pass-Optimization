#!/usr/bin/env python3
"""T-078 expanded-bias addmm 正例的原生入口预检与适配调度。"""
...
METHOD = "TestPatternMatcher.test_unfuse_expanded_bias_addmm"
parser = argparse.ArgumentParser(description=__doc__)
parser.add_argument("--adapter", action="store_true")
args = parser.parse_args()
if Path.cwd().resolve() != WORK:
    raise SystemExit("必须从 /home/z50063656/tmp 启动")
root = WORK / "t078-npu-results" / "REF-unfuse-addmm-expanded-native"
