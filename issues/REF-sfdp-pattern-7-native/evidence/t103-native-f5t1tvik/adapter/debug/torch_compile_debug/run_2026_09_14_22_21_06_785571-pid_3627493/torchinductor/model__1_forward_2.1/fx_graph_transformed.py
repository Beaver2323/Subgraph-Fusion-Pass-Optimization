class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[2, 8, 4, 16]", primals_2: "f16[2, 8, 4, 16]", primals_3: "f16[2, 8, 4, 16]"):
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:454 in sfdp_pattern_7, code: k = key.permute(0, 2, 1, 3)
        permute: "f16[2, 4, 8, 16]" = torch.ops.aten.permute.default(primals_1, [0, 2, 1, 3]);  primals_1 = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:453 in sfdp_pattern_7, code: q = query.permute(0, 2, 1, 3)
        permute_1: "f16[2, 4, 8, 16]" = torch.ops.aten.permute.default(primals_2, [0, 2, 1, 3]);  primals_2 = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:455 in sfdp_pattern_7, code: v = value.permute(0, 2, 1, 3)
        permute_2: "f16[2, 4, 8, 16]" = torch.ops.aten.permute.default(primals_3, [0, 2, 1, 3]);  primals_3 = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:456 in sfdp_pattern_7, code: div = q @ k.transpose(-2, -1) / math.sqrt(q.size(-1))
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:458 in sfdp_pattern_7, code: attn_weight = torch.softmax(div, dim=-1)
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:460 in sfdp_pattern_7, code: attn_weight = torch.dropout(attn_weight, 0.00000000001, training)
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:461 in sfdp_pattern_7, code: attn_weight = attn_weight.to(torch.float16)
        convert_element_type_3: "f16[2, 4, 8, 8]" = torch.ops.prims.convert_element_type.default(getitem, torch.float16);  getitem = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:462 in sfdp_pattern_7, code: return attn_weight @ v
        ...
        return (view_5, permute_1, permute_2, permute_3, div_1, getitem_1, convert_element_type_3)
