...
def forward(self, arg0_1, arg1_1, arg2_1):
    ...
    convert_element_type_3 = torch.ops.prims.convert_element_type.default(convert_element_type_2, torch.float16);  convert_element_type_2 = None
    ...
    amax = torch.ops.aten.amax.default(convert_element_type_4, [-1], True)
    sub = torch.ops.aten.sub.Tensor(convert_element_type_4, amax);  convert_element_type_4 = amax = None
    exp = torch.ops.aten.exp.default(sub);  sub = None
    sum_1 = torch.ops.aten.sum.dim_IntList(exp, [-1], True)
    div = torch.ops.aten.div.Tensor(exp, sum_1);  exp = sum_1 = None
    convert_element_type_5 = torch.ops.prims.convert_element_type.default(div, torch.float16);  div = None
    expand_2 = torch.ops.aten.expand.default(convert_element_type_5, [2, 8, 4, 4]);  convert_element_type_5 = None
