class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[2, 4, 8, 16]", arg1_1: "f16[2, 4, 8, 16]", arg2_1: "f16[2, 4, 8, 16]"):
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:688 in _sfdp_pattern_23, code: query = query.permute([0, 2, 1, 3])
        ...
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:691 in _sfdp_pattern_23, code: score = torch.matmul(query, key.permute(0, 1, 3, 2))
        ...
        # File: /home/z50063656/Pass/src/pytorch/torch/_inductor/fx_passes/fuse_attention.py:693 in _sfdp_pattern_23, code: score = fp32_score.type_as(query)
        convert_element_type_default: "f16[2, 8, 4, 4]" = torch.ops.prims.convert_element_type.default(view_2, torch.float16);  view_2 = None
        ...
        convert_element_type_4: "f32[2, 8, 4, 4]" = torch.ops.prims.convert_element_type.default(convert_element_type_default, torch.float32);  convert_element_type_default = None
        amax: "f32[2, 8, 4, 1]" = torch.ops.aten.amax.default(convert_element_type_4, [-1], True)
        sub: "f32[2, 8, 4, 4]" = torch.ops.aten.sub.Tensor(convert_element_type_4, amax);  convert_element_type_4 = amax = None
        ...
        convert_element_type_5: "f16[2, 8, 4, 4]" = torch.ops.prims.convert_element_type.default(div, torch.float16);  div = None
        expand_2: "f16[2, 8, 4, 4]" = torch.ops.aten.expand.default(convert_element_type_5, [2, 8, 4, 4]);  convert_element_type_5 = None
