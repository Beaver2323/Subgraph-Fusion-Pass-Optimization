...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.permute, aten.transpose, npu.npu_fusion_attention_v3]
            # [Provenance debug handles] torch.ops.npu.npu_fusion_attention_v3.default:1
            buf0 = torch.ops.npu.npu_fusion_attention_v3.default(reinterpret_tensor(arg1_1, (1, 16, 2, 32), (1024, 32, 512, 1), 0), reinterpret_tensor(arg0_1, (1, 16, 2, 32), (1024, 32, 512, 1), 0), reinterpret_tensor(arg2_1, (1, 16, 2, 32), (1024, 32, 512, 1), 0), 16, 'BNSD', pse=None, padding_mask=None, atten_mask=None, scale=1.0, keep_prob=1.0, pre_tockens=2147483647, next_tockens=2147483647, inner_precise=0, prefix=None, actual_seq_qlen=None, actual_seq_kvlen=None, sparse_mode=0, gen_mask_parallel=True, sync=False, softmax_layout='', sink=None)
            del arg1_1
            buf1 = buf0[0]
            assert_alignment(buf1, 16, 'torch.ops.npu.npu_fusion_attention_v3.default')
            del buf0
        return (buf1, reinterpret_tensor(arg0_1, (1, 16, 2, 32), (1024, 32, 512, 1), 0), reinterpret_tensor(arg2_1, (1, 16, 2, 32), (1024, 32, 512, 1), 0), )
...
def get_args():
    ...
    arg0_1 = rand_strided((1, 2, 16, 32), (1024, 512, 32, 1), device='npu:0', dtype=torch.float32)
