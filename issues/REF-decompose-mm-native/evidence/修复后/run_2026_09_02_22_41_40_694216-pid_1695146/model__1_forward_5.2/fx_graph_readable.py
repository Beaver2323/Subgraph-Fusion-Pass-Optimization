class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[20480, 32]", primals_2: "f32[32, 2]"):
        ...
        permute: "f32[32, 20480]" = torch.ops.aten.permute.default(primals_1, [1, 0]);  primals_1 = None
        permute_1: "f32[2, 32]" = torch.ops.aten.permute.default(primals_2, [1, 0]);  primals_2 = None
