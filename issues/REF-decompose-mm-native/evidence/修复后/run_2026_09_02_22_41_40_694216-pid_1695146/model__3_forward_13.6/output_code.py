...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmptbd55dqz/p2/cp2ms7urxlww2ebgs364lswcwv6ywp6sc44ae7k6qrzgkkzorcpg.py
# Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   mm => convert_element_type
# Graph fragment:
#   %primals_1 : Tensor "f32[20480, 5][5, 1]npu:0" = PlaceHolder[target=primals_1]
#   %convert_element_type : Tensor "bf16[20480, 5][5, 1]npu:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_1, torch.bfloat16), kwargs = {})
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 102400}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*bf16', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [102400, {'divisors': [1]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 102400, 'divisor': 1, 'seed': 1}]},
...
def triton_unk_fused__to_copy_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    xnumel = 102400
    x_g_tile0 : tl.constexpr = (102400) if (102400) < (XBLOCK) else (XBLOCK)
    x0numel : tl.constexpr = 102400
...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmptbd55dqz/yi/cyica7ftkjucvvqbfp5ntytaelihcgyedd3twqtqkyrugtnnoyi4.py
# Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   mm => convert_element_type_1
# Graph fragment:
#   %primals_2 : Tensor "f32[5, 2][2, 1]npu:0" = PlaceHolder[target=primals_2]
#   %convert_element_type_1 : Tensor "bf16[5, 2][2, 1]npu:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_2, torch.bfloat16), kwargs = {})
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 10}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*bf16', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [10, {'divisors': [1]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 10, 'divisor': 1, 'seed': 1}]},
...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmptbd55dqz/pf/cpfi5cw3t2svnvvkgn5rz3jcjbubgta4fnan23m62sfgeokxmbkf.py
# Topologically Sorted Source Nodes: [permute], Original ATen: [aten.t]
# Source node to ATen node mapping:
#   permute => permute
# Graph fragment:
#   %convert_element_type : Tensor "bf16[20480, 5][5, 1]npu:0" = PlaceHolder[target=convert_element_type]
#   %permute : Tensor "bf16[5, 20480][1, 5]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type, [1, 0]), kwargs = {})
#   return %permute
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 102400}, 
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [102400, {'divisors': [1]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 102400, 'divisor': 1, 'seed': 1}]},
...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmptbd55dqz/qt/cqti3gq72eysythhkjcl34rllffr7yacxvnye5xxdecakvgmwzki.py
# Topologically Sorted Source Nodes: [permute_1], Original ATen: [aten.t]
# Source node to ATen node mapping:
#   permute_1 => permute_1
# Graph fragment:
#   %convert_element_type_1 : Tensor "bf16[5, 2][2, 1]npu:0" = PlaceHolder[target=convert_element_type_1]
#   %permute_1 : Tensor "bf16[2, 5][1, 2]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_1, [1, 0]), kwargs = {})
#   return %permute_1
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = empty_strided_npu((20480, 5), (5, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__to_copy_0.run(primals_1, buf0, 102400, stream=raw_stream0)
            del primals_1
            primals_2 = copy_if_misaligned(primals_2)
            buf1 = empty_strided_npu((5, 2), (2, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__to_copy_1.run(primals_2, buf1, 10, stream=raw_stream0)
            del primals_2
            ...
            buf3 = reinterpret_tensor(buf0, (5, 20480), (1, 5), 0); del buf0  # reuse
            # Topologically Sorted Source Nodes: [permute], Original ATen: [aten.t]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_t_2.run(buf3, 102400, stream=raw_stream0)
            buf4 = reinterpret_tensor(buf1, (2, 5), (1, 2), 0); del buf1  # reuse
            # Topologically Sorted Source Nodes: [permute_1], Original ATen: [aten.t]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_t_3.run(buf4, 10, stream=raw_stream0)
...
def get_args():
    ...
    primals_1 = rand_strided((20480, 5), (5, 1), device='npu:0', dtype=torch.float32)
    primals_2 = rand_strided((5, 2), (2, 1), device='npu:0', dtype=torch.float32)
