...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmp28qepibb/33/c33qlkzfl3pxwykd5ntvchiksyu4hozaetppqjkwbmiwq6eravbc.py
# Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   mm => convert_element_type
# Graph fragment:
#   %primals_1 : Tensor "f32[2048, 2][2, 1]npu:0" = PlaceHolder[target=primals_1]
#   %convert_element_type : Tensor "bf16[2048, 2][2, 1]npu:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_1, torch.bfloat16), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmp28qepibb/zd/czd244giqfnxdvt3irkv26gc6fvxiokrhsgrdcxgmr7jluxp4mbh.py
# Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   mm => convert_element_type_1
# Graph fragment:
#   %primals_2 : Tensor "f32[2, 2][2, 1]npu:0" = PlaceHolder[target=primals_2]
#   %convert_element_type_1 : Tensor "bf16[2, 2][2, 1]npu:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_2, torch.bfloat16), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmp28qepibb/of/cofqnd3iilgazb5vj5zfsprgxbmaxywjdy6ynlzqnypynapjc6sn.py
# Topologically Sorted Source Nodes: [permute], Original ATen: [aten.t]
# Source node to ATen node mapping:
#   permute => permute
# Graph fragment:
#   %convert_element_type : Tensor "bf16[2048, 2][2, 1]npu:0" = PlaceHolder[target=convert_element_type]
#   %permute : Tensor "bf16[2, 2048][1, 2]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /home/z50063656/tmp/t077-cache-mm-fixed-suite0/tmp28qepibb/eg/cegkwivlupvko76o3bfuqxmreg33o7wkcgaukgklws6jqzjxaq25.py
# Topologically Sorted Source Nodes: [permute_1], Original ATen: [aten.t]
# Source node to ATen node mapping:
#   permute_1 => permute_1
# Graph fragment:
#   %convert_element_type_1 : Tensor "bf16[2, 2][2, 1]npu:0" = PlaceHolder[target=convert_element_type_1]
#   %permute_1 : Tensor "bf16[2, 2][1, 2]npu:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_1, [1, 0]), kwargs = {})
#   return %permute_1
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = empty_strided_npu((2048, 2), (2, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__to_copy_0.run(primals_1, buf0, 4096, stream=raw_stream0)
            del primals_1
            primals_2 = copy_if_misaligned(primals_2)
            buf1 = empty_strided_npu((2, 2), (2, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mm], Original ATen: [aten._to_copy]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused__to_copy_1.run(primals_2, buf1, 4, stream=raw_stream0)
            del primals_2
            buf2 = empty_strided_npu((2048, 2), (2, 1), torch.bfloat16)
            ...
            buf3 = reinterpret_tensor(buf0, (2, 2048), (1, 2), 0); del buf0  # reuse
            # Topologically Sorted Source Nodes: [permute], Original ATen: [aten.t]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_t_2.run(buf3, 4096, stream=raw_stream0)
            buf4 = reinterpret_tensor(buf1, (2, 2), (1, 2), 0); del buf1  # reuse
            # Topologically Sorted Source Nodes: [permute_1], Original ATen: [aten.t]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_t_3.run(buf4, 4, stream=raw_stream0)
...
def get_args():
    ...
    primals_1 = rand_strided((2048, 2), (2, 1), device='npu:0', dtype=torch.float32)
    primals_2 = rand_strided((2, 2), (2, 1), device='npu:0', dtype=torch.float32)
