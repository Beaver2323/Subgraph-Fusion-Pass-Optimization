#!/usr/bin/env python3
"""T-078 half dtype addmm 保留分支的原生入口预检与适配调度。"""
...
METHODS = [
    "TestPatternMatcher.test_unfuse_bias_addmm_half_dtypes_bfloat16",
    "TestPatternMatcher.test_unfuse_bias_addmm_half_dtypes_float16",
]
...
root = WORK / "t078-npu-results" / "REF-unfuse-addmm-half-preserve-native"
