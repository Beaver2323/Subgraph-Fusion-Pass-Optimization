class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[1, 7, 4]", arg1_1: "f32[3, 7, 5]"):
        ...
        select: "f32[1, 7]" = torch.ops.aten.select.int(arg0_1, -1, 3);  arg0_1 = None
        unsqueeze: "f32[1, 7, 1]" = torch.ops.aten.unsqueeze.default(select, -1);  select = None
