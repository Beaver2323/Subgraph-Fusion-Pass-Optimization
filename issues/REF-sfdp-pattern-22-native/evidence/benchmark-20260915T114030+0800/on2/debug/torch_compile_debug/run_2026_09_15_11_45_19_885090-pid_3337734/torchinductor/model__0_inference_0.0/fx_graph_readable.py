class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[2, 4, 8, 16]", arg1_1: "f16[2, 4, 8, 16]", arg2_1: "f16[2, 4, 8, 16]", arg3_1: "f32[2, 1, 1, 4]"):
        ...
        convert_element_type_default_2: "f32[2, 8, 4, 16]" = torch.ops.prims.convert_element_type.default(permute_default_1, torch.float32)
        convert_element_type_default_3: "f32[2, 8, 4, 16]" = torch.ops.prims.convert_element_type.default(permute_default_2, torch.float32)
        ...
        view_default: "f32[16, 4, 16]" = torch.ops.aten.view.default(clone_default, [16, 4, 16]);  clone_default = None
        ...
        view_default_1: "f32[16, 16, 4]" = torch.ops.aten.view.default(clone_default_1, [16, 16, 4]);  clone_default_1 = None
        bmm_default: "f32[16, 4, 4]" = torch.ops.aten.bmm.default(view_default, view_default_1);  view_default = view_default_1 = None
        view_default_2: "f32[2, 8, 4, 4]" = torch.ops.aten.view.default(bmm_default, [2, 8, 4, 4]);  bmm_default = None
        ...
        sub_tensor: "f32[2, 8, 4, 4]" = torch.ops.aten.sub.Tensor(add_tensor, amax_default);  amax_default = None
        ...
        eq_scalar: "b8[2, 8, 4, 4]" = torch.ops.aten.eq.Scalar(add_tensor, -inf);  add_tensor = None
        ...
        view_default_3: "f32[16, 4, 4]" = torch.ops.aten.view.default(expand_default_2, [16, 4, 4]);  expand_default_2 = None
        ...
        view_default_4: "f32[16, 4, 16]" = torch.ops.aten.view.default(clone_default_2, [16, 4, 16]);  clone_default_2 = None
        bmm_default_1: "f32[16, 4, 16]" = torch.ops.aten.bmm.default(view_default_3, view_default_4);  view_default_3 = view_default_4 = None
        view_default_5: "f32[2, 8, 4, 16]" = torch.ops.aten.view.default(bmm_default_1, [2, 8, 4, 16]);  bmm_default_1 = None
