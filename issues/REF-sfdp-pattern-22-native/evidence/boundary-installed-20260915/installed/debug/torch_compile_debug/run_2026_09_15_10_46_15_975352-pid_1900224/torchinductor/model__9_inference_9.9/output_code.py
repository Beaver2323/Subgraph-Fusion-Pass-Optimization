...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-5k498lwi/installed/inductor-cache/tmpdy4xhe50/hm/chmcpco4nizw4azruydndooinehsn6vm52uwf7nr53cfgyxl6l3q.py
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-5k498lwi/installed/inductor-cache/tmpdy4xhe50/6t/c6taaq32hist6mij5lbolirtlkl3jercufvw5hu3cadvgsbrigey.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
