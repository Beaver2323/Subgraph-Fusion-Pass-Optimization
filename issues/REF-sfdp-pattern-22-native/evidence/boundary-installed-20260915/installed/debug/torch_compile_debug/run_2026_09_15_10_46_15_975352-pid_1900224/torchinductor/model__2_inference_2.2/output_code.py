...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-5k498lwi/installed/inductor-cache/tmp_5cdehy4/mr/cmrt3dvj6adbnc35mswcopgmyrdub65jka5fqsjgy6czkhfo2hlg.py
...
#   %select : Tensor "f32[1, 7][28, 4]npu:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg0_1, -1, 0), kwargs = {})
...
def triton_unk_fused_add_select_unsqueeze_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + 4 * x1 + _es_lane0, x1mask & ((4 * x1 + _es_lane0 >= 0) & (4 * x1 + _es_lane0 < 28)), eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-5k498lwi/installed/inductor-cache/tmp_5cdehy4/ok/coke2a2cmbgoc44epklqqct5q6vsanpq5ntjpm6uwnq5wlkydqb6.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
