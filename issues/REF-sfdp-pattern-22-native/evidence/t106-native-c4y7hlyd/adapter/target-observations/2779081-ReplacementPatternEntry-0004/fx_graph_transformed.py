...
def forward(self, arg0_1, arg1_1, arg2_1, arg3_1):
    ...
    permute_default_3 = torch.ops.aten.permute.default(permute_default_1, [0, 1, 3, 2])
    mul_scalar_1 = torch.ops.aten.mul.Scalar(permute_default_3, 1.0);  permute_default_3 = None
    expand_default = torch.ops.aten.expand.default(mul_scalar, [1, 16, 2, 32]);  mul_scalar = None
    view_default = torch.ops.aten.view.default(expand_default, [16, 2, 32]);  expand_default = None
    expand_default_1 = torch.ops.aten.expand.default(mul_scalar_1, [1, 16, 32, 2]);  mul_scalar_1 = None
    view_default_1 = torch.ops.aten.view.default(expand_default_1, [16, 32, 2]);  expand_default_1 = None
    bmm_default = torch.ops.aten.bmm.default(view_default, view_default_1);  view_default = view_default_1 = None
    view_default_2 = torch.ops.aten.view.default(bmm_default, [1, 16, 2, 2]);  bmm_default = None
    ...
    full_default = torch.ops.aten.full.default([1, 16, 2, 2], 0, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=0), pin_memory = False)
    ...
    expand_default_2 = torch.ops.aten.expand.default(where_self, [1, 16, 2, 2]);  where_self = None
    view_default_3 = torch.ops.aten.view.default(expand_default_2, [16, 2, 2]);  expand_default_2 = None
    expand_default_3 = torch.ops.aten.expand.default(permute_default_2, [1, 16, 2, 32])
    view_default_4 = torch.ops.aten.view.default(expand_default_3, [16, 2, 32]);  expand_default_3 = None
    bmm_default_1 = torch.ops.aten.bmm.default(view_default_3, view_default_4);  view_default_3 = view_default_4 = None
    view_default_5 = torch.ops.aten.view.default(bmm_default_1, [1, 16, 2, 32]);  bmm_default_1 = None
