...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/qc/cqcesuwhlktntyty4rhr6263lvyqoaivbggehiewmbmtty5p3jp2.py
...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/en/ceny6f3s3a2az37ihj67xgqkgpftvru36khnx2ytes3vc3l4tgiz.py
...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/m5/cm5tpyojialvxrp332i3xy4vr5pe5gaaiceq6u6elyqwimmen42m.py
...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/vc/cvchht4obus77paensdmtmw3dwys5encu4jl5hv6jl5gbynri7xn.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax_add_matmul_3(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full1 = tl.load(in_ptr0 + (1 + 2 * x1 + 4 * x2) + _es_lane1, x1mask & x2mask & ((1 + 2 * x1 + 4 * x2 + _es_lane1 >= 0) & (1 + 2 * x1 + 4 * x2 + _es_lane1 < 64)), eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/mc/cmcnflrnmea2syfuzndtb37c4nrcx46u5dy4jtksi62n44upws3f.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax_add_matmul_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        tmp1 = tl.load(in_ptr1 + (x1), x1mask, eviction_policy='evict_last')
        _es_lane1 = tl.arange(0, 2)[None, None, :]
        _es_full1 = tl.load(in_ptr2 + (2 * x1 + 4 * x2) + _es_lane1, x1mask & x2mask & ((2 * x1 + 4 * x2 + _es_lane1 >= 0) & (2 * x1 + 4 * x2 + _es_lane1 < 64)), eviction_policy='evict_last')
        tmp3 = extract_slice(_es_full1, [0, 0, 0], [_es_full1.shape[0], _es_full1.shape[1], 1], [1, 1, 1])
        ...
        _es_full3 = tl.load(in_ptr2 + (1 + 2 * x1 + 4 * x2) + _es_lane3, x1mask & x2mask & ((1 + 2 * x1 + 4 * x2 + _es_lane3 >= 0) & (1 + 2 * x1 + 4 * x2 + _es_lane3 < 64)), eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/6n/c6nl4irjx42cds42oxcyr35jvbgsjbropy6y3ynqh2y2rz7rdkgv.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-nzmb_etp/adapter/inductor-cache/tmpt4gfp1f_/uj/cujvocf7dikgdskhzv4kgqf7xh6wiyocdesbpawaze3faw6fahbm.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
# Graph fragment:
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 64}, 
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*i1', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3, 4, 5), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [2, 2, 16, {'divisors': [1, 2, 4]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 2, 'divisor': 1, 'seed': 1}, {'name': 'x1', 'length': 2, 'divisor': 2, 'seed': 2}, {'name': 'x2', 'length': 16, 'divisor': 4, 'seed': 2}]},
