class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[1, 1, 2, 2]", arg1_1: "f32[1, 2, 16, 32]", arg2_1: "f32[1, 2, 16, 32]", arg3_1: "f32[1, 2, 16, 32]"):
        ...
        permute_default_3: "f32[1, 16, 32, 2]" = torch.ops.aten.permute.default(permute_default_1, [0, 1, 3, 2])
        ...
        view_default: "f32[16, 2, 32]" = torch.ops.aten.view.default(expand_default, [16, 2, 32]);  expand_default = None
        expand_default_1: "f32[1, 16, 32, 2]" = torch.ops.aten.expand.default(mul_scalar_1, [1, 16, 32, 2]);  mul_scalar_1 = None
        view_default_1: "f32[16, 32, 2]" = torch.ops.aten.view.default(expand_default_1, [16, 32, 2]);  expand_default_1 = None
        bmm_default: "f32[16, 2, 2]" = torch.ops.aten.bmm.default(view_default, view_default_1);  view_default = view_default_1 = None
        view_default_2: "f32[1, 16, 2, 2]" = torch.ops.aten.view.default(bmm_default, [1, 16, 2, 2]);  bmm_default = None
        ...
        sub_tensor: "f32[1, 16, 2, 2]" = torch.ops.aten.sub.Tensor(add_tensor, amax_default);  amax_default = None
        ...
        eq_scalar: "b8[1, 16, 2, 2]" = torch.ops.aten.eq.Scalar(add_tensor, -inf);  add_tensor = None
        ...
        view_default_3: "f32[16, 2, 2]" = torch.ops.aten.view.default(expand_default_2, [16, 2, 2]);  expand_default_2 = None
        expand_default_3: "f32[1, 16, 2, 32]" = torch.ops.aten.expand.default(permute_default_2, [1, 16, 2, 32])
        view_default_4: "f32[16, 2, 32]" = torch.ops.aten.view.default(expand_default_3, [16, 2, 32]);  expand_default_3 = None
        ...
        view_default_5: "f32[1, 16, 2, 32]" = torch.ops.aten.view.default(bmm_default_1, [1, 16, 2, 32]);  bmm_default_1 = None
