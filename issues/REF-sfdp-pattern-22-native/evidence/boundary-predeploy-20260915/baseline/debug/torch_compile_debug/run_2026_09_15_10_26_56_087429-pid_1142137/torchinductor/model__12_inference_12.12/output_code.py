...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpk8bxg_f6/6n/c6noyqs4zlg5fr2diqoizwofk7dd3nlqmo3wbpdko3rfknt2h7qe.py
...
def triton_unk_fused_add_select_unsqueeze_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + 2 * x1 + _es_lane0, x1mask, eviction_policy='evict_last').to(tl.float32)
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpk8bxg_f6/yb/cyb2ugtdopnvob6cu6u7xa2hkjxkvquhs42qllz7mu7mjkzrsf6d.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
