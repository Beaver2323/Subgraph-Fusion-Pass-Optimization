...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpauc66em0/ty/ctybzj4o2rivqfwhjbn2f6o2jpmpogjbnxa3n7zik6c57eu6dtbw.py
...
def triton_unk_fused_add_select_unsqueeze_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + (3 + 4 * x1) + _es_lane0, x1mask, eviction_policy='evict_last')
        tmp0 = extract_slice(_es_full0, [0, 0], [real_block_x1, 1], [1, 1])
        tl.store(out_ptr0 + (x0 + 5*x1), tmp0, x0mask & x1mask)
''', device_str='npu')


# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpauc66em0/ok/coke2a2cmbgoc44epklqqct5q6vsanpq5ntjpm6uwnq5wlkydqb6.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
