...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmp0n1ue68p/xy/cxyugyca22d5ynjcyzfdeeoy6w2zt2hkgx4ywy2gly66mcvwr6w3.py
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmp0n1ue68p/6t/c6taaq32hist6mij5lbolirtlkl3jercufvw5hu3cadvgsbrigey.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
