...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpzal5vyqo/dz/cdzlcemnfridab25jfb65bhobcdytgkx4ynuulqox5jf3qfks2rm.py
...
def triton_unk_fused_add_select_unsqueeze_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + 4 * x1 + _es_lane0, x1mask, eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpzal5vyqo/ok/coke2a2cmbgoc44epklqqct5q6vsanpq5ntjpm6uwnq5wlkydqb6.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
