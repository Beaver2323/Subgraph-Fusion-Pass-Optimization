...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpyt1shtux/v7/cv7jx5anoslosi6fa3nqnqf6np42xlmkksewa2clki7rasa5vwi7.py
...
def triton_unk_fused_add_select_unsqueeze_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        _es_full0 = tl.load(in_ptr0 + (7 + 8 * x1) + _es_lane0, x1mask, eviction_policy='evict_last').to(tl.float32)
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmpyt1shtux/yb/cyb2ugtdopnvob6cu6u7xa2hkjxkvquhs42qllz7mu7mjkzrsf6d.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
