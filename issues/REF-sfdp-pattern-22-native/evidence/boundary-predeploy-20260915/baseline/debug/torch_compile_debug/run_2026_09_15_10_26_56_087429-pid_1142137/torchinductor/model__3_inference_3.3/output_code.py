...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmp_wtwqg1j/2w/c2wu3bzwufm6m5skttmuayiwyklbpdjlkis6jpb67oisonmmny6d.py
...
# kernel path: /home/z50063656/tmp/attention-slice-boundary-6uy2plji/baseline/inductor-cache/tmp_wtwqg1j/ok/coke2a2cmbgoc44epklqqct5q6vsanpq5ntjpm6uwnq5wlkydqb6.py
# Topologically Sorted Source Nodes: [select, unsqueeze, add], Original ATen: [aten.select, aten.unsqueeze, aten.add]
# Source node to ATen node mapping:
#   add => add
#   select => select
