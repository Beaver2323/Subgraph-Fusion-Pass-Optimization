...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/zi/cziymxfd7mjgxqx7bzblzcwzay5w734x54jqr54ezjd5szgmtiw3.py
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/s2/cs25i2bhyunllqayk26eraro62qx2tnep5255jp4cbtxlxbta45r.py
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/rk/crk4wzilb7d5a4aindibrwv24yymwjnejpjwu4chmogq6qxpkspz.py
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/o6/co6h5jg2vcvxsgv4mfdtscaqbhpy7p4dpq3e2yn5u4dpr6lwifhu.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/eo/ceol2fkfutpk4xmajtmvy2jtj7ljuugldplw6lmo7pmsvgmhtjbt.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
def triton_unk_fused__safe_softmax_add_matmul_4(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        tmp1 = extract_slice(_es_full1, [0, 0, 0], [_es_full1.shape[0], _es_full1.shape[1], 1], [1, 1, 1])
        _es_lane2 = tl.arange(0, 2)[None, None, :]
        _es_full2 = tl.load(in_ptr2 + (2 * x1 + 4 * x2) + _es_lane2, x1mask & x2mask & ((2 * x1 + 4 * x2 + _es_lane2 >= 0) & (2 * x1 + 4 * x2 + _es_lane2 < 256)), eviction_policy='evict_last')
        tmp3 = extract_slice(_es_full2, [0, 0, 0], [_es_full2.shape[0], _es_full2.shape[1], 1], [1, 1, 1])
        _es_lane3 = tl.arange(0, 2)[None, None, :]
        _es_full3 = tl.load(in_ptr0 + (1 + 2 * x1 + 4 * x2) + _es_lane3, x1mask & x2mask & ((1 + 2 * x1 + 4 * x2 + _es_lane3 >= 0) & (1 + 2 * x1 + 4 * x2 + _es_lane3 < 256)), eviction_policy='evict_last')
        ...
        _es_full5 = tl.load(in_ptr2 + (1 + 2 * x1 + 4 * x2) + _es_lane5, x1mask & x2mask & ((1 + 2 * x1 + 4 * x2 + _es_lane5 >= 0) & (1 + 2 * x1 + 4 * x2 + _es_lane5 < 256)), eviction_policy='evict_last')
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/6f/c6fixvxvqkhex5n6yukkh2mjked4tzytrqfdeerivaupncfrwyiz.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/xu/cxuttsbyozfsfdrkxlvja3m6ckrzjp26vlikkdk5ku6jojx3qcbp.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.matmul, aten.add, aten._safe_softmax]
# Source node to ATen node mapping:
#    => add_tensor, amax_default, div_tensor, exp_default, full_default, logical_not_default_1, sub_tensor, sum_dim_int_list, view_default_2, where_self
# Graph fragment:
...
# kernel path: /home/z50063656/tmp/t106-native-ft072a_v/adapter/inductor-cache/tmppy3wx8kx/al/calczonpvaigy2cpgngzx7couzz7ufmkjqvtb7hguddgkev3it6g.py
