class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "bf16[7]"):
        ...
        log2: "bf16[7]" = torch.ops.aten.log2.default(arg0_1);  arg0_1 = None
        ceil: "bf16[7]" = torch.ops.aten.ceil.default(log2);  log2 = None
        ...
        convert_element_type_1: "bf16[7]" = torch.ops.prims.convert_element_type.default(clamp_max, torch.bfloat16);  clamp_max = None
        add: "bf16[7]" = torch.ops.aten.add.Tensor(convert_element_type_1, 127);  convert_element_type_1 = None
