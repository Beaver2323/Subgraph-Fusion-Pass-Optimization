...
# kernel path: /home/z50063656/tmp/t096-npu-results/functional-20260911T182951-swod5y_r/strided/artifacts/inductor-cache/tmpxo3via76/7p/c7puehhgz2am5tsbrwdqvg5rudbqdbkhohabqy7bj5xvwdxxh5dq.py
...
# Graph fragment:
#   %view_dtype : Tensor "i32[7][2]npu:0" = PlaceHolder[target=view_dtype]
...
def triton_unk_fused__to_copy_add_bitwise_and_bitwise_or_clamp_eq_gt_lt_ne_scalar_tensor_where_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        xmask = x0mask
        _es_slane0 = tl.arange(0, 2*real_block_x0)[:]
        _es_smask0 = (2*x0offset + _es_slane0) < 2*x0numel
        _es_sfull0 = tl.load(in_ptr0 + (0 + 2 * x0offset + _es_slane0), _es_smask0, eviction_policy='evict_last')
        tmp0 = extract_slice(_es_sfull0, [0], [real_block_x0], [2])
...
def get_args():
    ...
    arg0_1 = rand_strided((7, ), (2, ), device='npu:0', dtype=torch.float32)
    return [arg0_1]
