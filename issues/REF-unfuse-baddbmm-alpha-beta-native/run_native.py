#!/usr/bin/env python3
"""T-078 baddbmm alpha/beta 正例的原生入口预检与适配调度。"""
...
METHOD = "TestPatternMatcher.test_unfuse_broadcast_bias_baddbmm_alpha_beta"
parser = argparse.ArgumentParser(description=__doc__)
parser.add_argument("--adapter", action="store_true")
args = parser.parse_args()
if Path.cwd().resolve() != WORK:
    raise SystemExit("必须从 /home/z50063656/tmp 启动")
root = WORK / "t078-npu-results" / "REF-unfuse-baddbmm-alpha-beta-native"
