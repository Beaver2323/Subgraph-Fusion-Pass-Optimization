#!/usr/bin/env python3
"""复用上游 baddbmm alpha/beta 正例；只适配设备与入口。"""
...
METHOD = "test_unfuse_broadcast_bias_baddbmm_alpha_beta"
...
def main() -> int:
    ...
    spec = importlib.util.spec_from_file_location(
        "t078_unfuse_baddbmm_alpha_beta_upstream", SOURCE
    )
    ...
    summary = {
        ...
        "adapter_deviation": [
            ...
            "不改变 alpha=0.8、beta=0.2、shape、数值断言或 codegen FileCheck",
        ],
