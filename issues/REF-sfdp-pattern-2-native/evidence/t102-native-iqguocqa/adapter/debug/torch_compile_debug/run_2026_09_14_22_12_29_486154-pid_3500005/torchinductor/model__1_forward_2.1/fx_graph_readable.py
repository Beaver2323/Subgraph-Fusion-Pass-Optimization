class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[4, 2, 16, 32]", primals_2: "f32[4, 2, 16, 32]", primals_3: "f32[4, 2, 16, 32]"):
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:316 in dot_prod_attention, code: torch.matmul(query, key.transpose(-2, -1))
        ...
        mul_tensor: "f32[4, 2, 16, 16]" = torch.ops.aten.mul.Tensor(view_2, 0.17677669529663687)
        ...
        mul_tensor_2: "f32[4, 2, 16, 16]" = torch.ops.aten.mul.Tensor(sub_tensor, 0.17677669529663687);  sub_tensor = None
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:318 in dot_prod_attention, code: .softmax(dim=-1)
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fused_attention.py:319 in dot_prod_attention, code: .matmul(value)
        expand_2: "f32[4, 2, 16, 16]" = torch.ops.aten.expand.default(div, [4, 2, 16, 16])
        ...
        return (view_5, primals_2, primals_3, permute, div)
