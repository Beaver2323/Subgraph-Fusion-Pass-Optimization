...
def forward(self, primals_1, primals_2, primals_3, primals_4, tangents_1):
    primals_2 = primals_1
    primals_4 = primals_2
    primals_6 = primals_3
    primals_8 = primals_4
    ...
    matmul_backward = torch.ops.aten.matmul_backward.default(tangents_2, convert_element_type_3, primals_6, [True, True]);  tangents_2 = primals_6 = None
    getitem_1 = matmul_backward[0]
    getitem_3 = matmul_backward[1];  matmul_backward = None
    convert_element_type_6 = torch.ops.prims.convert_element_type.default(getitem_1, torch.float32);  getitem_1 = None
    ...
    mul_1 = torch.ops.aten.mul.Tensor(convert_element_type_6, convert_element_type_7);  convert_element_type_6 = None
    sum_2 = torch.ops.aten.sum.dim_IntList(mul_1, [-1], True)
    mul_2 = torch.ops.aten.mul.Tensor(convert_element_type_7, sum_2);  convert_element_type_7 = sum_2 = None
    ...
    mul_3 = torch.ops.aten.mul.Tensor(convert_element_type_8, primals_8);  convert_element_type_8 = primals_8 = None
    matmul_backward_1 = torch.ops.aten.matmul_backward.default(mul_3, primals_2, permute, [True, True]);  mul_3 = primals_2 = permute = None
    getitem_5 = matmul_backward_1[0]
    getitem_7 = matmul_backward_1[1];  matmul_backward_1 = None
    permute_1 = torch.ops.aten.permute.default(getitem_7, [0, 1, 3, 2]);  getitem_7 = None
    return [view_5, getitem_5, permute_1, getitem_3, None]
