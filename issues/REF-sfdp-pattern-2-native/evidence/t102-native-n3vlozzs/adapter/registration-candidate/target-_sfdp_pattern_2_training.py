...
def forward(self, primals_1, primals_2, primals_3, primals_4, tangents_1):
    ...
    expand_2 = torch.ops.aten.expand.default(div, [2, 4, 8, 8])
    ...
    matmul_backward = torch.ops.aten.matmul_backward.default(tangents_2, div, primals_6, [True, True]);  tangents_2 = primals_6 = None
    getitem_1 = matmul_backward[0]
    getitem_3 = matmul_backward[1];  matmul_backward = None
    mul_1 = torch.ops.aten.mul.Tensor(getitem_1, div);  getitem_1 = None
