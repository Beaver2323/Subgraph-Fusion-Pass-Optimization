...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = torch.ops.npu.npu_fusion_attention_v3.default(reinterpret_tensor(arg1_1, (1, 1024, 128, 128), (16777216, 16384, 128, 1), 0), reinterpret_tensor(arg0_1, (1, 1024, 128, 128), (16777216, 16384, 128, 1), 0), reinterpret_tensor(arg2_1, (1, 1024, 128, 128), (16777216, 16384, 128, 1), 0), 1024, 'BNSD', pse=None, padding_mask=None, atten_mask=None, scale=1.0, keep_prob=1.0, pre_tockens=2147483647, next_tockens=2147483647, inner_precise=0, prefix=None, actual_seq_qlen=None, actual_seq_kvlen=None, sparse_mode=0, gen_mask_parallel=True, sync=False, softmax_layout='', sink=None)
            del arg0_1
            del arg1_1
            del arg2_1
            buf1 = buf0[0]
            ...
            del buf0
        return (reinterpret_tensor(buf1, (1024, 128, 128), (16384, 128, 1), 0), )
