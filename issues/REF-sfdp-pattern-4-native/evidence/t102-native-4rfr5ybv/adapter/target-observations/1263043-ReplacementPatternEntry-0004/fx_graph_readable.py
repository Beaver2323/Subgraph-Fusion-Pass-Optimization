...
def forward(self, primals, tangents):
    ...
    mul = torch.ops.aten.mul.Tensor(view_2, 0.4);  view_2 = None
    ...
    npu_dropout_backward = torch.ops.npu.npu_dropout_backward.default(getitem_2, getitem_1, 0.19999999999999996);  getitem_2 = getitem_1 = None
    ...
    mul_3 = torch.ops.aten.mul.Tensor(sub_1, 0.4);  sub_1 = None
