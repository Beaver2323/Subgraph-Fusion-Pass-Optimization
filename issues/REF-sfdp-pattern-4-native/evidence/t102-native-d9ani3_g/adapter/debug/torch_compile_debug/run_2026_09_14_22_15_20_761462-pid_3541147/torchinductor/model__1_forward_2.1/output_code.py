...
# kernel path: /home/z50063656/tmp/t102-native-d9ani3_g/adapter/inductor-cache/tmpje9lp7px/7p/c7pyyic6gbcaroejxuveni74bsntbzbaucvuu2x7bvmlvu7g6ude.py
...
#   %mul_tensor : Tensor "f32[4, 2, 16, 16][512, 256, 16, 1]npu:0"[num_users=4] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_2, 0.4), kwargs = {})
...
# kernel path: /home/z50063656/tmp/t102-native-d9ani3_g/adapter/inductor-cache/tmpje9lp7px/2k/c2kba3pfjrnatbxfjtqdi3l57aahafrqedjlmkkqzps5ty5r3mq6.py
...
#   %mul_tensor_2 : Tensor "f32[4, 2, 16, 16][512, 256, 16, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor, 0.4), kwargs = {})
...
#   return %amax_default,%amax_default_1,%sum_1,%div
...
def triton_unk_fused__softmax_all_amax_matmul_mul_sub_1(in_out_ptr0, in_ptr0, xnumel, r0_numel, XBLOCK : tl.constexpr, R0_BLOCK : tl.constexpr):
    ...
    for i in range(group_size):
        ...
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            _tmp4 = tmp5
            tmp6 = tl.full([1, 1], 0.4, tl.float32)
            tmp7 = tmp0 * tmp6
        ...
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            tmp15 = tmp13 * tmp14
            tmp16 = tmp15 - tmp4
            tmp17 = tl.full([1, 1], 0.4, tl.float32)
            tmp18 = tmp16 * tmp17
            tmp19 = tmp13 * tmp17
            tmp20 = tmp19 - tmp9
        ...
        for r0_offset in tl.range(0, r0_numel, R0_BLOCK):
            ...
            tmp29 = tmp27 * tmp28
            tmp30 = tmp29 - tmp4
            tmp31 = tl.full([1, 1], 0.4, tl.float32)
            tmp32 = tmp30 * tmp31
            tmp33 = tmp27 * tmp31
            tmp34 = tmp33 - tmp9
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf7 = torch.ops.npu._npu_dropout.default(buf6, 0.2)
            buf8 = buf7[0]
