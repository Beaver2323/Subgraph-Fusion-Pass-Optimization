...
def forward(self, primals, tangents):
    ...
    npu_fusion_attention_grad_v3_default = torch.ops.npu.npu_fusion_attention_grad_v3.default(primals_2, primals_1, primals_3, tangents_1, 4, 'BNSD', softmax_max = getitem_7, softmax_sum = getitem_8, softmax_in = getitem_9, attention_in = getitem_6, scale_value = 2.0, keep_prob = 0.99999999999, seed = getitem_10, offset = getitem_11);  primals_2 = primals_1 = primals_3 = tangents_1 = getitem_7 = getitem_8 = getitem_9 = getitem_10 = getitem_11 = None
