...
# kernel path: /home/z50063656/tmp/t096-native-tf6xlf05/adapter/inductor-cache/tmpgf6xy4d_/az/cazfjv3oufce4lpyiclipfxvbb3cupx2oupm7ieovmyj23w7ydb5.py
...
#   %bitwise_and_scalar : Tensor "i32[7][1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.bitwise_and.Scalar](args = (%__rshift___scalar, 255), kwargs = {})
#   %bitwise_and_scalar_1 : Tensor "i32[7][1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.bitwise_and.Scalar](args = (%view_dtype, 8388607), kwargs = {})
...
#   %convert_element_type_default_1 : Tensor "u8[7][1]npu:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clamp_max_default, torch.uint8), kwargs = {})
