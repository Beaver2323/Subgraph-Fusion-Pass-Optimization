class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[7]"):
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fp8.py:2219 in encode_fn, code: log2_val = torch.log2(inp)
        log2: "f32[7]" = torch.ops.aten.log2.default(arg0_1);  arg0_1 = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fp8.py:2220 in encode_fn, code: ceil_val = torch.ceil(log2_val)
        ceil: "f32[7]" = torch.ops.aten.ceil.default(log2);  log2 = None

        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fp8.py:2221 in encode_fn, code: clamped = torch.clamp(ceil_val, min=-E8M0_BIAS, max=E8M0_BIAS)
        ...
        # File: /home/z50063656/Pass/src/pytorch/test/inductor/test_fp8.py:2222 in encode_fn, code: biased = clamped + E8M0_BIAS
