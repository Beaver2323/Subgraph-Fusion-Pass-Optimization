...
# kernel path: /home/z50063656/tmp/t086-performance-results/benchmark-20260910T062546-kx8vcs7b/on1/inductor-cache/tmp23g342af/dx/cdx6rbqx2745cy33tyzu2d2u6s7cbuzwvojzzs76zqvmxn4lthaz.py
...
#   return %full_default
triton_unk_fused_ones_0 = async_compile.triton('triton_unk_fused_ones_0', '''
import triton
import triton.language as tl
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_ones_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 0, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused_ones_0(out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = empty_strided_npu((10, ), (1, ), torch.float32)
            # Topologically Sorted Source Nodes: [src], Original ATen: [aten.ones]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_ones_0.run(buf0, 10, stream=raw_stream0)
            arg0_1 = copy_if_misaligned(arg0_1)
            aten.index_put_(arg1_1, [arg0_1], buf0, False)
            del arg0_1
            del buf0
        return (reinterpret_tensor(arg1_1, (2, 1024), (0, 1), 0), )
