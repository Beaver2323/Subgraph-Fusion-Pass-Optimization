...
# kernel path: /home/z50063656/tmp/t084-performance-results/benchmark-dedup-reduce-scatter-20260910T055903-704gzsgo/on1/rank-0/inductor-cache/tmpqw3154df/7k/c7kcl74f3wk77zb3flxcdl5jgts6y2qpj2vd3jwshysuorqaceui.py
# Topologically Sorted Source Nodes: [], Original ATen: [aten.add, _c10d_functional.reduce_scatter_tensor]
# Source node to ATen node mapping:
#    => add_tensor, reduce_scatter_tensor_default
# Graph fragment:
#   %arg0_1 : Tensor "f32[4, 128][128, 1]npu:0" = PlaceHolder[target=arg0_1]
#   %arg1_1 : Tensor "f32[4, 128][128, 1]npu:0" = PlaceHolder[target=arg1_1]
#   %add_tensor : Tensor "f32[4, 128][128, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg0_1, %arg1_1), kwargs = {})
#   %reduce_scatter_tensor_default : Tensor "f32[2, 128][128, 1]npu:0"[num_users=1] = call_function[target=torch.ops._c10d_functional.reduce_scatter_tensor.default](args = (%add_tensor, avg, 2, 0), kwargs = {})
#   return %buf0
triton_unk_fused_add_reduce_scatter_tensor_0 = async_compile.triton('triton_unk_fused_add_reduce_scatter_tensor_0', '''
import triton
import triton.language as tl
...
@npu_triton_heuristics.pointwise(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_add_reduce_scatter_tensor_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused_add_reduce_scatter_tensor_0(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = empty_strided_npu((4, 128), (128, 1), torch.float32)
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, _c10d_functional.reduce_scatter_tensor]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_add_reduce_scatter_tensor_0.run(arg0_1, arg1_1, buf0, 512, stream=raw_stream0)
            del arg0_1
            del arg1_1
            # Topologically Sorted Source Nodes: [], Original ATen: [aten.add, _c10d_functional.reduce_scatter_tensor]
            ...
            buf2 = torch.ops._c10d_functional.wait_tensor.default(buf1)
