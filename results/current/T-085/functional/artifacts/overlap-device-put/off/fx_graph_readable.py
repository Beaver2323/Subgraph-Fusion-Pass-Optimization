class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "i64[8]", arg1_1: "f32[1024, 128]"):
        ...
        view: "i64[2, 4]" = torch.ops.aten.view.default(arg0_1, [2, -1]);  arg0_1 = None
        ...
        view_1: "i64[2, 4]" = torch.ops.aten.view.default(wait_tensor, [2, -1]);  wait_tensor = None
        ...
        device_put: "i64[2]" = torch.ops.prims.device_put.default(sum_1, device(type='cpu'), True);  sum_1 = None
