...
# kernel path: /home/z50063656/tmp/t085-performance-results/functional-partitioned-scatter-20260910T054442-vb4ys8_j/off/rank-0/inductor-cache/tmpn9sdbu61/lu/cluvdwpblzymhcefvrqsabzmzr5ctwa6z4phgcmr3ddbbzvhjiz2.py
# Topologically Sorted Source Nodes: [out0], Original ATen: [aten.index_put]
# Source node to ATen node mapping:
#   out0 => index_put
# Graph fragment:
#   %arg0_1 : Tensor "f32[501, 100][100, 1]npu:0" = PlaceHolder[target=arg0_1]
#   %index_put : Tensor "f32[501, 100][100, 1]npu:0"[num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%arg0_1, [%arg2_1], %arg1_1, True), kwargs = {})
#   return %index_put
...
@npu_triton_heuristics.pointwise(
    size_hints={'x': 50100}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='npu', index=0, multi_processor_count=48, cc='Ascend910B2', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, max_threads_per_block=1024, warp_size=None), 'constants': {}, 'mix_mode': 'aiv', 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})], 'block_hints': {'XBLOCK_HINT': [50100, {'divisors': [1]}], 'R0_BLOCK_HINT': [{'divisors': []}]}, 'axis_hints': [{'name': 'x0', 'length': 50100, 'divisor': 1, 'seed': 1}]},
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused_index_put_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'npu_num_x_nodes': 1, 'npu_rsplit_partial': False, 'backend_hash': '573767764059784D1B071A77E46541176356CEAB012EDE3A29BDD4D6B9E2A472', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': True, 'dynamic_scale_rblock': True, 'incremental_autotune': False, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'batch_invariant': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': True, 'dynamic_disable_pipelining': True, 'are_deterministic_algorithms_enabled': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_unk_fused_index_put_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    total_thread = 48
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.npu.utils.device(0):
            ...
            buf0 = empty_strided_npu((501, 100), (100, 1), torch.float32)
            # Topologically Sorted Source Nodes: [out0], Original ATen: [aten.index_put]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_index_put_0.run(arg0_1, buf0, 50100, stream=raw_stream0)
            del arg0_1
            arg1_1 = copy_if_misaligned(arg1_1)
            arg2_1 = copy_if_misaligned(arg2_1)
            aten.index_put_(buf0, [arg2_1], arg1_1, True)
            arg3_1 = copy_if_misaligned(arg3_1)
            buf2 = empty_strided_npu((501, 100), (100, 1), torch.float32)
            # Topologically Sorted Source Nodes: [out1], Original ATen: [aten.index_put]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_index_put_0.run(arg3_1, buf2, 50100, stream=raw_stream0)
            del arg3_1
            aten.index_put_(buf2, [arg2_1], arg1_1, True)
            arg4_1 = copy_if_misaligned(arg4_1)
            buf4 = empty_strided_npu((501, 100), (100, 1), torch.float32)
            # Topologically Sorted Source Nodes: [out2], Original ATen: [aten.index_put]
            raw_stream0 = get_raw_stream(0)
            triton_unk_fused_index_put_0.run(arg4_1, buf4, 50100, stream=raw_stream0)
            del arg4_1
            aten.index_put_(buf4, [arg2_1], arg1_1, True)
            del arg1_1
            del arg2_1
