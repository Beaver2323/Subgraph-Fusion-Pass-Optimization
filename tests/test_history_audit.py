...
class ExportIntegrationTests(HistoryFixtures):
    ...
    def test_real_export_then_latest_publication(self):
        ...
        self.assertIn("--profile review", (ROOT / "scripts/run_gpu_reference_task.sh").read_text())
        self.assertIn("--split-output-dir", (ROOT / "scripts/run_gpu_reference_task.sh").read_text())
