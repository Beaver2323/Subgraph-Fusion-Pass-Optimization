...
> 生成时间：2026-09-08T03:12:20+08:00
...
- 活动 acceptance units：**28**；已冻结 reference：**28**；等待 GPU reference：**0**。
...
| T-081 | AU-joint-graph-constant-fold-uniform-value | joint_graph | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-improved / PERF_IMPROVED | functional-comparison-closed |
| T-081 | AU-joint-graph-pointless-convert | joint_graph | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-neutral / PERF_NEUTRAL | functional-comparison-closed |
| T-082 | AU-joint-graph-pointless-permute-pair | joint_graph | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-neutral / PERF_NEUTRAL | functional-comparison-closed |
| T-082 | AU-joint-graph-pointless-view-pair | joint_graph | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-neutral / PERF_NEUTRAL | functional-comparison-closed |
| T-083 | AU-post-grad-bucket-all-gathers | post_grad | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-regressed / PERF_REGRESSED | functional-comparison-closed |
| T-083 | AU-post-grad-bucket-all-reduce | post_grad | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-improved / PERF_IMPROVED | functional-comparison-closed |
| T-083 | AU-post-grad-bucket-reduce-scatters | post_grad | valid-reference-suite | triton_experimental | passed | passed | BEHAVIOR_UNCHANGED | not-needed | measured-mixed / PERF_MIXED | functional-comparison-closed |
