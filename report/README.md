...
> 索引更新时间：2026-09-06 09:50 CST（UTC+08:00）
...
| 文件 | 作用 | 当前边界 |
| --- | --- | --- |
| [current_acceptance_unit_matrix.md](current_acceptance_unit_matrix.md) / [CSV](current_acceptance_unit_matrix.csv) | 从活动 manifest、current results 与性能数据生成的逐 acceptance-unit 真值入口 | 21 units；14 个已闭环、7 个等待 reference；现有 NPU 动态结果 backend 全为 `triton_experimental` |
