...
- PyTorch source: `/home/z50063656/Pass/src/pytorch`
- torch_npu source: `/home/z50063656/Pass/src/torch_npu`
- Records: **251**
...
|---|---:|
| Total records | 251 |
| Stage `inductor-extension` | 91 |
| Stage `joint_graph` | 48 |
| Stage `npu-custom` | 3 |
| Stage `npu-dvm` | 1 |
| Stage `npu-dvm-subpass` | 5 |
| Stage `npu-mlir` | 1 |
| Stage `npu-mlir-subpass` | 1 |
| Stage `npu-pattern` | 1 |
| Stage `npu-triton-experimental` | 4 |
| Stage `post_grad` | 70 |
| Stage `pre_grad` | 26 |
| Mechanism `backend-graph-pass` | 2 |
| Mechanism `backend-subpass` | 6 |
| Mechanism `extension-function` | 21 |
| Mechanism `generated-pattern-family` | 33 |
| Mechanism `npu-custom-pass` | 27 |
| Mechanism `pattern-entry` | 86 |
| Mechanism `pattern-registry` | 25 |
| Mechanism `pipeline` | 41 |
| Mechanism `replacement-entry` | 10 |
| Static status `backend-sensitive` | 2 |
| Static status `generic-needs-validation` | 147 |
| Static status `generic-pipeline` | 41 |
| Static status `needs-npu-validation` | 17 |
| Static status `npu-specific` | 44 |
...
The executable probe is `run_npu_probe.py`. Launch it from `/home/z50063656/tmp` with an installed torch_npu and a visible NPU. Device availability and runtime results are tracked separately; this static report makes no claim about them.
...
| inductor-extension | `folded_op` | pattern-entry | `torch/_inductor/fx_passes/binary_folding.py:479` | - | generic-needs-validation |
...
| inductor-extension | `int8_woq_fusion_pattern` | replacement-entry | `torch/_inductor/fx_passes/freezing_patterns.py:206` | - | generic-needs-validation |
| inductor-extension | `matmul_fuse_pattern` | replacement-entry | `torch/_inductor/fx_passes/freezing_patterns.py:229` | - | generic-needs-validation |
| inductor-extension | `matmul_fuse_pattern_two` | replacement-entry | `torch/_inductor/fx_passes/freezing_patterns.py:252` | - | generic-needs-validation |
| inductor-extension | `addmm_fuse_pattern_second` | replacement-entry | `torch/_inductor/fx_passes/freezing_patterns.py:279` | - | generic-needs-validation |
...
| inductor-extension | `randperm_index_add_pattern` | replacement-entry | `torch/_inductor/fx_passes/misc_patterns.py:50` | - | generic-needs-validation |
| inductor-extension | `randperm_index_full_pattern` | replacement-entry | `torch/_inductor/fx_passes/misc_patterns.py:71` | - | generic-needs-validation |
| inductor-extension | `randperm_index_pattern` | replacement-entry | `torch/_inductor/fx_passes/misc_patterns.py:92` | - | generic-needs-validation |
| inductor-extension | `e8m0_rceil_pattern` | replacement-entry | `torch/_inductor/fx_passes/misc_patterns.py:139` | cuda | needs-npu-validation |
| inductor-extension | `e8m0_rceil_log2_pattern` | replacement-entry | `torch/_inductor/fx_passes/misc_patterns.py:198` | cuda | needs-npu-validation |
...
| inductor-extension | `reshape_linear_reshape_pattern` | pattern-entry | `torch/_inductor/fx_passes/mkldnn_fusion.py:1094` | mkldnn, dynamic_shape | needs-npu-validation |
| inductor-extension | `linear_bias_pattern` | pattern-entry | `torch/_inductor/fx_passes/mkldnn_fusion.py:1178` | mkldnn | needs-npu-validation |
...
| inductor-extension | `convolution` | pattern-entry | `torch/_inductor/fx_passes/mkldnn_fusion.py:1408` | mkldnn, dynamic_shape | needs-npu-validation |
| inductor-extension | `mkldnn_rnn_layer` | pattern-entry | `torch/_inductor/fx_passes/mkldnn_fusion.py:1460` | mkldnn | needs-npu-validation |
| inductor-extension | `linear` | pattern-entry | `torch/_inductor/fx_passes/mkldnn_fusion.py:1527` | mkldnn, dynamic_shape | needs-npu-validation |
...
| inductor-extension | `woq_int8` | pattern-entry | `torch/_inductor/fx_passes/quantization.py:1208` | - | generic-needs-validation |
...
| inductor-extension | `replacement` | pattern-entry | `torch/_inductor/fx_passes/reduced_atomic_contention.py:581` | - | generic-needs-validation |
...
| joint_graph | `_sfdp_pattern_1` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:43` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_2` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:65` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_3` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:87` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_4` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:109` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_5` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:129` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_6` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:150` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_7` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:171` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_8` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:208` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_9` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:237` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_10` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:267` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_11` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:297` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_12` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:318` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_13` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:341` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_14` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:358` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_15` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:384` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_16` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:421` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_17` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:464` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_18` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:504` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_19` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:552` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_20` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:588` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_21` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:628` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_22` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:654` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_23` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:684` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_24` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:716` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_25` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:752` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_26` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:782` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_27` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:820` | memory_alias | generic-needs-validation |
| joint_graph | `_sfdp_pattern_28` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:857` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_29` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:876` | - | generic-needs-validation |
| joint_graph | `_sfdp_pattern_30` | generated-pattern-family | `torch/_inductor/fx_passes/fuse_attention.py:906` | - | generic-needs-validation |
...
| joint_graph | `mul_softmax_pattern` | pattern-entry | `torch/_inductor/fx_passes/joint_graph.py:1107` | - | generic-needs-validation |
| joint_graph | `div_softmax_pattern` | pattern-entry | `torch/_inductor/fx_passes/joint_graph.py:1142` | - | generic-needs-validation |
...
| joint_graph | `addmm_pattern` | generated-pattern-family | `torch/_inductor/fx_passes/pad_mm.py:197` | - | generic-needs-validation |
| joint_graph | `mm_pattern` | generated-pattern-family | `torch/_inductor/fx_passes/pad_mm.py:812` | - | generic-needs-validation |
| joint_graph | `bmm_pattern` | generated-pattern-family | `torch/_inductor/fx_passes/pad_mm.py:885` | - | generic-needs-validation |
...
| npu-dvm | `dvm_graph_fusion` | backend-graph-pass | `torch_npu/_inductor/dvm/graph_fusion.py:345` | - | npu-specific |
| npu-dvm-subpass | `annotate_mm_transpose_flags` | backend-subpass | `torch_npu/_inductor/dvm/fx_pass.py:26` | - | npu-specific |
| npu-dvm-subpass | `decompose_k1_matmul_to_mul` | backend-subpass | `torch_npu/_inductor/dvm/fx_pass.py:70` | dynamic_shape | npu-specific |
| npu-dvm-subpass | `insert_sum_fp32_prepost_cast_prims` | backend-subpass | `torch_npu/_inductor/dvm/fx_pass.py:117` | - | npu-specific |
| npu-dvm-subpass | `insert_promote_cast_by_pos_prims` | backend-subpass | `torch_npu/_inductor/dvm/fx_pass.py:191` | - | npu-specific |
| npu-dvm-subpass | `expand_to_reshape` | backend-subpass | `torch_npu/_inductor/dvm/fx_pass.py:245` | dynamic_shape | npu-specific |
| npu-mlir | `DvmMlirPostGradPass` | backend-graph-pass | `torch_npu/_inductor/ascend_npu_ir/ascend_npu_ir/npu/npu_inductor_plugin.py:213` | - | npu-specific |
| npu-mlir-subpass | `fold_sum_cast_to_dtype` | backend-subpass | `torch_npu/_inductor/ascend_npu_ir/ascend_npu_ir/npu/utils.py:352` | - | npu-specific |
...
| npu-triton-experimental | `_disable_pad_mm_pass` | extension-function | `torch_npu/_inductor/triton_experimental/overrides.py:74` | npu, dynamic_shape | npu-specific |
...
| post_grad | `prepare_softmax_pattern` | replacement-entry | `torch/_inductor/fx_passes/post_grad.py:873` | - | generic-needs-validation |
