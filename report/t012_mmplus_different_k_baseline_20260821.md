...
- 功能哨兵：审计工作区 `results/t012_mmplus_different_k_sentinel_20260821/`（未镜像到文档仓）
- 性能原始 JSON：审计工作区
  `results/t012_mmplus_different_k_paired_20260821/p0_gate_probe.json`（未镜像到文档仓）
- 变更与测试合同：[CHANGE_CONTROL.md](../docs/CHANGE_CONTROL.md)
